...
- Timeline hover/focus previews are bounded plain-text excerpts for both resident and historical markers. Keep their viewport-bounded surface in `styles/messaging/timeline-preview.css`; hovering never mounts a message renderer or fetches message payloads.
