export const toolCallMessages = {
  ...
  "permissionApproval.kind.form": "Formulaire",
  "formRequest.selectPlaceholder": "Sélectionner une option",
  "formRequest.openExternal": "Ouvrir le formulaire externe",
  "formRequest.cancel": "Annuler",
  "formRequest.submit": "Envoyer",
  "formRequest.submitting": "Envoi...",
  "formRequest.errors.reply": "Impossible d'envoyer le formulaire",
  "formRequest.errors.cancel": "Impossible d'annuler le formulaire",
  "formRequest.errors.validation": "Remplissez tous les champs obligatoires.",
  "formRequest.customValuesPlaceholder": "Autres valeurs, séparées par des virgules",
