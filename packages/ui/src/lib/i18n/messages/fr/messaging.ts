export const messagingMessages = {
  ...
  "promptInput.voiceInput.liveMode": "Ouvrir le mode vocal en direct",
  "voice.hud.title": "Mode vocal en direct",
  "voice.hud.connecting": "Connexion...",
  "voice.hud.listening": "Écoute...",
  "voice.hud.speaking": "Parle...",
  "voice.hud.idle": "Prêt",
  "voice.hud.error": "Erreur de connexion vocale",
  "voice.hud.muted": "Muet",
  "voice.hud.mute": "Couper le microphone",
  "voice.hud.unmute": "Activer le microphone",
  "voice.hud.interrupt": "Interrompre la réponse",
  "voice.hud.close": "Fermer le mode vocal",
  "voice.hud.deadman_timeout": "Mode vocal fermé pour cause d'inactivité",
  "voice.hud.empty_transcript": "Commencez à parler pour démarrer la conversation...",
  "voice.hud.switch_provider": "Changer de fournisseur vocal",
} as const
