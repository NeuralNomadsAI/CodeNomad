export const messagingMessages = {
  ...
  "promptInput.btw.commandDescription": "Poser une question à part sans l'ajouter à la conversation",
  "promptInput.btw.description": "Utilise le contexte de cette session dans une requête distincte au modèle. La question et la réponse ne sont pas ajoutées à la conversation. Les pièces jointes restent dans le composeur.",
  "promptInput.btw.question": "Votre question",
  "promptInput.btw.answer": "Réponse",
  "promptInput.btw.ask": "Demander",
  "promptInput.btw.loading": "Réflexion…",
  "promptInput.btw.cancel": "Annuler la question",
  "promptInput.btw.close": "Fermer la question à part",
  "promptInput.btw.empty": "Le modèle n'a renvoyé aucun texte. Essayez de reformuler votre question.",
  "promptInput.btw.failed": "Impossible de répondre à la question à part.",
  "promptInput.btw.copy": "Copier la réponse",
  "promptInput.btw.copied": "Copié",
  "promptInput.btw.copyFailed": "Impossible de copier la réponse.",
  "history.navigation.outlineLoading": "Chargement de la timeline complète… {loaded} / {total}",
  "history.navigation.loading": "Chargement du passage…",
  "history.navigation.outlineUnavailable": "Timeline complète indisponible",
  "history.scope": "Périmètre de recherche",
  "history.session": "Session entière",
  "history.workspace": "Workspace entier",
  "history.technical": "Inclure les outils et réflexions",
  "history.counts": "{messages} messages · {tools} outils · {reasoning} réflexions",
  "history.scanning": "Comptage…",
  "history.snapshot": "Instantané de l’historique",
  "history.skipped": "{count} messages n’ont pas pu être entièrement traités.",
  "history.more": "Résultats suivants",
  "history.text": "Texte",
  "history.tool": "Outil",
  "history.reasoning": "Réflexion",
  ...
  "transcriptFilters.systemMessages": "Système",
  ...
  "messageBlock.reasoning.thoughtLabel": "Réflexion",
  "messageBlock.reasoning.steps.one": "{count} étape",
  "messageBlock.reasoning.steps.other": "{count} étapes",
  "messageBlock.exploration.completed": "Exploré : {tools}",
  "messageBlock.exploration.active": "Exploration : {tools}",
  "messageBlock.exploration.read.one": "{count} lecture",
  "messageBlock.exploration.read.other": "{count} lectures",
  "messageBlock.exploration.search.one": "{count} recherche",
  "messageBlock.exploration.search.other": "{count} recherches",
  ...
  "messageItem.actions.deleteTechnicalParts": "Supprimer les outils et raisonnements de cette réponse",
  "messageItem.actions.deleteTechnicalParts.confirmTitle": "Supprimer les outils et raisonnements ?",
  "messageItem.actions.deleteTechnicalParts.confirmMessage": "Sorties d'outils : {toolCount} ; raisonnements : {reasoningCount}. Le texte final sera conservé.",
  "messageItem.actions.deleteTechnicalParts.confirmLabel": "Supprimer",
  "messageItem.actions.deleteTechnicalParts.failedTitle": "Échec de suppression",
  "messageItem.actions.deleteTechnicalParts.failedMessage": "Impossible de supprimer les outils et raisonnements de cette réponse",
  ...
  "promptInput.attachFiles.title": "Joindre un fichier…",
  "promptInput.attachFiles.help": "Choisir des fichiers sur cet appareil",
  "promptInput.attachFiles.reading": "Lecture des fichiers…",
  "promptInput.hints.projectFiles": "Référencer les fichiers du projet",
  "promptInput.attachFiles.deviceDetail": "Appareil : {name} · {bytes} octets",
  "promptInput.attachFiles.projectDetail": "Projet : {path}",
  "promptInput.attachFiles.rejected.tooLarge": "{name} : dépasse 5 Mio par fichier.",
  "promptInput.attachFiles.rejected.limit": "{name} : dépasse 10 fichiers ou 20 Mio au total.",
  "promptInput.attachFiles.rejected.unreadable": "{name} : lecture impossible.",
  ...
  "promptInput.attachFiles.tooLarge.other": "{count} fichiers sélectionnés n'ont pas pu être joints car ils dépassent la limite de 5 Mo.",
  "promptInput.attachFiles.limit.one": "1 fichier sélectionné n’a pas été joint, car les pièces jointes sont limitées à {maxFiles} fichiers et {maxMegabytes} Mo au total.",
  "promptInput.attachFiles.limit.other": "{count} fichiers sélectionnés n’ont pas été joints, car les pièces jointes sont limitées à {maxFiles} fichiers et {maxMegabytes} Mo au total.",
  "promptInput.attachFiles.deviceRejected.one": "1 fichier sélectionné n’a pas été joint. Les fichiers doivent être lisibles, ne pas dépasser {maxFileMegabytes} Mo chacun et respecter la limite de {maxFiles} fichiers et {maxTotalMegabytes} Mo au total.",
  "promptInput.attachFiles.deviceRejected.other": "{count} fichiers sélectionnés n’ont pas été joints. Les fichiers doivent être lisibles, ne pas dépasser {maxFileMegabytes} Mo chacun et respecter la limite de {maxFiles} fichiers et {maxTotalMegabytes} Mo au total.",
  ...
  "promptInput.send.queueAriaLabel": "Mettre le message en file d'attente",
  "promptQueue.title": "File d'attente ({count})",
  "promptQueue.delivery.queue": "En attente",
  "promptQueue.delivery.steer": "Injection en cours",
  "promptQueue.attachments.one": "{count} pièce jointe",
  "promptQueue.attachments.other": "{count} pièces jointes",
  ...
  "promptQueue.error.message": "Impossible de mettre à jour la file d'attente",
