export const settingsMessages = {
  ...
  "settings.section.sidecars.subtitle": "Configure local services the server can proxy into tabs.",
  "sidecars.form.name": "Name",
  "sidecars.form.validation": "Enter a valid SideCar name and port.",
  "sidecars.form.port": "Port",
  "sidecars.form.kind": "Type",
  "sidecars.form.command": "Startup command",
  "sidecars.form.command.help": "Command the server should run for app SideCars.",
  "sidecars.form.insecure": "Use HTTP",
  "sidecars.form.autoStart": "Auto-start",
  "sidecars.form.autoStart.help": "Start the SideCar automatically when the server launches.",
  ...
  "sidecars.kind.managed": "App",
  "sidecars.kind.port": "Port",
  "sidecars.status.starting": "Starting",
  "sidecars.status.running": "Running",
  "sidecars.status.stopped": "Stopped",
  "sidecars.status.error": "Error",
  "sidecars.basePath": "Base path",
  "sidecars.settings.listTitle": "Configured SideCars",
  "sidecars.settings.listSubtitle": "Review status and manage the SideCars available in the picker.",
  ...
  "sidecars.picker.subtitle": "Choose a configured SideCar to open in a new tab.",
