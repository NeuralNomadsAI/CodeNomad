export const settingsMessages = {
  ...
  "settings.nav.remote": "Contrôle à distance",
  ...
  "settings.section.remote.title": "Contrôle à distance",
  "settings.section.remote.subtitle": "Continuez les sessions de cet appareil depuis un autre appareil via le relais sortant sécurisé.",
