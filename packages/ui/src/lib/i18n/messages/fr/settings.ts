export const settingsMessages = {
  ...
  "modelSelector.error.noVisibleModels": "Sélectionnez au moins un modèle visible avant d’envoyer un message.",
  ...
  "settings.providers.modelVisibility.mode.label": "Mode de visibilité des modèles",
  "settings.providers.modelVisibility.mode.all": "Tous les modèles",
  "settings.providers.modelVisibility.mode.all.description": "Afficher les modèles actuels et nouveaux.",
  "settings.providers.modelVisibility.mode.custom": "Personnalisé",
  "settings.providers.modelVisibility.mode.custom.description": "Afficher uniquement les identifiants sélectionnés.",
  ...
  "settings.providers.modelVisibility.count": "{selected} sur {total} sélectionnés",
  "settings.providers.modelVisibility.selectAll": "Tout sélectionner",
  "settings.providers.modelVisibility.selectNone": "Tout désélectionner",
  "settings.providers.modelVisibility.unavailable.one": "{count} modèle sélectionné est actuellement indisponible.",
  "settings.providers.modelVisibility.unavailable.other": "{count} modèles sélectionnés sont actuellement indisponibles.",
  "settings.providers.modelVisibility.empty": "Aucun modèle ne correspond à cette recherche.",
  "settings.providers.modelVisibility.listAriaLabel": "Modèles pour {provider}",
  "settings.providers.modelVisibility.saveFailed": "Impossible d’enregistrer la visibilité des modèles.",
