export const settingsMessages = {
  ...
  "instanceServiceStatus.plugins.empty": "Aucun plugin actif.",
  ...
  "instanceServiceStatus.plugins.scope.required": "Choisissez Global ou Projet avant de modifier un plugin.",
  ...
  "instanceServiceStatus.plugins.inactive.heading": "Configurés mais inactifs",
  "instanceServiceStatus.plugins.configured.heading": "Entrées configurées",
  "instanceServiceStatus.plugins.configured.empty": "Aucune source ni règle d’activation de plugin n’est configurée.",
  "instanceServiceStatus.plugins.configured.source": "Source",
  "instanceServiceStatus.plugins.configured.rule": "Règle",
  "instanceServiceStatus.plugins.configured.options": "Options",
  "instanceServiceStatus.plugins.configScope.global": "Global",
  "instanceServiceStatus.plugins.configScope.project": "Projet",
  "instanceServiceStatus.plugins.configScope.other": "Autre source",
  "instanceServiceStatus.plugins.configScope.virtual": "Source virtuelle",
  "instanceServiceStatus.plugins.toast.ruleSaved": "Règle d’activation {scope} enregistrée pour {name}.",
  "instanceServiceStatus.plugins.toast.ruleUnchanged": "La règle d’activation {scope} de {name} est déjà à jour.",
  ...
  "instanceServiceStatus.plugins.errors.save": "Impossible d’enregistrer la règle d’activation du plugin.",
  "instanceServiceStatus.plugins.errors.forbidden": "Cet espace de travail ne peut pas modifier cet emplacement de plugin.",
  "instanceServiceStatus.plugins.errors.conflict": "Le projet ou la configuration a changé simultanément. Actualisez puis réessayez.",
  "instanceServiceStatus.plugins.errors.invalidConfig": "La configuration OpenCode sélectionnée est mal formée. Elle n’a pas été modifiée.",
