export const settingsMessages = {
  ...
  "instanceServiceStatus.plugins.errors.save": "La règle d’activation {scope} de {name} n’a pas pu être enregistrée.",
  "instanceServiceStatus.plugins.errors.forbidden": "Cet espace de travail ne peut pas modifier l’emplacement {scope} de {name}.",
  "instanceServiceStatus.plugins.errors.conflict": "Le projet ou la configuration a changé pendant l’enregistrement de la règle {scope} de {name}. Actualisez puis réessayez.",
  "instanceServiceStatus.plugins.errors.invalidConfig": "La configuration OpenCode {scope} de {name} est mal formée. Elle n’a pas été modifiée.",
