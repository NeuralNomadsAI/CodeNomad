export const settingsMessages = {
  "settings.usage.title": "Stats",
  "settings.usage.scope": "Tout le service OpenCode connecté : tous les projets, clones indépendants et sous-sessions. Ces statistiques ne se limitent pas au dossier ouvert. Périodes glissantes ; l’activité suit le fuseau affiché.",
  "settings.usage.noProject": "Ouvrez un projet pour connecter son service OpenCode et consulter les statistiques globales du service.",
  "settings.usage.period": "Période",
  "settings.usage.days": "{count} derniers jours",
  "settings.usage.loading": "Chargement des statistiques…",
  "settings.usage.error": "Actualisation des statistiques du service impossible. Une connexion OpenCode est nécessaire. Les données affichées proviennent de la dernière actualisation réussie.",
  "settings.usage.sessions": "Sessions",
  "settings.usage.subagents": "Sous-sessions",
  "settings.usage.prompts": "Prompts",
  "settings.usage.steps": "Étapes",
  "settings.usage.input": "Tokens d’entrée",
  "settings.usage.output": "Tokens de sortie",
  "settings.usage.reasoning": "Tokens de raisonnement",
  "settings.usage.cacheRead": "Tokens lus du cache",
  "settings.usage.cacheWrite": "Tokens écrits en cache",
  "settings.usage.activeDays": "Jours actifs",
  "settings.usage.streak": "Série (jours)",
  "settings.usage.cost": "Coût enregistré (USD)",
  "settings.usage.costHint": "Coûts et tokens enregistrés par OpenCode. Les quotas d’abonnement et les factures des fournisseurs ne sont pas mesurés ici.",
  "settings.usage.models": "Par modèle",
  "settings.usage.model": "Modèle",
  "settings.usage.activity": "Activité quotidienne",
  "settings.mcpCodeMode.title": "Code Mode MCP",
  "settings.mcpCodeMode.hint": "Modifiez la source déclarant chaque serveur. Par défaut, Code Mode est actif ; désactivé, les outils sont exposés directement. Une définition prioritaire remplace toute la configuration du serveur.",
  "settings.mcpCodeMode.default": "Par défaut (actif)",
  "settings.mcpCodeMode.on": "Activé",
  "settings.mcpCodeMode.off": "Désactivé",
  "settings.mcpCodeMode.effective": "Effectif : {mode}",
  "settings.mcpCodeMode.error": "Échec du réglage MCP. Actualisez pour consulter l’état courant.",
  "settings.pluginPackages.check": "Vérifier les mises à jour de {target}",
  "settings.pluginPackages.update": "Mettre à jour {target}",
  "settings.pluginPackages.shared": "Met à jour cette cible dans le cache OpenCode partagé pour tous les dossiers qui l’utilisent.",
  "settings.pluginPackages.error": "Échec de l’opération sur {target}. Actualisez pour consulter son état.",
  "settings.accounts.title": "Comptes",
  "settings.accounts.global": "Les comptes sont partagés globalement par ce service OpenCode.",
  "settings.accounts.active": "Actif",
  "settings.accounts.label": "Nom du compte",
  ...
  "settings.websearch.effective": "Recherche dans ce projet : {provider}",
  ...
  "settings.opencode.setup.sharedInstallDescription": "Utilise une installation npm standard partagée avec les autres clients. Ouvrez un nouveau terminal après l’installation.",
  ...
  "settings.opencode.setup.disconnected": "OpenCode n’est pas connecté.",
  ...
  "settings.opencode.setup.progress.start": "Connexion à OpenCode…",
  "settings.opencode.setup.progress.restart": "Redémarrage du service partagé…",
  "settings.opencode.setup.progress.reload": "Rechargement de la configuration OpenCode…",
  "settings.opencode.setup.actionFailed": "L’action OpenCode n’a pas pu être terminée. Vérifiez l’état actuel ci-dessus et réessayez.",
  "settings.opencode.setup.reload": "Recharger la configuration OpenCode",
  "settings.opencode.setup.reloadDescription": "Si les plugins installés restent indisponibles, rechargez la configuration. Cette action reconstruit tous les emplacements chargés pour tous les clients connectés, annule les demandes d’autorisation et formulaires en attente, et ferme les terminaux et commandes d’arrière-plan. Le travail actif peut être interrompu.",
  "settings.opencode.setup.description": "Installez, mettez à jour et connectez OpenCode sur le serveur qui exécute vos projets.",
  "settings.opencode.setup.missing": "OpenCode n’est pas installé.",
  "settings.opencode.setup.update_required": "Cette version d’OpenCode n’est pas prise en charge par cette version de CodeNomad.",
  "settings.opencode.setup.ready": "L’exécutable OpenCode est disponible.",
  "settings.opencode.setup.recommended": "Version minimale recommandée",
  "settings.opencode.setup.untested": "OpenCode {version} n’a pas été entièrement validé avec cette version de CodeNomad. Cela n’empêche pas à lui seul la connexion.",
  "settings.opencode.setup.error": "L’exécutable sélectionné n’a pas pu être vérifié.",
  "settings.opencode.setup.minimum": "Version minimale",
  "settings.opencode.setup.minimumReason": "OpenCode {version} a introduit l’horodatage natif de début d’étape nécessaire à l’affichage des conversations. Les versions antérieures nécessitent des conversions d’événements qui ont été retirées.",
  "settings.opencode.setup.canonical_api": "Le service en cours n’expose pas l’API de sessions, permissions, formulaires et file d’attente nécessaire à cette version de CodeNomad.",
  "settings.opencode.setup.session_environment": "Le service en cours ne permet pas de remplacer l’environnement de la session, une opération nécessaire avant l’envoi de messages ou de commandes.",
  "settings.opencode.setup.daemon": "Service en cours",
  "settings.opencode.setup.install": "Installer et démarrer OpenCode",
  "settings.opencode.setup.connect": "Connecter et continuer",
  "settings.opencode.setup.restart": "Redémarrer le service partagé",
  "settings.opencode.setup.restartRequired": "Le service en cours doit être mis à jour. Son redémarrage interrompt le travail actif de tous les clients OpenCode connectés.",
  "settings.opencode.setup.restartAvailable": "Une version plus récente est installée. Vous pouvez continuer avec le service en cours et le redémarrer plus tard. Son redémarrage interrompt le travail actif de tous les clients OpenCode connectés.",
  "settings.opencode.setup.serviceError": "Impossible de vérifier le service partagé. Vérifiez la connexion et l’authentification, puis réessayez.",
  "settings.opencode.setup.manual": "Sélectionnez un exécutable compatible ou installez @opencode/cli sur l’hôte d’exécution, puis réessayez.",
  "settings.opencode.setup.wsl": "Cet exécutable tourne dans WSL. Installez ou mettez à jour OpenCode dans la distribution sélectionnée.",
  "settings.opencode.setup.chooseBinary": "Choisir l’exécutable",
  "settings.opencode.setup.required": "Configuration d’OpenCode requise",
  ...
  "settings.appearance.palette.mist.description": "Gris neutres doux aux nuances froides.",
  "settings.appearance.palette.slate": "Ardoise",
  "settings.appearance.palette.slate.description": "Surfaces gris bleuté et accents minéraux discrets.",
  "settings.appearance.palette.clay": "Argile",
  "settings.appearance.palette.clay.description": "Gris terreux chauds et tonalités ocre atténuées.",
  "settings.appearance.palette.linen": "Lin",
  "settings.appearance.palette.linen.description": "Papier ivoire doux et texte gris-vert.",
  "settings.appearance.palette.iris": "Iris",
  "settings.appearance.palette.iris.description": "Surfaces gris lavande froides, sans blanc éclatant.",
  "settings.appearance.palette.sage": "Sauge",
  "settings.appearance.palette.sage.description": "Surfaces gris-vert douces aux nuances olive.",
  "settings.appearance.palette.saved": "Personnalisation enregistrée",
  ...
  "instanceServiceStatus.plugins.empty": "Aucun plugin disponible pour l’activation.",
  "instanceServiceStatus.plugins.description": "Les contrôles d’activation V2 écrivent uniquement des règles ordonnées. L’installation, les mises à jour et les options restent dans la configuration OpenCode ou la CLI.",
  "instanceServiceStatus.plugins.scope.legend": "Écrire la prochaine règle dans",
  ...
  "instanceServiceStatus.plugins.runtime.active": "Actif",
  "instanceServiceStatus.plugins.runtime.failed": "En échec",
  "instanceServiceStatus.plugins.runtime.inactive": "Inactif",
  "instanceServiceStatus.plugins.runtime.empty": "Aucun plugin n’est signalé par le runtime.",
  "instanceServiceStatus.plugins.refresh": "Actualiser les contrôles des plugins",
  "instanceServiceStatus.plugins.toggleAriaLabel": "Modifier la règle d’activation de {name}",
  "instanceServiceStatus.plugins.globalOverridden": "Une règle projet remplace ici l’état global.",
  "instanceServiceStatus.plugins.source.package": "Package : {source}",
  "instanceServiceStatus.plugins.source.local": "Source locale : {source}",
  "instanceServiceStatus.plugins.source.builtin": "Intégré à OpenCode",
  "instanceServiceStatus.plugins.source.sdk": "Fourni par l’hôte SDK",
  "instanceServiceStatus.plugins.ruleState.default": "Hérité",
  "instanceServiceStatus.plugins.ruleState.enabled": "Activé par règle",
  "instanceServiceStatus.plugins.ruleState.disabled": "Désactivé par règle",
  "instanceServiceStatus.plugins.toast.ruleSaved": "Règle d’activation de {name} enregistrée dans la portée « {scope} ».",
  "instanceServiceStatus.plugins.toast.ruleUnchanged": "La règle d’activation de {name} est déjà à jour dans la portée « {scope} ».",
  "instanceServiceStatus.plugins.toast.reloadNote": "Elle prend effet quand le daemon recharge sa configuration.",
  "instanceServiceStatus.plugins.errors.load": "Impossible de charger les contrôles d’activation des plugins.",
  "instanceServiceStatus.plugins.errors.refresh": "L’actualisation a échoué. Le dernier état connu reste affiché.",
  "instanceServiceStatus.plugins.errors.save": "La règle d’activation de {name} n’a pas pu être enregistrée dans la portée « {scope} ».",
  "instanceServiceStatus.plugins.errors.forbidden": "Cet espace de travail ne peut pas modifier la règle de {name} dans la portée « {scope} ».",
  "instanceServiceStatus.plugins.errors.conflict": "Le projet ou la configuration a changé pendant l’enregistrement de la règle de {name} dans la portée « {scope} ». Actualisez puis réessayez.",
  "instanceServiceStatus.plugins.errors.invalidConfig": "La configuration OpenCode dans la portée « {scope} » est mal formée pour {name}. Elle n’a pas été modifiée.",
  ...
  "permissionBanner.detail.form.one": "{count} formulaire",
  "permissionBanner.detail.form.other": "{count} formulaires",
  ...
  "envEditor.help": "Avant chaque prompt ou commande de session, CodeNomad applique les variables de ce profil à l’environnement des commandes locales de la conversation. Les modifications prennent effet au prochain envoi. Elles sont aussi transmises au démarrage d’un service OpenCode arrêté ; un service existant n’est pas redémarré.",
  "envEditor.applyFailed": "Impossible d’appliquer l’environnement du profil. Rien n’a été envoyé. Vérifiez les variables et votre version d’OpenCode, puis réessayez.",
  ...
  "settings.appearance.colorScheme.title": "Palette de couleurs",
  "settings.appearance.colorScheme.subtitle": "Choisissez la palette des clients connectés à ce serveur CodeNomad.",
  "settings.appearance.colorScheme.option.system": "Système",
  "settings.appearance.colorScheme.option.light": "Clair",
  "settings.appearance.colorScheme.option.porcelain": "Porcelaine",
  "settings.appearance.colorScheme.option.dawn": "Aube",
  "settings.appearance.colorScheme.option.parchment": "Parchemin",
  "settings.appearance.colorScheme.option.codeNomadClassic": "Classique",
  "settings.appearance.colorScheme.option.basalt": "Basalte",
  "settings.appearance.colorScheme.option.fjord": "Fjord",
  "settings.appearance.colorScheme.option.lichen": "Lichen",
  "settings.appearance.colorScheme.option.velvet": "Velours",
  "settings.appearance.colorScheme.option.ember": "Braise",
  "settings.appearance.colorScheme.option.custom": "Personnalisée",
  "settings.appearance.colorScheme.description.system": "Suit l'apparence du système d'exploitation.",
  "settings.appearance.colorScheme.description.light": "Une palette claire et neutre.",
  "settings.appearance.colorScheme.description.porcelain": "Un chrome neutre et doux autour d’un espace de travail blanc.",
  "settings.appearance.colorScheme.description.dawn": "Des surfaces de jour froides rehaussées de bleu clair.",
  "settings.appearance.colorScheme.description.parchment": "Des surfaces papier chaudes avec un accent bleu sarcelle discret.",
  "settings.appearance.colorScheme.description.codeNomadClassic": "La palette sombre d'origine de CodeNomad.",
  "settings.appearance.colorScheme.description.basalt": "Un gris charbon neutre rehaussé de bleu froid.",
  "settings.appearance.colorScheme.description.fjord": "Un bleu-gris profond rehaussé de vert marin.",
  "settings.appearance.colorScheme.description.lichen": "Un vert-gris terreux rehaussé de mousse.",
  "settings.appearance.colorScheme.description.velvet": "Un prune profond rehaussé de pêche chaude.",
  "settings.appearance.colorScheme.description.ember": "Un brun-noir chaud rehaussé de cuivre.",
  "settings.appearance.colorScheme.description.custom": "Créez et enregistrez votre propre palette.",
  "settings.appearance.colorScheme.custom.appearance": "Apparence personnalisée",
  "settings.appearance.colorScheme.custom.appearance.light": "Claire",
  "settings.appearance.colorScheme.custom.appearance.dark": "Sombre",
  "settings.appearance.colorScheme.custom.colors": "Couleurs",
  "settings.appearance.colorScheme.custom.field.surfaceBase": "Base",
  "settings.appearance.colorScheme.custom.field.surfaceSecondary": "Secondaire",
  "settings.appearance.colorScheme.custom.field.surfaceMuted": "Atténuée",
  "settings.appearance.colorScheme.custom.field.borderBase": "Bordures",
  "settings.appearance.colorScheme.custom.field.textPrimary": "Texte principal",
  "settings.appearance.colorScheme.custom.field.textMuted": "Texte atténué",
  "settings.appearance.colorScheme.custom.field.accentPrimary": "Accent",
  "settings.appearance.colorScheme.custom.field.statusSuccess": "Succès",
  "settings.appearance.colorScheme.custom.field.statusWarning": "Avertissement",
  "settings.appearance.colorScheme.custom.field.statusError": "Erreur",
  "settings.appearance.colorScheme.custom.field.userAccent": "Utilisateur",
  "settings.appearance.colorScheme.custom.field.agentAccent": "Agent",
  "settings.appearance.colorScheme.custom.field.compactionAccent": "Compactage",
  "settings.appearance.colorScheme.custom.field.yoloAccent": "Mode YOLO",
  "settings.appearance.colorScheme.custom.pickerAriaLabel": "Choisir {name}",
  "settings.appearance.colorScheme.custom.valueAriaLabel": "Valeur hexadécimale pour {name}",
  "settings.appearance.colorScheme.custom.warning.format": "Utilisez le format #RRGGBB en majuscules.",
  "settings.appearance.colorScheme.custom.reset": "Réinitialiser",
  "settings.appearance.colorScheme.custom.new": "Nouveau",
  "settings.appearance.colorScheme.custom.name": "Nom",
  "settings.appearance.colorScheme.custom.delete": "Supprimer",
  "settings.appearance.colorScheme.custom.deleteConfirm": "Supprimer « {name} » ?",
  "settings.appearance.colorScheme.custom.save": "Enregistrer",
  "settings.appearance.colorScheme.custom.saveError": "Impossible d'enregistrer la palette.",
  ...
  "settings.appearance.startup.clear.subtitle": "Supprime les onglets, brouillons, positions de défilement et la disposition des panneaux enregistrés. Les données CodeNomad et OpenCode ne sont pas supprimées.",
  ...
  "settings.opencode.update.title": "Version d’OpenCode",
  "settings.opencode.update.subtitle": "Version installée du binaire OpenCode configuré.",
  "settings.opencode.update.checking": "Lecture de la version installée...",
  "settings.opencode.update.checkFailed": "Impossible de lire la version installée d’OpenCode.",
  ...
  "settings.opencode.update.availableUnsupported": "OpenCode {version} est disponible. L’installation automatique n’est pas prise en charge par OpenCode V2.",
  ...
  "settings.providers.method.command": "Commande",
  "settings.providers.method.mixed": "Clé API, OAuth ou commande",
  ...
  "settings.providers.prompt.customValuesPlaceholder": "Valeurs supplémentaires, séparées par des virgules",
  "settings.providers.command.description": "OpenCode exécutera la commande d'authentification native de ce fournisseur.",
  "settings.providers.command.waitingTitle": "En attente de l'authentification par commande",
  "settings.providers.command.waitingMessage": "Suivez les instructions affichées par la commande d'authentification.",
  ...
  "settings.behavior.expansionDefaults.otherTools": "Autres",
  ...
  "settings.behavior.toolInputsVisibility.title": "Entrée",
  ...
  "settings.behavior.focusExistingWindowOnSecondLaunch.title": "Focaliser la fenêtre existante au second lancement",
  "settings.behavior.focusExistingWindowOnSecondLaunch.subtitle": "Ramener la fenêtre CodeNomad la plus récente au premier plan au lieu d'en ouvrir une nouvelle.",
  ...
  "settings.info.diagnostics.reportTitle": "Rapport de diagnostic CodeNomad",
  "settings.info.diagnostics.generated": "Généré",
  "settings.info.connectivity.title": "Connectivité du serveur CodeNomad",
  "settings.info.connectivity.subtitle": "Consultez la configuration d’écoute actuellement utilisée et les adresses réseau possibles.",
  "settings.info.connectivity.mode.local": "Local uniquement",
  "settings.info.connectivity.mode.all": "Toutes les interfaces réseau",
  "settings.info.connectivity.mode.specific": "Interface réseau spécifique",
  "settings.info.connectivity.host": "Hôte d’écoute",
  "settings.info.connectivity.localListener": "Point d’écoute local",
  "settings.info.connectivity.remoteListener": "Point d’écoute distant",
  "settings.info.connectivity.disclaimer": "Ces adresses sont dérivées des interfaces réseau. Les paramètres du pare-feu, du routeur ou des certificats peuvent malgré tout empêcher les connexions.",
  "settings.info.connectivity.loadFailed": "Impossible de charger les informations de connectivité du serveur CodeNomad.",
  "settings.info.diagnostics.privacy": "Vérifiez ce rapport avant de le partager. Il contient des chemins locaux et des adresses réseau, mais jamais de mots de passe ni de secrets d’authentification.",
