export const settingsMessages = {
  ...
  "settings.usage.noProject": "Ouvrez un projet pour connecter son service OpenCode et consulter l’utilisation globale du service.",
  "settings.usage.period": "Période",
  "settings.usage.days": "{count} derniers jours",
  "settings.usage.loading": "Chargement de l’utilisation…",
  "settings.usage.error": "Actualisation de l’utilisation du service impossible. Une connexion OpenCode est nécessaire. Les données affichées proviennent de la dernière actualisation réussie.",
