export const settingsMessages = {
  ...
  "settings.usage.scope": "Statistiques natives de ce projet Git et de ses worktrees, sous-sessions incluses. Périodes glissantes ; l’activité suit le fuseau affiché.",
  "settings.usage.noProject": "Ouvrez un projet Git pour consulter l’utilisation.",
  "settings.usage.period": "Période",
  "settings.usage.days": "{count} derniers jours",
  "settings.usage.loading": "Chargement de l’utilisation…",
  "settings.usage.error": "Actualisation impossible. Un projet Git vérifié et une connexion OpenCode sont nécessaires. Les données affichées proviennent de la dernière actualisation réussie.",
