export const settingsMessages = {
  ...
  "settings.speech.error.urlChangeKeyRequired.title": "Endpoint modifié",
  "settings.speech.error.urlChangeKeyRequired.stt": "Vous avez modifié l'URL d'entrée sans saisir de nouvelle clé API. Saisissez une nouvelle clé ou effacez d'abord la clé enregistrée.",
  "settings.speech.error.urlChangeKeyRequired.tts": "Vous avez modifié l'URL de sortie sans saisir de nouvelle clé API. Saisissez une nouvelle clé ou effacez d'abord la clé enregistrée.",
  "settings.speech.error.urlChangeKeyRequired.both": "Vous avez modifié les deux URLs sans saisir de nouvelles clés API. Saisissez de nouvelles clés ou effacez les clés enregistrées.",
