export const settingsMessages = {
  ...
  "settings.appearance.gitDiff.gutterMode.title": "Mode de gouttiere du diff Git",
  "settings.appearance.gitDiff.gutterMode.subtitle": "Choisir la presentation de gouttiere Monaco utilisee pour les diffs des changements Git.",
