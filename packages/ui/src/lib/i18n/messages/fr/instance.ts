export const instanceMessages = {
  ...
  "instanceShell.rightPanel.errors.gitStatusFailed": "Échec du chargement du statut git",
  "instanceShell.rightPanel.errors.diffNotAvailable": "Le diff du fichier supprimé n'est pas encore disponible",
  "instanceShell.rightPanel.errors.binaryFile": "Impossible d'afficher le fichier binaire",
  "instanceShell.rightPanel.errors.unsupportedType": "Type de fichier non pris en charge",
  "instanceShell.rightPanel.errors.fileChangesFailed": "Échec du chargement des modifications du fichier",
  "instanceShell.rightPanel.errors.filesLoadFailed": "Échec du chargement de la liste des fichiers",
  "instanceShell.rightPanel.errors.fileReadFailed": "Échec de la lecture du fichier",
  "instanceShell.rightPanel.errors.fileSaveFailed": "Échec de l'enregistrement du fichier",
