export const instanceMessages = {
  ...
  "instanceShell.rightPanel.tabs.workflows": "Flux de travail",
  "instanceShell.rightPanel.tabs.ariaLabel": "Onglets du panneau droit",
  "instanceShell.workflows.builder.title": "Nouveau flux",
  "instanceShell.workflows.builder.description": "Exécuter une suite d’étapes confiées aux agents.",
  "instanceShell.workflows.objective.label": "Objectif",
  "instanceShell.workflows.objective.placeholder": "Décrivez le résultat attendu",
  "instanceShell.workflows.stages.title": "Étapes",
  "instanceShell.workflows.stages.count": "{count} sur {max}",
  "instanceShell.workflows.stages.number": "Étape {number}",
  "instanceShell.workflows.fields.title": "Titre",
  "instanceShell.workflows.fields.instructions": "Instructions",
  "instanceShell.workflows.fields.agent": "Agent",
  "instanceShell.workflows.fields.model": "Modèle",
  "instanceShell.workflows.fields.requiresApproval": "Demander une approbation après cette étape",
  "instanceShell.workflows.defaults.planner.title": "Planificateur",
  "instanceShell.workflows.defaults.planner.instructions": "Créez un plan de mise en œuvre clair pour l’objectif.",
  "instanceShell.workflows.defaults.implementer.title": "Réalisateur",
  "instanceShell.workflows.defaults.implementer.instructions": "Mettez en œuvre le plan et validez le résultat.",
  "instanceShell.workflows.defaults.newStage.title": "Étape {number}",
  "instanceShell.workflows.actions.moveUp": "Monter l’étape",
  "instanceShell.workflows.actions.moveDown": "Descendre l’étape",
  "instanceShell.workflows.actions.removeStage": "Supprimer l’étape",
  "instanceShell.workflows.actions.addStage": "Ajouter une étape",
  "instanceShell.workflows.actions.start": "Démarrer le flux",
  "instanceShell.workflows.actions.starting": "Démarrage...",
  "instanceShell.workflows.actions.refresh": "Actualiser les flux",
  "instanceShell.workflows.actions.approve": "Approuver",
  "instanceShell.workflows.actions.keepWaiting": "Continuer d’attendre",
  "instanceShell.workflows.actions.cancel": "Annuler le flux",
  "instanceShell.workflows.actions.keepRunning": "Laisser continuer",
  "instanceShell.workflows.actions.openSession": "Ouvrir la session générée",
  "instanceShell.workflows.history.title": "Historique des exécutions",
  "instanceShell.workflows.history.description": "Flux actuels et précédents de cet espace de travail.",
  "instanceShell.workflows.history.loading": "Chargement des flux...",
  "instanceShell.workflows.history.empty": "Aucun flux exécuté.",
  "instanceShell.workflows.confirm.approve.message": "Approuver l’étape terminée et poursuivre ce flux ?",
  "instanceShell.workflows.confirm.cancel.message": "Annuler ce flux ? Le travail en cours sera arrêté.",
  "instanceShell.workflows.errors.action": "L’action sur le flux a échoué.",
  "instanceShell.workflows.errors.openSession": "Impossible d’ouvrir la session générée.",
  "instanceShell.workflows.output": "Sortie",
  "instanceShell.workflows.outputTruncated": "La sortie a été raccourcie. Ouvrez la session générée pour consulter la sortie complète.",
  "instanceShell.workflows.live.statusChanged": "Le statut du flux est passé à {status}.",
  "instanceShell.workflows.status.pending": "En attente",
  "instanceShell.workflows.status.running": "En cours",
  "instanceShell.workflows.status.waiting_for_review": "En attente de validation",
  "instanceShell.workflows.status.completed": "Terminé",
  "instanceShell.workflows.status.failed": "Échec",
  "instanceShell.workflows.status.cancelled": "Annulé",
  "instanceShell.workflows.status.interrupted": "Interrompu",
  "instanceShell.rightPanel.modules.core": "Noyau CodeNomad",
