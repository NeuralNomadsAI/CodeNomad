export const instanceMessages = {
  ...
  "gitPanel.detached": "HEAD détachée",
  "gitPanel.filter": "Filtrer les commits chargés…",
  "gitPanel.emptyHistory": "Aucun commit à afficher",
  "gitPanel.more": "Charger les commits précédents",
  "gitPanel.files": "{count} fichiers modifiés",
  "gitPanel.actions": "Actions Git",
  "gitPanel.diff": "Diff Git",
  "gitPanel.parentDiff": "Comparaison avec le premier parent",
  "gitPanel.backChat": "Retour à la conversation",
