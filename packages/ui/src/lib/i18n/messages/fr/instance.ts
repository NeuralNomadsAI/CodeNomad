export const instanceMessages = {
  ...
  "instanceTabs.developerMode.enableTitle": "Activer le mode développeur",
  "instanceTabs.developerMode.disableTitle": "Désactiver le mode développeur",
  "instanceTabs.developerMode.restartTitle": "{action} ; redémarrez CodeNomad pour appliquer la modification",
  "instanceTabs.developerMode.enabledToast": "Mode développeur activé. Redémarrez CodeNomad pour appliquer la modification.",
  "instanceTabs.developerMode.disabledToast": "Mode développeur désactivé. Redémarrez CodeNomad pour appliquer la modification.",
  "instanceTabs.developerMode.error": "Impossible d’accéder au mode développeur.",
  ...
  "instanceInfo.server.title": "Processus OpenCode",
  ...
  "instanceShell.backgroundProcesses.error": "Impossible de charger les shells en arrière-plan.",
  "instanceShell.backgroundProcesses.empty": "Aucun shell en arrière-plan.",
  "instanceShell.backgroundProcesses.status.running": "En cours",
  "instanceShell.backgroundProcesses.status.exited": "Terminé",
  "instanceShell.backgroundProcesses.status.timeout": "Délai dépassé",
  "instanceShell.backgroundProcesses.status.killed": "Arrêté",
  "instanceShell.backgroundProcesses.pid": "PID {pid}",
  "instanceShell.backgroundProcesses.exitCode": "Sortie {code}",
  "instanceShell.backgroundProcesses.actions.stopRemove": "Arrêter et supprimer",
  "instanceShell.backgroundProcesses.actions.remove": "Supprimer",
  "instanceShell.backgroundProcesses.actions.output": "Afficher la sortie",
  "instanceShell.backgroundProcesses.remove.title": "Supprimer le shell en arrière-plan",
  "instanceShell.backgroundProcesses.remove.message": "Supprimer \"{title}\" ? Un processus en cours sera arrêté.",
  ...
  "instanceShell.worktree.unavailable": "Indisponible",
  "instanceShell.worktree.create.fromCurrentBranch": "Nouveau depuis la branche actuelle",
  "instanceShell.worktree.create.action": "Créer et utiliser le worktree",
  "instanceShell.worktree.create.description": "Crée une branche Git nommée depuis le checkout de cette session et déplace sa famille vers le nouveau worktree. Les modifications non committées restent dans le checkout d’origine.",
  "instanceShell.worktree.create.name": "Nom",
  "instanceShell.worktree.create.placeholder": "nom-du-worktree",
  "instanceShell.worktree.create.success": "Worktree {slug} créé",
  "instanceShell.worktree.create.error": "Impossible de créer le worktree",
  ...
  "instanceShell.worktree.delete.action": "Supprimer le worktree",
  "instanceShell.worktree.delete.description": "Supprime ce worktree de branche et son dossier local.",
  ...
  "opencodeBinarySelector.customPath.placeholder": "Saisissez le chemin vers le binaire {name}…",
