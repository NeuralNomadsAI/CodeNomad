export const instanceMessages = {
  ...
  "instanceShell.rightPanel.sections.backgroundProcesses.tooltip": "PTY OpenCode pour l'espace de travail ou le worktree actif.",
  ...
  "instanceShell.backgroundProcesses.actions.rename": "Renommer",
  ...
  "instanceShell.backgroundProcesses.rename.title": "Renommer le shell en arrière-plan",
  "instanceShell.backgroundProcesses.rename.message": "Saisissez un nouveau titre pour ce shell en arrière-plan.",
  "instanceShell.backgroundProcesses.rename.inputLabel": "Titre",
