export const commandMessages = {
  ...
  "commands.removeSessionTechnicalParts.label": "Supprimer les outils et raisonnements de la session",
  "commands.removeSessionTechnicalParts.description": "Conserver les réponses finales et supprimer les outils et raisonnements terminés",
  "commands.removeSessionTechnicalParts.keywords": "nettoyage, outils, raisonnements, supprimer, session",
  "commands.removeSessionTechnicalParts.empty.title": "Rien à supprimer",
  "commands.removeSessionTechnicalParts.empty.message": "Cette session ne contient aucun outil ou raisonnement terminé.",
  "commands.removeSessionTechnicalParts.confirm.title": "Supprimer les outils et raisonnements ?",
  "commands.removeSessionTechnicalParts.confirm.message": "Sorties d'outils : {toolCount} ; raisonnements : {reasoningCount}. Le texte final sera conservé.",
  "commands.removeSessionTechnicalParts.confirm.label": "Supprimer",
  "commands.removeSessionTechnicalParts.failed.title": "Échec de suppression",
  "commands.removeSessionTechnicalParts.failed.message": "Le nettoyage de {count} réponses a échoué.",
