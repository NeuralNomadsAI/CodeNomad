export const commandMessages = {
  ...
  "commands.removeSessionTechnicalParts.label": "Sitzungs-Tools und Denkprozesse entfernen",
  "commands.removeSessionTechnicalParts.description": "Finale Antworten behalten und abgeschlossene Tools und Denkprozesse entfernen",
  "commands.removeSessionTechnicalParts.keywords": "bereinigen, tools, denken, entfernen, sitzung",
  "commands.removeSessionTechnicalParts.empty.title": "Nichts zu entfernen",
  "commands.removeSessionTechnicalParts.empty.message": "Diese Sitzung enthält keine abgeschlossenen Tool-Ausgaben oder Denkblöcke.",
  "commands.removeSessionTechnicalParts.confirm.title": "Tools und Denkprozesse entfernen?",
  "commands.removeSessionTechnicalParts.confirm.message": "Tool-Ausgaben: {toolCount}; Denkblöcke: {reasoningCount}. Der finale Text bleibt erhalten.",
  "commands.removeSessionTechnicalParts.confirm.label": "Entfernen",
  "commands.removeSessionTechnicalParts.failed.title": "Entfernen fehlgeschlagen",
  "commands.removeSessionTechnicalParts.failed.message": "{count} Antworten konnten nicht bereinigt werden.",
