export const messagingMessages = {
  ...
  "promptInput.attachFiles.title": "עיון בקבצי סביבת העבודה",
  "promptInput.attachFiles.upload": "העלאת קבצים מהמכשיר הזה",
  "promptInput.attachFiles.dialogTitle": "בחירת קובץ מסביבת העבודה",
