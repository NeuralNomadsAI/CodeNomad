export const messagingMessages = {
  ...
  "promptInput.btw.question": "השאלה שלך",
  "promptInput.btw.answer": "תשובה",
  "promptInput.btw.ask": "שאל",
  "promptInput.btw.loading": "חושב…",
  "promptInput.btw.cancel": "בטל שאלה",
  "promptInput.btw.close": "סגור שאלה צדדית",
  "promptInput.btw.empty": "המודל לא החזיר טקסט. נסה לנסח מחדש את השאלה.",
  "promptInput.btw.failed": "לא ניתן לענות על השאלה הצדדית.",
  "promptInput.btw.copy": "העתק תשובה",
  "promptInput.btw.copied": "הועתק",
  "promptInput.btw.copyFailed": "לא ניתן להעתיק את התשובה.",
  ...
  "history.technical": "כלול כלים וחשיבה",
  "history.counts": "{messages} הודעות · {tools} כלים · {reasoning} קטעי חשיבה",
  "history.scanning": "סופר…",
  "history.snapshot": "תמונת מצב של ההיסטוריה",
  "history.skipped": "לא ניתן היה לעבד באופן מלא {count} הודעות.",
  "history.more": "התוצאות הבאות",
  "history.text": "טקסט",
  "history.tool": "כלי",
  "history.reasoning": "חשיבה",
  "history.planning": "בדיקת היסטוריה: {count} הודעות",
  "history.pruning": "ניקוי: {count} / {total} הודעות",
  "transcriptFilters.title": "תוכן ההודעות",
  "transcriptFilters.systemMessages": "מערכת",
  ...
  "messageBlock.reasoning.thoughtLabel": "מחשבה",
  "messageBlock.reasoning.steps.one": "שלב {count}",
  "messageBlock.reasoning.steps.other": "{count} שלבים",
  "messageBlock.exploration.completed": "החקירה הושלמה: {tools}",
  "messageBlock.exploration.active": "חוקר: {tools}",
  "messageBlock.exploration.read.one": "קריאה אחת",
  ...
  "messageItem.actions.deleteTechnicalParts": "הסר כלים וחשיבה מהתשובה הזו",
  "messageItem.actions.deleteTechnicalParts.confirmTitle": "להסיר כלים וחשיבה?",
  "messageItem.actions.deleteTechnicalParts.confirmMessage": "פלטי כלים: {toolCount}; מקטעי חשיבה: {reasoningCount}. הטקסט הסופי יישמר.",
  "messageItem.actions.deleteTechnicalParts.confirmLabel": "הסר",
  "messageItem.actions.deleteTechnicalParts.failedTitle": "ההסרה נכשלה",
  "messageItem.actions.deleteTechnicalParts.failedMessage": "לא ניתן להסיר כלים וחשיבה מהתשובה",
  ...
  "messagePart.actions.delete": "מחק",
  ...
  "promptInput.attachFiles.title": "צירוף קובץ…",
  "promptInput.attachFiles.help": "בחירת קבצים מהמכשיר הזה",
  "promptInput.attachFiles.reading": "קריאת קבצים…",
  "promptInput.hints.projectFiles": "הפניה לקבצי הפרויקט",
  "promptInput.attachFiles.deviceDetail": "מכשיר: {name} · {bytes} בתים",
  "promptInput.attachFiles.projectDetail": "פרויקט: {path}",
  "promptInput.attachFiles.rejected.tooLarge": "{name}: חורג מ־5 MiB לקובץ.",
  "promptInput.attachFiles.rejected.limit": "{name}: חורג מ־10 קבצים או 20 MiB בסך הכול.",
  "promptInput.attachFiles.rejected.unreadable": "{name}: לא ניתן לקרוא את הקובץ.",
  ...
  "promptInput.attachFiles.tooLarge.other": "לא ניתן היה לצרף {count} קבצים נבחרים כי הם גדולים ממגבלת הקבצים המצורפים של 5 MB.",
  "promptInput.attachFiles.limit.one": "קובץ נבחר אחד לא צורף כי ניתן לצרף עד {maxFiles} קבצים ובסך הכול {maxMegabytes} MB.",
  "promptInput.attachFiles.limit.other": "{count} קבצים נבחרים לא צורפו כי ניתן לצרף עד {maxFiles} קבצים ובסך הכול {maxMegabytes} MB.",
  "promptInput.attachFiles.deviceRejected.one": "קובץ נבחר אחד לא צורף. הקבצים חייבים להיות קריאים, בגודל של עד {maxFileMegabytes} MB כל אחד, ובגבול של {maxFiles} קבצים ו-{maxTotalMegabytes} MB בסך הכול.",
  "promptInput.attachFiles.deviceRejected.other": "{count} קבצים נבחרים לא צורפו. הקבצים חייבים להיות קריאים, בגודל של עד {maxFileMegabytes} MB כל אחד, ובגבול של {maxFiles} קבצים ו-{maxTotalMegabytes} MB בסך הכול.",
  ...
  "promptInput.send.queueAriaLabel": "הוסף הודעה לתור",
  "promptQueue.title": "תור הנחיות ({count})",
  "promptQueue.delivery.queue": "בתור",
  "promptQueue.delivery.steer": "מוזרק כעת",
  "promptQueue.attachments.one": "קובץ מצורף אחד",
  "promptQueue.attachments.other": "{count} קבצים מצורפים",
  ...
  "promptQueue.error.message": "לא ניתן לעדכן את תור ההנחיות",
