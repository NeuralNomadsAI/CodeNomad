export const messagingMessages = {
  ...
  "promptInput.voiceInput.liveMode": "פתח מצב קולי חי",
  "promptInput.resizeHandle.title": "גרור כדי לשנות את גובה שדה הקלט",
  "voice.hud.title": "מצב קולי חי",
  "voice.hud.connecting": "מתחבר...",
  "voice.hud.listening": "מקשיב...",
  "voice.hud.speaking": "מדבר...",
  "voice.hud.idle": "מוכן",
  "voice.hud.error": "שגיאת חיבור קולי",
  "voice.hud.muted": "מושתק",
  "voice.hud.mute": "השתק מיקרופון",
  "voice.hud.unmute": "בטל השתקת מיקרופון",
  "voice.hud.interrupt": "הפסק תגובה",
  "voice.hud.close": "סגור מצב קולי",
  "voice.hud.deadman_timeout": "מצב קולי נסגר עקב חוסר פעילות",
  "voice.hud.empty_transcript": "התחל לדבר כדי להתחיל בשיחה...",
  "voice.hud.switch_provider": "החלף ספק קולי",
} as const
