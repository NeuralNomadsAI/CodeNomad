export const instanceMessages = {
  ...
  "instanceShell.rightPanel.tabs.workflows": "תהליכי עבודה",
  "instanceShell.rightPanel.tabs.ariaLabel": "לשוניות לוח ימני",
  "instanceShell.workflows.builder.title": "תהליך עבודה חדש",
  "instanceShell.workflows.builder.description": "הרצת רצף של שלבים באמצעות סוכנים.",
  "instanceShell.workflows.objective.label": "מטרה",
  "instanceShell.workflows.objective.placeholder": "תארו את התוצאה הרצויה",
  "instanceShell.workflows.stages.title": "שלבים",
  "instanceShell.workflows.stages.count": "{count} מתוך {max}",
  "instanceShell.workflows.stages.number": "שלב {number}",
  "instanceShell.workflows.fields.title": "כותרת",
  "instanceShell.workflows.fields.instructions": "הוראות",
  "instanceShell.workflows.fields.agent": "סוכן",
  "instanceShell.workflows.fields.model": "מודל",
  "instanceShell.workflows.fields.requiresApproval": "דרישת אישור לאחר שלב זה",
  "instanceShell.workflows.defaults.planner.title": "מתכנן",
  "instanceShell.workflows.defaults.planner.instructions": "צרו תוכנית מימוש ברורה עבור המטרה.",
  "instanceShell.workflows.defaults.implementer.title": "מממש",
  "instanceShell.workflows.defaults.implementer.instructions": "ממשו את התוכנית ואמתו את התוצאה.",
  "instanceShell.workflows.defaults.newStage.title": "שלב {number}",
  "instanceShell.workflows.actions.moveUp": "העברת השלב למעלה",
  "instanceShell.workflows.actions.moveDown": "העברת השלב למטה",
  "instanceShell.workflows.actions.removeStage": "הסרת שלב",
  "instanceShell.workflows.actions.addStage": "הוספת שלב",
  "instanceShell.workflows.actions.start": "התחלת תהליך",
  "instanceShell.workflows.actions.starting": "מתחיל...",
  "instanceShell.workflows.actions.refresh": "רענון תהליכים",
  "instanceShell.workflows.actions.approve": "אישור",
  "instanceShell.workflows.actions.keepWaiting": "המשך המתנה",
  "instanceShell.workflows.actions.cancel": "ביטול תהליך",
  "instanceShell.workflows.actions.keepRunning": "המשך הרצה",
  "instanceShell.workflows.actions.openSession": "פתיחת הסשן שנוצר",
  "instanceShell.workflows.history.title": "היסטוריית הרצות",
  "instanceShell.workflows.history.description": "תהליכים נוכחיים וקודמים בסביבת עבודה זו.",
  "instanceShell.workflows.history.loading": "טוען תהליכים...",
  "instanceShell.workflows.history.empty": "עדיין אין הרצות תהליך.",
  "instanceShell.workflows.confirm.approve.message": "לאשר את השלב שהושלם ולהמשיך בתהליך?",
  "instanceShell.workflows.confirm.cancel.message": "לבטל תהליך זה? העבודה הפעילה תיעצר.",
  "instanceShell.workflows.errors.action": "פעולת תהליך העבודה נכשלה.",
  "instanceShell.workflows.errors.openSession": "לא ניתן לפתוח את הסשן שנוצר.",
  "instanceShell.workflows.output": "פלט",
  "instanceShell.workflows.outputTruncated": "הפלט קוצר. פתחו את הסשן שנוצר כדי לראות את הפלט המלא.",
  "instanceShell.workflows.live.statusChanged": "סטטוס תהליך העבודה השתנה ל-{status}.",
  "instanceShell.workflows.status.pending": "ממתין",
  "instanceShell.workflows.status.running": "פועל",
  "instanceShell.workflows.status.waiting_for_review": "ממתין לבדיקה",
  "instanceShell.workflows.status.completed": "הושלם",
  "instanceShell.workflows.status.failed": "נכשל",
  "instanceShell.workflows.status.cancelled": "בוטל",
  "instanceShell.workflows.status.interrupted": "הופסק",
  "instanceShell.rightPanel.modules.core": "ליבת CodeNomad",
