export const instanceMessages = {
  ...
  "gitPanel.history": "היסטוריה",
  "filesPanel.workspace": "סביבת עבודה",
  "filesPanel.commits": "קומיטים",
  ...
  "gitPanel.detached": "HEAD מנותק",
  "gitPanel.filter": "סינון קומיטים שנטענו…",
  "gitPanel.emptyHistory": "אין קומיטים להצגה",
  "gitPanel.more": "טעינת קומיטים קודמים",
  "gitPanel.files": "{count} קבצים שהשתנו",
  "gitPanel.actions": "פעולות Git",
  "gitPanel.diff": "הבדלי Git",
  "gitPanel.parentDiff": "השוואה להורה הראשון",
  "gitPanel.backChat": "חזרה לשיחה",
  ...
  "instanceShell.backgroundProcesses.error": "טעינת מעטפות הרקע נכשלה.",
  "instanceShell.backgroundProcesses.empty": "אין מעטפות רקע.",
  "instanceShell.backgroundProcesses.status.running": "פועל",
  "instanceShell.backgroundProcesses.status.exited": "הסתיים",
  "instanceShell.backgroundProcesses.status.timeout": "תם הזמן",
  "instanceShell.backgroundProcesses.status.killed": "הופסק",
  "instanceShell.backgroundProcesses.pid": "PID {pid}",
  "instanceShell.backgroundProcesses.exitCode": "יציאה {code}",
  "instanceShell.backgroundProcesses.actions.stopRemove": "עצור והסר",
  "instanceShell.backgroundProcesses.actions.remove": "הסר",
  "instanceShell.backgroundProcesses.actions.output": "הצגת פלט",
  "instanceShell.backgroundProcesses.remove.title": "הסרת מעטפת רקע",
  "instanceShell.backgroundProcesses.remove.message": "להסיר את \"{title}\"? תהליך פעיל ייעצר.",
  ...
  "instanceShell.worktree.unavailable": "לא זמין",
  "instanceShell.worktree.create.fromCurrentBranch": "חדש מהענף הנוכחי",
  "instanceShell.worktree.create.action": "יצירה ושימוש ב-worktree",
  "instanceShell.worktree.create.description": "יוצר ענף Git בעל שם מה-checkout של השיחה ומעביר את משפחת השיחות ל-worktree החדש. שינויים שלא בוצע להם commit נשארים ב-checkout המקורי.",
  "instanceShell.worktree.create.name": "שם",
  "instanceShell.worktree.create.placeholder": "worktree-name",
  "instanceShell.worktree.create.success": "ה-worktree {slug} נוצר",
  "instanceShell.worktree.create.error": "יצירת ה-worktree נכשלה",
  ...
  "instanceShell.worktree.delete.action": "מחק worktree",
  "instanceShell.worktree.delete.description": "מוחק את ה-worktree של הענף ואת התיקייה המקומית שלו.",
  "instanceShell.worktree.delete.target": "Worktree \"{slug}\"",
  "instanceShell.worktree.delete.force": "מחיקה בכפייה (זריקת שינויים מקומיים)",
  "instanceShell.worktree.delete.success": "ה-worktree {slug} נמחק",
