export const instanceMessages = {
  ...
  "instanceShell.rightPanel.sections.backgroundProcesses.tooltip": "מסופי OpenCode עבור סביבת העבודה או עץ העבודה הפעיל.",
  ...
  "instanceShell.backgroundProcesses.actions.rename": "שנה שם",
  "instanceShell.backgroundProcesses.actions.stopRemove": "עצור והסר",
  "instanceShell.backgroundProcesses.actions.remove": "הסר",
  "instanceShell.backgroundProcesses.rename.title": "שינוי שם מעטפת רקע",
  "instanceShell.backgroundProcesses.rename.message": "הזן כותרת חדשה למעטפת הרקע.",
  "instanceShell.backgroundProcesses.rename.inputLabel": "כותרת",
