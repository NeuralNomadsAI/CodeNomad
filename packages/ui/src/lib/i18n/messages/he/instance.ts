export const instanceMessages = {
  ...
  "instanceShell.rightPanel.errors.gitStatusFailed": "טעינת מצב git נכשלה",
  "instanceShell.rightPanel.errors.diffNotAvailable": "ה-diff של הקובץ שנמחק אינו זמין עדיין",
  "instanceShell.rightPanel.errors.binaryFile": "לא ניתן להציג קובץ בינארי",
  "instanceShell.rightPanel.errors.unsupportedType": "סוג קובץ לא נתמך",
  "instanceShell.rightPanel.errors.fileChangesFailed": "טעינת שינויי הקובץ נכשלה",
  "instanceShell.rightPanel.errors.filesLoadFailed": "טעינת רשימת הקבצים נכשלה",
  "instanceShell.rightPanel.errors.fileReadFailed": "קריאת הקובץ נכשלה",
  "instanceShell.rightPanel.errors.fileSaveFailed": "שמירת הקובץ נכשלה",
