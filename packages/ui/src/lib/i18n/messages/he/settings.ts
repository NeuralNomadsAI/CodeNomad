export const settingsMessages = {
  ...
  "settings.usage.noProject": "פתח פרויקט כדי להתחבר לשירות OpenCode ולהציג שימוש בכל השירות.",
  "settings.usage.period": "תקופה",
  "settings.usage.days": "{count} הימים האחרונים",
  "settings.usage.loading": "טוען שימוש…",
  "settings.usage.error": "רענון שימוש השירות נכשל. נדרש חיבור OpenCode. הנתונים המוצגים הם מהרענון המוצלח האחרון.",
