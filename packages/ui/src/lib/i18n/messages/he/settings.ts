export const settingsMessages = {
  ...
  "settings.speech.error.urlChangeKeyRequired.title": "נקודת קצה שונתה",
  "settings.speech.error.urlChangeKeyRequired.stt": "שינית את כתובת הקלט אך לא הזנת מפתח API חדש. הזן מפתח חדש או נקה את המפתח השמור תחילה.",
  "settings.speech.error.urlChangeKeyRequired.tts": "שינית את כתובת הפלט אך לא הזנת מפתח API חדש. הזן מפתח חדש או נקה את המפתח השמור תחילה.",
  "settings.speech.error.urlChangeKeyRequired.both": "שינית את שתי הכתובות אך לא הזנת מפתחות API חדשים. הזן מפתחות חדשים או נקה את המפתחות השמורים תחילה.",
