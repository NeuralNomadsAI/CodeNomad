export const settingsMessages = {
  ...
  "modelSelector.error.noVisibleModels": "יש לבחור לפחות מודל גלוי אחד לפני שליחת הודעה.",
  ...
  "settings.providers.modelVisibility.mode.label": "מצב נראות מודלים",
  "settings.providers.modelVisibility.mode.all": "כל המודלים",
  "settings.providers.modelVisibility.mode.all.description": "הצג מודלים נוכחיים וחדשים.",
  "settings.providers.modelVisibility.mode.custom": "מותאם אישית",
  "settings.providers.modelVisibility.mode.custom.description": "הצג רק מזהי מודלים שנבחרו.",
  ...
  "settings.providers.modelVisibility.count": "{selected} מתוך {total} נבחרו",
  "settings.providers.modelVisibility.selectAll": "בחר הכול",
  "settings.providers.modelVisibility.selectNone": "בטל בחירת הכול",
  "settings.providers.modelVisibility.unavailable.one": "מודל נבחר אחד אינו זמין כעת.",
  "settings.providers.modelVisibility.unavailable.other": "{count} מודלים שנבחרו אינם זמינים כעת.",
  "settings.providers.modelVisibility.empty": "אין מודלים התואמים לחיפוש.",
  "settings.providers.modelVisibility.listAriaLabel": "מודלים עבור {provider}",
  "settings.providers.modelVisibility.saveFailed": "שמירת נראות המודלים נכשלה.",
