export const settingsMessages = {
  ...
  "instanceServiceStatus.plugins.errors.save": "לא ניתן לשמור את כלל הפעלת התוסף. [{scope} {name}]",
  "instanceServiceStatus.plugins.errors.forbidden": "לסביבת עבודה זו אין הרשאה לשנות מיקום תוסף זה. [{scope} {name}]",
  "instanceServiceStatus.plugins.errors.conflict": "הפרויקט או התצורה השתנו במקביל. יש לרענן ולנסות שוב. [{scope} {name}]",
  "instanceServiceStatus.plugins.errors.invalidConfig": "תצורת OpenCode שנבחרה פגומה ולא שונתה. [{scope} {name}]",
