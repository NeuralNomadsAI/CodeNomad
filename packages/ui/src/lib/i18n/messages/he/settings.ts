export const settingsMessages = {
  ...
  "settings.usage.scope": "סטטיסטיקות מקוריות לפרויקט Git ול-worktrees שלו, כולל תתי-שיחות. התקופות מתגלגלות והפעילות לפי אזור הזמן המוצג.",
  "settings.usage.noProject": "פתח פרויקט Git להצגת השימוש.",
  "settings.usage.period": "תקופה",
  "settings.usage.days": "{count} הימים האחרונים",
  "settings.usage.loading": "טוען שימוש…",
  "settings.usage.error": "רענון נכשל. נדרשים פרויקט Git מאומת וחיבור OpenCode. הנתונים המוצגים הם מהרענון המוצלח האחרון.",
