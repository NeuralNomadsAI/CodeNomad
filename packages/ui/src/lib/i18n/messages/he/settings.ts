export const settingsMessages = {
  ...
  "settings.appearance.gitDiff.gutterMode.title": "מצב השוליים של diff Git",
  "settings.appearance.gitDiff.gutterMode.subtitle": "בחר את תצוגת השוליים של Monaco עבור diff-ים בלשונית שינויי Git.",
  "settings.appearance.gitDiff.gutterMode.option.compact": "קומפקטי",
  "settings.appearance.gitDiff.gutterMode.option.normal": "רגיל",
