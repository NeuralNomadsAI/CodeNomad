export const settingsMessages = {
  ...
  "settings.nav.remote": "שליטה מרחוק",
  ...
  "settings.section.remote.title": "שליטה מרחוק",
  "settings.section.remote.subtitle": "המשך באופן מאובטח את ההפעלות של מכשיר זה ממכשיר אחר דרך הממסר היוצא.",
