export const settingsMessages = {
  "settings.usage.title": "סטטיסטיקות",
  "settings.usage.scope": "כל שירות OpenCode המחובר: כל הפרויקטים, העותקים העצמאיים ותתי-השיחות. הנתונים אינם מוגבלים לתיקייה הפתוחה. התקופות מתגלגלות והפעילות לפי אזור הזמן המוצג.",
  "settings.usage.noProject": "פתח פרויקט כדי להתחבר לשירות OpenCode ולהציג סטטיסטיקות של השירות כולו.",
  "settings.usage.period": "תקופה",
  "settings.usage.days": "{count} הימים האחרונים",
  "settings.usage.loading": "טוען סטטיסטיקות…",
  "settings.usage.error": "רענון סטטיסטיקות השירות נכשל. נדרש חיבור OpenCode. הנתונים המוצגים הם מהרענון המוצלח האחרון.",
  "settings.usage.sessions": "שיחות",
  "settings.usage.subagents": "תתי-שיחות",
  "settings.usage.prompts": "בקשות",
  "settings.usage.steps": "צעדים",
  "settings.usage.input": "טוקני קלט",
  "settings.usage.output": "טוקני פלט",
  "settings.usage.reasoning": "טוקני חשיבה",
  "settings.usage.cacheRead": "טוקני קריאה מהמטמון",
  "settings.usage.cacheWrite": "טוקני כתיבה למטמון",
  "settings.usage.activeDays": "ימים פעילים",
  "settings.usage.streak": "רצף (ימים)",
  "settings.usage.cost": "עלות מתועדת (USD)",
  "settings.usage.costHint": "עלויות וטוקנים מרישומי OpenCode. מכסות מנוי וחשבוניות ספק אינן נמדדות כאן.",
  "settings.usage.models": "לפי מודל",
  "settings.usage.model": "מודל",
  "settings.usage.activity": "פעילות יומית",
  ...
  "settings.websearch.effective": "חיפוש בפרויקט זה: {provider}",
  ...
  "settings.opencode.setup.sharedInstallDescription": "משתמש בהתקנת npm רגילה המשותפת ללקוחות אחרים. יש לפתוח מסוף חדש לאחר ההתקנה.",
  ...
  "settings.opencode.setup.disconnected": "OpenCode אינו מחובר.",
  ...
  "settings.opencode.setup.progress.start": "מתחבר ל־OpenCode…",
  "settings.opencode.setup.progress.restart": "מפעיל מחדש את השירות המשותף…",
  "settings.opencode.setup.progress.reload": "טוען מחדש את תצורת OpenCode…",
  ...
  "settings.opencode.setup.missing": "OpenCode אינו מותקן.",
  "settings.opencode.setup.update_required": "גרסת OpenCode זו אינה נתמכת בגרסה זו של CodeNomad.",
  "settings.opencode.setup.ready": "קובץ ההפעלה של OpenCode זמין.",
  "settings.opencode.setup.recommended": "גרסה מינימלית מומלצת",
  "settings.opencode.setup.untested": "OpenCode {version} לא נבדקה במלואה עם גרסה זו של CodeNomad. עובדה זו לבדה אינה מונעת התחברות.",
  "settings.opencode.setup.error": "לא ניתן לאמת את קובץ ההפעלה שנבחר.",
  "settings.opencode.setup.minimum": "גרסה מינימלית",
  "settings.opencode.setup.minimumReason": "OpenCode {version} הוסיפה את חותמת הזמן המקורית לתחילת שלב הנדרשת להצגת שיחות. גרסאות קודמות דורשות המרות אירועים שהוסרו.",
  "settings.opencode.setup.canonical_api": "השירות הפעיל אינו מספק את ממשק ה-API לשיחות, הרשאות, טפסים ותור הקלט הנדרש לגרסה זו של CodeNomad.",
  "settings.opencode.setup.session_environment": "השירות הפעיל אינו יכול להחליף את סביבת השיחה, פעולה הנדרשת לפני שליחת הודעות או פקודות.",
  "settings.opencode.setup.daemon": "השירות הפעיל",
  "settings.opencode.setup.install": "התקנה והפעלה של OpenCode",
  "settings.opencode.setup.connect": "התחברות והמשך",
  "settings.opencode.setup.restart": "הפעלה מחדש של השירות המשותף",
  "settings.opencode.setup.restartRequired": "יש לעדכן את השירות הפעיל. הפעלה מחדש תקטע עבודה פעילה בכל לקוחות OpenCode המחוברים.",
  "settings.opencode.setup.restartAvailable": "מותקנת גרסה חדשה יותר. אפשר להמשיך להשתמש בשירות הפעיל ולהפעיל אותו מחדש מאוחר יותר. הפעלה מחדש תקטע עבודה פעילה בכל לקוחות OpenCode המחוברים.",
  "settings.opencode.setup.serviceError": "לא ניתן לאמת את השירות המשותף. יש לבדוק את החיבור והאימות ולנסות שוב.",
  "settings.opencode.setup.manual": "יש לבחור קובץ הפעלה נתמך או להתקין @opencode/cli במחשב המבצע ולנסות שוב.",
  "settings.opencode.setup.wsl": "קובץ זה פועל בתוך WSL. יש להתקין או לעדכן את OpenCode בהפצה שנבחרה.",
  "settings.opencode.setup.chooseBinary": "בחירת קובץ הפעלה",
  "settings.opencode.setup.required": "נדרשת הגדרת OpenCode",
  ...
  "settings.appearance.palette.mist.description": "גווני אפור ניטרליים ורכים עם נגיעות קרירות.",
  "settings.appearance.palette.slate": "צפחה",
  "settings.appearance.palette.slate.description": "משטחים אפורים־כחלחלים והדגשות מינרליות עדינות.",
  "settings.appearance.palette.clay": "חימר",
  "settings.appearance.palette.clay.description": "גווני אפור אדמתיים וחמים ואוכרה מעודנת.",
  "settings.appearance.palette.linen": "פשתן",
  "settings.appearance.palette.linen.description": "נייר שנהב רך עם טקסט אפור־ירוק.",
  "settings.appearance.palette.iris": "איריס",
  "settings.appearance.palette.iris.description": "משטחים אפורים בגוון לבנדר קריר, ללא לבן בוהק.",
  "settings.appearance.palette.sage": "מרווה",
  "settings.appearance.palette.sage.description": "משטחים אפורים־ירוקים רגועים עם גווני זית.",
  "settings.appearance.palette.saved": "התאמה אישית שמורה",
  ...
  "instanceServiceStatus.plugins.scope.legend": "כתיבת הכלל הבא אל",
  "instanceServiceStatus.plugins.scope.global": "כללי",
  ...
  "instanceServiceStatus.plugins.runtime.active": "פעיל",
  "instanceServiceStatus.plugins.runtime.failed": "נכשל",
  "instanceServiceStatus.plugins.runtime.inactive": "לא פועל",
  "instanceServiceStatus.plugins.runtime.empty": "זמן הריצה אינו מדווח על תוספים.",
  "instanceServiceStatus.plugins.refresh": "רענון פקדי התוספים",
  "instanceServiceStatus.plugins.toggleAriaLabel": "שינוי כלל ההפעלה עבור {name}",
  "instanceServiceStatus.plugins.globalOverridden": "כלל פרויקט דורס כאן את המצב הכללי.",
  "instanceServiceStatus.plugins.source.package": "חבילה: {source}",
  "instanceServiceStatus.plugins.source.local": "מקור מקומי: {source}",
  "instanceServiceStatus.plugins.source.builtin": "מובנה ב-OpenCode",
  "instanceServiceStatus.plugins.source.sdk": "מסופק על ידי מארח ה-SDK",
  "instanceServiceStatus.plugins.ruleState.default": "בירושה",
  "instanceServiceStatus.plugins.ruleState.enabled": "מופעל בכלל",
  "instanceServiceStatus.plugins.ruleState.disabled": "מושבת בכלל",
  "instanceServiceStatus.plugins.toast.ruleSaved": "כלל ההפעלה {scope} עבור {name} נשמר.",
  "instanceServiceStatus.plugins.toast.ruleUnchanged": "כלל ההפעלה {scope} עבור {name} כבר מעודכן.",
  "instanceServiceStatus.plugins.toast.reloadNote": "הכלל ייכנס לתוקף כאשר תהליך הרקע יטען מחדש את התצורה שלו.",
  "instanceServiceStatus.plugins.errors.load": "לא ניתן לטעון את פקדי הפעלת התוספים.",
  "instanceServiceStatus.plugins.errors.refresh": "הרענון נכשל. המצב האחרון הידוע עדיין מוצג.",
  "instanceServiceStatus.plugins.errors.save": "לא ניתן לשמור את כלל ההפעלה עבור {name} בהיקף «{scope}».",
  "instanceServiceStatus.plugins.errors.forbidden": "לסביבת עבודה זו אין הרשאה לשנות את המיקום של {name} בהיקף «{scope}».",
  "instanceServiceStatus.plugins.errors.conflict": "הפרויקט או התצורה השתנו במהלך שמירת הכלל עבור {name} בהיקף «{scope}». יש לרענן ולנסות שוב.",
  "instanceServiceStatus.plugins.errors.invalidConfig": "תצורת OpenCode עבור {name} בהיקף «{scope}» אינה תקינה. היא לא שונתה.",
  ...
  "permissionBanner.detail.form.one": "טופס {count}",
  "permissionBanner.detail.form.other": "{count} טפסים",
  ...
  "settings.appearance.colorScheme.title": "ערכת צבעים",
  "settings.appearance.colorScheme.subtitle": "בחר את לוח הצבעים ללקוחות המחוברים לשרת CodeNomad הזה.",
  "settings.appearance.colorScheme.option.system": "מערכת",
  "settings.appearance.colorScheme.option.light": "בהיר",
  "settings.appearance.colorScheme.option.porcelain": "פורצלן",
  "settings.appearance.colorScheme.option.dawn": "שחר",
  "settings.appearance.colorScheme.option.parchment": "קלף",
  "settings.appearance.colorScheme.option.codeNomadClassic": "קלאסי",
  "settings.appearance.colorScheme.option.basalt": "בזלת",
  "settings.appearance.colorScheme.option.fjord": "פיורד",
  "settings.appearance.colorScheme.option.lichen": "חזזית",
  "settings.appearance.colorScheme.option.velvet": "קטיפה",
  "settings.appearance.colorScheme.option.ember": "גחל",
  "settings.appearance.colorScheme.option.custom": "מותאם אישית",
  "settings.appearance.colorScheme.description.system": "מתאים למראה של מערכת ההפעלה.",
  "settings.appearance.colorScheme.description.light": "לוח צבעים בהיר וניטרלי.",
  "settings.appearance.colorScheme.description.porcelain": "מעטפת ניטרלית ורכה עם סביבת עבודה לבנה ונקייה.",
  "settings.appearance.colorScheme.description.dawn": "משטחי אור יום קרירים עם הדגשה כחולה ברורה.",
  "settings.appearance.colorScheme.description.parchment": "משטחי נייר חמימים עם הדגשת טורקיז מאופקת.",
  "settings.appearance.colorScheme.description.codeNomadClassic": "לוח הצבעים הכהה המקורי של CodeNomad.",
  "settings.appearance.colorScheme.description.basalt": "אפור פחם ניטרלי עם הדגשה כחולה קרירה.",
  "settings.appearance.colorScheme.description.fjord": "כחול-אפור עמוק עם הדגשה ירוקה-ימית.",
  "settings.appearance.colorScheme.description.lichen": "ירוק-אפור אדמתי עם הדגשה בגוון טחב.",
  "settings.appearance.colorScheme.description.velvet": "שזיף עמוק עם הדגשה אפרסקית חמימה.",
  "settings.appearance.colorScheme.description.ember": "חום-שחור חמים עם הדגשת נחושת.",
  "settings.appearance.colorScheme.description.custom": "צור ושמור לוח צבעים משלך.",
  "settings.appearance.colorScheme.custom.appearance": "מראה מותאם אישית",
  "settings.appearance.colorScheme.custom.appearance.light": "בהיר",
  "settings.appearance.colorScheme.custom.appearance.dark": "כהה",
  "settings.appearance.colorScheme.custom.colors": "צבעים",
  "settings.appearance.colorScheme.custom.field.surfaceBase": "בסיס",
  "settings.appearance.colorScheme.custom.field.surfaceSecondary": "משני",
  "settings.appearance.colorScheme.custom.field.surfaceMuted": "מעומעם",
  "settings.appearance.colorScheme.custom.field.borderBase": "גבולות",
  "settings.appearance.colorScheme.custom.field.textPrimary": "טקסט ראשי",
  "settings.appearance.colorScheme.custom.field.textMuted": "טקסט מעומעם",
  "settings.appearance.colorScheme.custom.field.accentPrimary": "הדגשה",
  "settings.appearance.colorScheme.custom.field.statusSuccess": "הצלחה",
  "settings.appearance.colorScheme.custom.field.statusWarning": "אזהרה",
  "settings.appearance.colorScheme.custom.field.statusError": "שגיאה",
  "settings.appearance.colorScheme.custom.field.userAccent": "משתמש",
  "settings.appearance.colorScheme.custom.field.agentAccent": "סוכן",
  "settings.appearance.colorScheme.custom.field.compactionAccent": "דחיסה",
  "settings.appearance.colorScheme.custom.field.yoloAccent": "מצב YOLO",
  "settings.appearance.colorScheme.custom.pickerAriaLabel": "בחירת {name}",
  "settings.appearance.colorScheme.custom.valueAriaLabel": "ערך הקסדצימלי עבור {name}",
  "settings.appearance.colorScheme.custom.warning.format": "יש להשתמש באותיות גדולות בתבנית #RRGGBB.",
  "settings.appearance.colorScheme.custom.reset": "איפוס",
  "settings.appearance.colorScheme.custom.new": "חדש",
  "settings.appearance.colorScheme.custom.name": "שם",
  "settings.appearance.colorScheme.custom.delete": "מחיקה",
  "settings.appearance.colorScheme.custom.deleteConfirm": "למחוק את „{name}” ?",
  ...
  "settings.appearance.startup.clear.subtitle": "הסרת כרטיסיות, טיוטות, מיקומי גלילה ופריסת חלוניות שנשמרו. נתוני CodeNomad ו-OpenCode לא יימחקו.",
  ...
  "settings.opencode.update.title": "גרסת OpenCode",
  "settings.opencode.update.subtitle": "הגרסה המותקנת של קובץ OpenCode שהוגדר.",
  "settings.opencode.update.checking": "קורא את הגרסה המותקנת...",
  "settings.opencode.update.checkFailed": "לא ניתן לקרוא את גרסת OpenCode המותקנת.",
  ...
  "settings.opencode.update.availableUnsupported": "OpenCode {version} זמין. OpenCode V2 אינו תומך בהתקנה אוטומטית.",
  ...
  "settings.providers.method.command": "פקודה",
  "settings.providers.method.mixed": "מפתח API, OAuth או פקודה",
  ...
  "settings.providers.prompt.customValuesPlaceholder": "ערכים נוספים, מופרדים בפסיקים",
  "settings.providers.command.description": "OpenCode יפעיל את פקודת האימות המקורית של הספק.",
  "settings.providers.command.waitingTitle": "ממתין לאימות באמצעות פקודה",
  "settings.providers.command.waitingMessage": "יש להשלים את ההוראות שמוצגות על ידי פקודת האימות.",
  ...
  "settings.behavior.expansionDefaults.otherTools": "אחר",
  ...
  "settings.info.diagnostics.reportTitle": "דוח אבחון של CodeNomad",
  "settings.info.diagnostics.generated": "נוצר",
  "settings.info.connectivity.title": "קישוריות שרת CodeNomad",
  ...
  "settings.info.connectivity.disclaimer": "כתובות אלה נגזרות מממשקי הרשת. הגדרות חומת האש, הנתב או התעודה הדיגיטלית עדיין עשויות למנוע חיבורים.",
  "settings.info.connectivity.loadFailed": "לא ניתן לטעון את פרטי הקישוריות של שרת CodeNomad.",
  "settings.info.diagnostics.privacy": "יש לבדוק את הדוח לפני השיתוף. הוא כולל נתיבים מקומיים וכתובות רשת, אך לעולם לא סיסמאות או סודות אימות.",
