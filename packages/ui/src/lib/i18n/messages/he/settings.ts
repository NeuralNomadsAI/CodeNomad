export const settingsMessages = {
  ...
  "instanceServiceStatus.plugins.scope.required": "יש לבחור כללי או פרויקט לפני שינוי תוסף.",
  ...
  "instanceServiceStatus.plugins.inactive.heading": "מוגדרים אך אינם פועלים",
  "instanceServiceStatus.plugins.configured.heading": "רשומות מוגדרות",
  "instanceServiceStatus.plugins.configured.empty": "לא הוגדרו מקורות תוספים או כללי הפעלה.",
  "instanceServiceStatus.plugins.configured.source": "מקור",
  "instanceServiceStatus.plugins.configured.rule": "כלל",
  "instanceServiceStatus.plugins.configured.options": "אפשרויות",
  "instanceServiceStatus.plugins.configScope.global": "כללי",
  "instanceServiceStatus.plugins.configScope.project": "פרויקט",
  "instanceServiceStatus.plugins.configScope.other": "מקור אחר",
  "instanceServiceStatus.plugins.configScope.virtual": "מקור וירטואלי",
  ...
  "instanceServiceStatus.plugins.errors.save": "לא ניתן לשמור את כלל הפעלת התוסף.",
  "instanceServiceStatus.plugins.errors.forbidden": "לסביבת עבודה זו אין הרשאה לשנות מיקום תוסף זה.",
  "instanceServiceStatus.plugins.errors.conflict": "הפרויקט או התצורה השתנו במקביל. יש לרענן ולנסות שוב.",
  "instanceServiceStatus.plugins.errors.invalidConfig": "תצורת OpenCode שנבחרה פגומה ולא שונתה.",
