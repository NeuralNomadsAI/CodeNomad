export const commandMessages = {
  ...
  "commands.removeSessionTechnicalParts.label": "הסר כלים וחשיבה מהסשן",
  "commands.removeSessionTechnicalParts.description": "שמור תשובות סופיות והסר פלטי כלים ומקטעי חשיבה שהושלמו",
  "commands.removeSessionTechnicalParts.keywords": "ניקוי, כלים, חשיבה, הסרה, סשן",
  "commands.removeSessionTechnicalParts.empty.title": "אין מה להסיר",
  "commands.removeSessionTechnicalParts.empty.message": "בסשן הזה אין פלטי כלים או מקטעי חשיבה שהושלמו.",
  "commands.removeSessionTechnicalParts.confirm.title": "להסיר כלים וחשיבה?",
  "commands.removeSessionTechnicalParts.confirm.message": "פלטי כלים: {toolCount}; מקטעי חשיבה: {reasoningCount}. הטקסט הסופי יישמר.",
  "commands.removeSessionTechnicalParts.confirm.label": "הסר",
  "commands.removeSessionTechnicalParts.failed.title": "ההסרה נכשלה",
  "commands.removeSessionTechnicalParts.failed.message": "ניקוי {count} תשובות נכשל.",
