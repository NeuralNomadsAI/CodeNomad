export const toolCallMessages = {
  ...
  "permissionApproval.kind.form": "טופס",
  "formRequest.selectPlaceholder": "בחר אפשרות",
  "formRequest.openExternal": "פתח טופס חיצוני",
  "formRequest.cancel": "ביטול",
  "formRequest.submit": "שליחה",
  "formRequest.submitting": "שולח...",
  "formRequest.errors.reply": "לא ניתן לשלוח את הטופס",
  "formRequest.errors.cancel": "לא ניתן לבטל את הטופס",
  "formRequest.errors.validation": "יש למלא את כל שדות החובה.",
  "formRequest.customValuesPlaceholder": "ערכים נוספים, מופרדים בפסיקים",
