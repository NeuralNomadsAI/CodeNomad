export const sessionMessages = {
  ...
  "sessionList.options.ariaLabel": "מיין וסנן הפעלות",
  "sessionList.options.sort.label": "מיון",
  "sessionList.options.sort.activity": "פעילות אחרונה",
  "sessionList.options.sort.name": "שם",
  "sessionList.options.sort.worktree": "Worktree",
  "sessionList.options.filter.label": "סינון לפי worktree",
  "sessionList.options.filter.all": "כל ה-worktrees",
  "sessionList.options.filter.workspace": "סביבת עבודה",
