export const folderSelectionMessages = {
  ...
  "folderSelection.servers.dialog.savedServer": "Saved server",
  "folderSelection.servers.dialog.newServer": "New server",
  "folderSelection.servers.dialog.newServerDescription": "Enter another server address",
