export const messagingMessages = {
  ...
  "promptInput.voiceInput.liveMode": "Open Live Voice Mode",
  "promptInput.resizeHandle.title": "Drag to resize input height",
  "voice.hud.title": "Live Voice Mode",
  "voice.hud.connecting": "Connecting...",
  "voice.hud.listening": "Listening...",
  "voice.hud.speaking": "Speaking...",
  "voice.hud.idle": "Ready",
  "voice.hud.error": "Voice Connection Error",
  "voice.hud.muted": "Muted",
  "voice.hud.mute": "Mute microphone",
  "voice.hud.unmute": "Unmute microphone",
  "voice.hud.interrupt": "Interrupt response",
  "voice.hud.close": "Close voice mode",
  "voice.hud.deadman_timeout": "Voice mode closed due to inactivity",
  "voice.hud.empty_transcript": "Start speaking to begin conversation...",
  "voice.hud.switch_provider": "Switch Voice Provider",
  "voice.hud.description": "Real-time voice assistant cockpit and transcription feed",
  "voice.hud.status.connecting": "Connecting",
  "voice.hud.status.listening": "Listening",
  "voice.hud.status.speaking": "Speaking",
  "voice.hud.status.idle": "Idle",
  "voice.hud.status.error": "Error",
  "voice.hud.provider": "Provider",
  "voice.hud.controls.mute": "Mute",
  "voice.hud.controls.unmute": "Unmute",
  "voice.hud.controls.interrupt": "Interrupt",
  "voice.hud.controls.settings": "Settings",
  "voice.hud.controls.close": "Close",
  "voice.hud.transcript.empty": "Audio connection standby. Speak to begin...",
  "voice.hud.transcript.user": "You",
  "voice.hud.transcript.assistant": "Assistant",
} as const
