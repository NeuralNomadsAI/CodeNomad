export const messagingMessages = {
  ...
  "promptInput.skills.select": "Attach a skill…",
  "promptInput.skills.error": "Unable to load skills. Close and reopen to retry.",
  "promptInput.skills.empty": "No skills available in this directory.",
  ...
  "promptInput.btw.question": "Your question",
  "promptInput.btw.answer": "Answer",
  "promptInput.btw.ask": "Ask",
  "promptInput.btw.loading": "Thinking…",
  "promptInput.btw.cancel": "Cancel question",
  "promptInput.btw.close": "Close side question",
  "promptInput.btw.empty": "The model returned no text. Try rephrasing your question.",
  "promptInput.btw.failed": "Unable to answer the side question.",
  "promptInput.btw.copy": "Copy answer",
  "promptInput.btw.copied": "Copied",
  "promptInput.btw.copyFailed": "Unable to copy the answer.",
  ...
  "history.session": "Entire session",
  "history.workspace": "Entire workspace",
  "history.technical": "Include tools and thinking",
  "history.counts": "{messages} messages · {tools} tools · {reasoning} thinking blocks",
  "history.scanning": "Counting…",
  "history.snapshot": "History snapshot",
  "history.skipped": "{count} messages could not be fully processed.",
  "history.more": "Next results",
  "history.text": "Text",
  "history.tool": "Tool",
  "history.reasoning": "Thinking",
  ...
  "transcriptFilters.systemMessages": "System",
  ...
  "transcriptFilters.expand": "Expand {name}",
  "transcriptFilters.collapse": "Collapse {name}",
  ...
  "promptInput.attachFiles.title": "Attach file…",
  "promptInput.attachFiles.help": "Choose files from this device",
  "promptInput.attachFiles.reading": "Reading files…",
  "promptInput.hints.projectFiles": "Reference project files",
  "promptInput.attachFiles.deviceDetail": "Device: {name} · {bytes} bytes",
  "promptInput.attachFiles.projectDetail": "Project: {path}",
  "promptInput.attachFiles.rejected.tooLarge": "{name}: exceeds 5 MiB per file.",
  "promptInput.attachFiles.rejected.limit": "{name}: exceeds 10 files or 20 MiB total.",
  "promptInput.attachFiles.rejected.unreadable": "{name}: could not be read.",
  ...
  "promptInput.attachFiles.tooLarge.other": "{count} selected files could not be attached because they are larger than the 5 MB attachment limit.",
  "promptInput.attachFiles.limit.one": "1 selected file was not attached because attachments are limited to {maxFiles} files and {maxMegabytes} MB total.",
  "promptInput.attachFiles.limit.other": "{count} selected files were not attached because attachments are limited to {maxFiles} files and {maxMegabytes} MB total.",
  "promptInput.attachFiles.deviceRejected.one": "1 selected file was not attached. Files must be readable, no larger than {maxFileMegabytes} MB each, and stay within {maxFiles} files and {maxTotalMegabytes} MB total.",
  "promptInput.attachFiles.deviceRejected.other": "{count} selected files were not attached. Files must be readable, no larger than {maxFileMegabytes} MB each, and stay within {maxFiles} files and {maxTotalMegabytes} MB total.",
