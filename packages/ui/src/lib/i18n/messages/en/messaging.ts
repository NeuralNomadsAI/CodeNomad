export const messagingMessages = {
  ...
  "promptInput.attachFiles.title": "Browse workspace files",
  "promptInput.attachFiles.upload": "Upload files from this device",
  "promptInput.attachFiles.dialogTitle": "Choose a workspace file",
