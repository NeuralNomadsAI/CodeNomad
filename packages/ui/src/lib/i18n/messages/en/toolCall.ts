export const toolCallMessages = {
  ...
  "formRequest.selectPlaceholder": "Select an option",
  "formRequest.openExternal": "Open external form",
  "formRequest.cancel": "Cancel",
  "formRequest.submit": "Submit",
  "formRequest.submitting": "Submitting...",
  "formRequest.errors.reply": "Unable to submit form",
  "formRequest.errors.cancel": "Unable to cancel form",
  "formRequest.errors.validation": "Complete all required fields.",
  "formRequest.customValuesPlaceholder": "Other values, separated by commas",
