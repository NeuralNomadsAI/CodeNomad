export const settingsMessages = {
  ...
  "settings.usage.scope": "Entire connected OpenCode service: all projects, independent clones and subsessions. These statistics are not limited to the opened folder. Periods are rolling days; activity uses the displayed time zone.",
  "settings.usage.noProject": "Open a project to connect to its OpenCode service and view service-wide statistics.",
  "settings.usage.period": "Period",
  "settings.usage.days": "Last {count} days",
  "settings.usage.loading": "Loading statistics…",
  "settings.usage.error": "Service statistics could not be refreshed. An OpenCode connection is required. Any displayed snapshot is from the previous successful refresh.",
  "settings.usage.sessions": "Sessions",
  "settings.usage.subagents": "Subsessions",
  "settings.usage.prompts": "Prompts",
  "settings.usage.steps": "Steps",
  "settings.usage.input": "Input tokens",
  "settings.usage.output": "Output tokens",
  "settings.usage.reasoning": "Reasoning tokens",
  "settings.usage.cacheRead": "Cache read tokens",
  "settings.usage.cacheWrite": "Cache write tokens",
  "settings.usage.activeDays": "Active days",
  "settings.usage.streak": "Streak (days)",
  "settings.usage.cost": "Recorded cost (USD)",
  "settings.usage.costHint": "Costs and tokens come from OpenCode’s recorded usage. Subscription allowances and provider invoices are not measured here.",
  "settings.usage.models": "By model",
  "settings.usage.model": "Model",
  "settings.usage.activity": "Daily activity",
  "settings.mcpCodeMode.title": "MCP Code Mode",
  "settings.mcpCodeMode.hint": "Edit the source that declares each server. Default uses Code Mode; Off exposes tools directly. Higher-priority server definitions replace the entire server configuration.",
  "settings.mcpCodeMode.default": "Default (on)",
  "settings.mcpCodeMode.on": "On",
  "settings.mcpCodeMode.off": "Off",
  "settings.mcpCodeMode.effective": "Effective: {mode}",
  "settings.mcpCodeMode.error": "MCP setting operation failed. Refresh to reconcile the current state.",
  "settings.pluginPackages.check": "Check updates for {target}",
  "settings.pluginPackages.update": "Update {target}",
  "settings.pluginPackages.shared": "Updates this package target in the shared OpenCode cache for all locations using it.",
  "settings.pluginPackages.error": "Package operation failed for {target}. Refresh to reconcile its status.",
  ...
  "settings.websearch.effective": "Search in this project: {provider}",
  ...
  "instanceServiceStatus.plugins.empty": "No plugins available for activation.",
  ...
  "instanceServiceStatus.plugins.toast.reloadNote": "It takes effect when the daemon reloads its configuration.",
  ...
  "instanceServiceStatus.plugins.errors.save": "The {scope} activation rule for {name} could not be saved.",
  "instanceServiceStatus.plugins.errors.forbidden": "This workspace is not allowed to change the {scope} location of {name}.",
  "instanceServiceStatus.plugins.errors.conflict": "The project or configuration changed while saving the {scope} rule for {name}. Refresh and try again.",
  "instanceServiceStatus.plugins.errors.invalidConfig": "The {scope} OpenCode configuration for {name} is malformed. It was not changed.",
