export const settingsMessages = {
  ...
  "settings.speech.error.urlChangeKeyRequired.title": "Endpoint changed",
  "settings.speech.error.urlChangeKeyRequired.stt": "You changed the input base URL but did not enter a new API key. Enter a new key or clear the stored key first.",
  "settings.speech.error.urlChangeKeyRequired.tts": "You changed the output base URL but did not enter a new API key. Enter a new key or clear the stored key first.",
  "settings.speech.error.urlChangeKeyRequired.both": "You changed both base URLs but did not enter new API keys. Enter new keys or clear the stored keys first.",
