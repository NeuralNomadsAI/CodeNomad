export const settingsMessages = {
  ...
  "settings.section.remote.title": "Remote Control",
  "settings.section.remote.subtitle": "Securely continue this device's sessions from another device through the outbound relay.",
