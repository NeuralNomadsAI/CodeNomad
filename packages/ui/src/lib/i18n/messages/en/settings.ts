export const settingsMessages = {
  ...
  "settings.plugins.errors.invalidSpec": "Must start with npm:, file://, https://, /, or .",
  "settings.plugins.remove.confirm": "Remove this plugin?",
  "settings.plugins.remove.confirmYes": "Remove",
  "settings.plugins.remove.confirmNo": "Cancel",
