export const settingsMessages = {
  ...
  "settings.opencode.setup.source.legacy": "Legacy private CodeNomad installation. No shared installation was found.",
  "settings.opencode.setup.sharedInstall": "Install for the user and configure PATH",
  "settings.opencode.setup.sharedInstallDescription": "Uses a standard npm installation shared with other clients. Open a new terminal after installation. Old private copies are preserved.",
