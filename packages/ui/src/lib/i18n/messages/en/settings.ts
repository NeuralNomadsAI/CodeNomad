export const settingsMessages = {
  ...
  "settings.appearance.startup.restore.subtitle": "Reopen workspace and sidecar tabs, active sessions, and unsent messages; restore layout; and cache recent session messages on this device for faster reopening.",
  ...
  "settings.behavior.toolInputsVisibility.title": "Tool inputs",
  "settings.behavior.toolInputsVisibility.subtitle": "Set default visibility for tool call input arguments.",
  "settings.behavior.usageMetrics.title": "Token usage",
