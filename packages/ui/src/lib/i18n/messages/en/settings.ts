export const settingsMessages = {
  ...
  "settings.usage.noProject": "Open a project to connect to its OpenCode service and view service-wide usage.",
  "settings.usage.period": "Period",
  "settings.usage.days": "Last {count} days",
  "settings.usage.loading": "Loading usage…",
  "settings.usage.error": "Service usage could not be refreshed. An OpenCode connection is required. Any displayed snapshot is from the previous successful refresh.",
