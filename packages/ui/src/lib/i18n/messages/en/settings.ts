export const settingsMessages = {
  ...
  "modelSelector.error.noVisibleModels": "Select at least one visible model before sending a message.",
  ...
  "settings.providers.modelVisibility.mode.label": "Model visibility mode",
  "settings.providers.modelVisibility.mode.all": "All models",
  "settings.providers.modelVisibility.mode.all.description": "Show current and newly reported models.",
  "settings.providers.modelVisibility.mode.custom": "Custom",
  "settings.providers.modelVisibility.mode.custom.description": "Show only selected model IDs.",
  ...
  "settings.providers.modelVisibility.count": "{selected} of {total} selected",
  "settings.providers.modelVisibility.selectAll": "Select all",
  "settings.providers.modelVisibility.selectNone": "Select none",
  "settings.providers.modelVisibility.unavailable.one": "{count} selected model is currently unavailable.",
  "settings.providers.modelVisibility.unavailable.other": "{count} selected models are currently unavailable.",
  "settings.providers.modelVisibility.empty": "No models match this search.",
  "settings.providers.modelVisibility.listAriaLabel": "Models for {provider}",
  "settings.providers.modelVisibility.saveFailed": "Failed to save model visibility.",
