export const settingsMessages = {
  ...
  "settings.usage.scope": "Native statistics for this Git project and its worktrees, including subsessions. Periods are rolling days; activity uses the displayed time zone.",
  "settings.usage.noProject": "Open a Git project to view usage.",
  "settings.usage.period": "Period",
  "settings.usage.days": "Last {count} days",
  "settings.usage.loading": "Loading usage…",
  "settings.usage.error": "Usage could not be refreshed. Git project authority and an OpenCode connection are required. Any displayed snapshot is from the previous successful refresh.",
