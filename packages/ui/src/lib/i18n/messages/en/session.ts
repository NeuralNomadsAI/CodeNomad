export const sessionMessages = {
  ...
  "sessionList.actions.pin.ariaLabel": "Pin session",
  "sessionList.actions.pin.title": "Pin session",
  "sessionList.actions.unpin.ariaLabel": "Unpin session",
  "sessionList.actions.unpin.title": "Unpin session",
  ...
  "sessionList.delete.confirmPinnedMessage": "\"{label}\" is marked as important. Delete this pinned session anyway?",
  ...
  "sessionList.bulkDelete.confirmPinnedMessage": "Your selection contains {pinnedCount} pinned session(s). Delete {count} sessions anyway?",
  "sessionList.pin.badgeTooltip": "Pinned session",
  "sessionList.filter.pinned": "Pinned",
  ...
  "sessionPreview.open.invalidUrl": "Enter a valid HTTP or HTTPS URL.",
