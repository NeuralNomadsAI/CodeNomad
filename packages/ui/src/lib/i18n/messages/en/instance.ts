export const instanceMessages = {
  ...
  "instanceShell.rightPanel.errors.gitStatusFailed": "Failed to load git status",
  "instanceShell.rightPanel.errors.diffNotAvailable": "Deleted file diff is not available yet",
  "instanceShell.rightPanel.errors.binaryFile": "Binary file cannot be displayed",
  "instanceShell.rightPanel.errors.unsupportedType": "Unsupported file type",
  "instanceShell.rightPanel.errors.fileChangesFailed": "Failed to load file changes",
  "instanceShell.rightPanel.errors.filesLoadFailed": "Failed to load files",
  "instanceShell.rightPanel.errors.fileReadFailed": "Failed to read file",
  "instanceShell.rightPanel.errors.fileSaveFailed": "Failed to save file",
