export const instanceMessages = {
  ...
  "gitPanel.detached": "Detached HEAD",
  "gitPanel.filter": "Filter loaded commits…",
  "gitPanel.emptyHistory": "No commits to display",
  "gitPanel.more": "Load older commits",
  "gitPanel.files": "{count} changed files",
  "gitPanel.actions": "Git actions",
  "gitPanel.diff": "Git diff",
  "gitPanel.parentDiff": "Compared with first parent",
  "gitPanel.backChat": "Back to conversation",
  ...
  "instanceShell.backgroundProcesses.error": "Failed to load background shells.",
  "instanceShell.backgroundProcesses.empty": "No background shells.",
  "instanceShell.backgroundProcesses.status.running": "Running",
  "instanceShell.backgroundProcesses.status.exited": "Exited",
  "instanceShell.backgroundProcesses.status.timeout": "Timed out",
  "instanceShell.backgroundProcesses.status.killed": "Killed",
  "instanceShell.backgroundProcesses.pid": "PID {pid}",
  "instanceShell.backgroundProcesses.exitCode": "Exit {code}",
  "instanceShell.backgroundProcesses.actions.stopRemove": "Stop and remove",
  "instanceShell.backgroundProcesses.actions.remove": "Remove",
  "instanceShell.backgroundProcesses.actions.output": "View output",
  "instanceShell.backgroundProcesses.remove.title": "Remove background shell",
  "instanceShell.backgroundProcesses.remove.message": "Remove \"{title}\"? A running process will be stopped.",
  ...
  "instanceShell.gitChanges.actions.stageSelected": "Stage {count} selected files",
  "instanceShell.gitChanges.actions.unstageSelected": "Unstage {count} selected files",
  ...
  "instanceShell.worktree.unavailable": "Unavailable",
  "instanceShell.worktree.create.fromCurrentBranch": "New from current branch",
  "instanceShell.worktree.create.action": "Create and use worktree",
  "instanceShell.worktree.create.description": "Creates a named Git branch from this session's checkout and moves the session family to the new worktree. Uncommitted changes stay in the original checkout.",
  "instanceShell.worktree.create.name": "Name",
  "instanceShell.worktree.create.placeholder": "worktree-name",
  "instanceShell.worktree.create.success": "Created worktree {slug}",
  "instanceShell.worktree.create.error": "Failed to create worktree",
  ...
  "instanceShell.worktree.delete.action": "Delete worktree",
  "instanceShell.worktree.delete.description": "Deletes this branch worktree and its local folder.",
  "instanceShell.worktree.delete.target": "Worktree \"{slug}\"",
  "instanceShell.worktree.delete.force": "Force delete (discard local changes)",
  "instanceShell.worktree.delete.success": "Deleted worktree {slug}",
  ...
  "opencodeBinarySelector.badge.systemPath": "Prefer PATH, then the user npm installation",
  ...
  "opencodeBinarySelector.validation.v2Required": "CodeNomad requires OpenCode V2. Install and select the opencode2 binary.",
  "opencodeBinarySelector.validation.alreadyValidating": "Already validating",
  "opencodeBinarySelector.display.systemPath": "{name} (automatic)",
