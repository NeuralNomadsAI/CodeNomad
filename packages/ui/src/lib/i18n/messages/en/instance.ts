export const instanceMessages = {
  ...
  "instanceShell.chatSearch.openAriaLabel": "Search chat history",
  ...
  "instanceShell.rightPanel.tabs.workflows": "Workflows",
  "instanceShell.rightPanel.tabs.ariaLabel": "Right panel tabs",
  "instanceShell.workflows.builder.title": "New workflow",
  "instanceShell.workflows.builder.description": "Run a sequence of agent stages.",
  "instanceShell.workflows.objective.label": "Objective",
  "instanceShell.workflows.objective.placeholder": "Describe the result this workflow should achieve",
  "instanceShell.workflows.stages.title": "Stages",
  "instanceShell.workflows.stages.count": "{count} of {max}",
  "instanceShell.workflows.stages.number": "Stage {number}",
  "instanceShell.workflows.fields.title": "Title",
  "instanceShell.workflows.fields.instructions": "Instructions",
  "instanceShell.workflows.fields.agent": "Agent",
  "instanceShell.workflows.fields.model": "Model",
  "instanceShell.workflows.fields.requiresApproval": "Require approval after this stage",
  "instanceShell.workflows.defaults.planner.title": "Planner",
  "instanceShell.workflows.defaults.planner.instructions": "Create a clear implementation plan for the objective.",
  "instanceShell.workflows.defaults.implementer.title": "Implementer",
  "instanceShell.workflows.defaults.implementer.instructions": "Implement the plan and validate the result.",
  "instanceShell.workflows.defaults.newStage.title": "Stage {number}",
  "instanceShell.workflows.actions.moveUp": "Move stage up",
  "instanceShell.workflows.actions.moveDown": "Move stage down",
  "instanceShell.workflows.actions.removeStage": "Remove stage",
  "instanceShell.workflows.actions.addStage": "Add stage",
  "instanceShell.workflows.actions.start": "Start workflow",
  "instanceShell.workflows.actions.starting": "Starting...",
  "instanceShell.workflows.actions.refresh": "Refresh workflows",
  "instanceShell.workflows.actions.approve": "Approve",
  "instanceShell.workflows.actions.keepWaiting": "Keep waiting",
  "instanceShell.workflows.actions.cancel": "Cancel workflow",
  "instanceShell.workflows.actions.keepRunning": "Keep running",
  "instanceShell.workflows.actions.openSession": "Open generated session",
  "instanceShell.workflows.history.title": "Run history",
  "instanceShell.workflows.history.description": "Live and previous runs for this workspace.",
  "instanceShell.workflows.history.loading": "Loading workflows...",
  "instanceShell.workflows.history.empty": "No workflow runs yet.",
  "instanceShell.workflows.confirm.approve.message": "Approve the completed stage and continue this workflow?",
  "instanceShell.workflows.confirm.cancel.message": "Cancel this workflow? Running work will be stopped.",
  "instanceShell.workflows.errors.action": "The workflow action failed.",
  "instanceShell.workflows.errors.openSession": "The generated session could not be opened.",
  "instanceShell.workflows.output": "Output",
  "instanceShell.workflows.outputTruncated": "Output was shortened. Open the generated session to view the full output.",
  "instanceShell.workflows.live.statusChanged": "Workflow status changed to {status}.",
  "instanceShell.workflows.status.pending": "Pending",
  "instanceShell.workflows.status.running": "Running",
  "instanceShell.workflows.status.waiting_for_review": "Waiting for review",
  "instanceShell.workflows.status.completed": "Completed",
  "instanceShell.workflows.status.failed": "Failed",
  "instanceShell.workflows.status.cancelled": "Cancelled",
  "instanceShell.workflows.status.interrupted": "Interrupted",
  "instanceShell.rightPanel.modules.core": "CodeNomad core",
  "instanceShell.rightPanel.modules.core.description": "Built-in Git, Files, and Status panels.",
  ...
  "instanceShell.rightPanel.customize.description": "Show or hide right panel modules.",
  "instanceShell.rightPanel.customize.reset": "Reset",
  "instanceShell.rightPanel.customize.tabs": "Tabs",
  "instanceShell.rightPanel.customize.sections": "Customize sections",
  "instanceShell.rightPanel.customize.statusSections": "Status sections",
  "instanceShell.rightPanel.customize.dragToReorder": "Drag to reorder.",
  "instanceShell.rightPanel.customize.alwaysVisible": "Always visible",
  "instanceShell.rightPanel.customize.unavailableModules": "Unavailable modules",
  "instanceShell.rightPanel.customize.moduleUnavailable": "{module} unavailable",
