export const messagingMessages = {
  ...
  "promptInput.voiceInput.liveMode": "Abrir modo de voz en vivo",
  "voice.hud.title": "Modo de voz en vivo",
  "voice.hud.connecting": "Conectando...",
  "voice.hud.listening": "Escuchando...",
  "voice.hud.speaking": "Hablando...",
  "voice.hud.idle": "Listo",
  "voice.hud.error": "Error de conexión de voz",
  "voice.hud.muted": "Silenciado",
  "voice.hud.mute": "Silenciar micrófono",
  "voice.hud.unmute": "Reactivar micrófono",
  "voice.hud.interrupt": "Interrumpir respuesta",
  "voice.hud.close": "Cerrar modo de voz",
  "voice.hud.deadman_timeout": "Modo de voz cerrado por inactividad",
  "voice.hud.empty_transcript": "Comience a hablar para iniciar la conversación...",
  "voice.hud.switch_provider": "Cambiar proveedor de voz",
} as const
