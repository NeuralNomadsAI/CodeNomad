export const messagingMessages = {
  ...
  "promptInput.btw.question": "Tu pregunta",
  "promptInput.btw.answer": "Respuesta",
  "promptInput.btw.ask": "Preguntar",
  "promptInput.btw.loading": "Pensando…",
  "promptInput.btw.cancel": "Cancelar pregunta",
  "promptInput.btw.close": "Cerrar pregunta aparte",
  "promptInput.btw.empty": "El modelo no devolvió texto. Intenta reformular la pregunta.",
  "promptInput.btw.failed": "No se pudo responder a la pregunta aparte.",
  "promptInput.btw.copy": "Copiar respuesta",
  "promptInput.btw.copied": "Copiado",
  "promptInput.btw.copyFailed": "No se pudo copiar la respuesta.",
  "history.navigation.outlineLoading": "Cargando la cronología completa… {loaded} / {total}",
  ...
  "history.technical": "Incluir herramientas y razonamiento",
  "history.counts": "{messages} mensajes · {tools} herramientas · {reasoning} bloques de razonamiento",
  "history.scanning": "Contando…",
  "history.snapshot": "Instantánea del historial",
  "history.skipped": "No se pudieron procesar completamente {count} mensajes.",
  "history.more": "Siguientes resultados",
  "history.text": "Texto",
  "history.tool": "Herramienta",
  "history.reasoning": "Razonamiento",
  "history.planning": "Analizando el historial: {count} mensajes",
  "history.pruning": "Limpiando: {count} / {total} mensajes",
  "transcriptFilters.title": "Contenido de los mensajes",
  "transcriptFilters.systemMessages": "Sistema",
  ...
  "messageSection.search.failed": "La búsqueda falló",
  "messageSection.search.retry": "Reintentar",
  ...
  "messageBlock.reasoning.thoughtLabel": "Reflexión",
  "messageBlock.reasoning.steps.one": "{count} paso",
  "messageBlock.reasoning.steps.other": "{count} pasos",
  "messageBlock.exploration.completed": "Explorado: {tools}",
  "messageBlock.exploration.active": "Explorando: {tools}",
  "messageBlock.exploration.read.one": "{count} lectura",
  "messageBlock.exploration.read.other": "{count} lecturas",
  "messageBlock.exploration.search.one": "{count} búsqueda",
  "messageBlock.exploration.search.other": "{count} búsquedas",
  ...
  "messageItem.actions.forkTitle": "Bifurcar después de este mensaje",
  ...
  "messageItem.actions.deleteTechnicalParts": "Eliminar herramientas y razonamientos de esta respuesta",
  "messageItem.actions.deleteTechnicalParts.confirmTitle": "¿Eliminar herramientas y razonamientos?",
  "messageItem.actions.deleteTechnicalParts.confirmMessage": "Salidas de herramientas: {toolCount}; bloques de razonamiento: {reasoningCount}. El texto final se conservará.",
  "messageItem.actions.deleteTechnicalParts.confirmLabel": "Eliminar",
  "messageItem.actions.deleteTechnicalParts.failedTitle": "Error al eliminar",
  "messageItem.actions.deleteTechnicalParts.failedMessage": "No se pudieron eliminar las herramientas y los razonamientos",
  ...
  "promptInput.attachFiles.title": "Adjuntar archivo…",
  "promptInput.attachFiles.help": "Elegir archivos de este dispositivo",
  "promptInput.attachFiles.reading": "Leyendo archivos…",
  "promptInput.hints.projectFiles": "Referenciar archivos del proyecto",
  "promptInput.attachFiles.deviceDetail": "Dispositivo: {name} · {bytes} bytes",
  "promptInput.attachFiles.projectDetail": "Proyecto: {path}",
  "promptInput.attachFiles.rejected.tooLarge": "{name}: supera 5 MiB por archivo.",
  "promptInput.attachFiles.rejected.limit": "{name}: supera 10 archivos o 20 MiB en total.",
  "promptInput.attachFiles.rejected.unreadable": "{name}: no se pudo leer.",
  ...
  "promptInput.attachFiles.tooLarge.other": "No se pudieron adjuntar {count} archivos seleccionados porque superan el límite de adjuntos de 5 MB.",
  "promptInput.attachFiles.limit.one": "No se adjuntó 1 archivo seleccionado porque los adjuntos están limitados a {maxFiles} archivos y {maxMegabytes} MB en total.",
  "promptInput.attachFiles.limit.other": "No se adjuntaron {count} archivos seleccionados porque los adjuntos están limitados a {maxFiles} archivos y {maxMegabytes} MB en total.",
  "promptInput.attachFiles.deviceRejected.one": "No se adjuntó 1 archivo seleccionado. Los archivos deben poder leerse, no superar {maxFileMegabytes} MB cada uno y respetar el límite de {maxFiles} archivos y {maxTotalMegabytes} MB en total.",
  "promptInput.attachFiles.deviceRejected.other": "No se adjuntaron {count} archivos seleccionados. Los archivos deben poder leerse, no superar {maxFileMegabytes} MB cada uno y respetar el límite de {maxFiles} archivos y {maxTotalMegabytes} MB en total.",
  ...
  "promptInput.send.queueAriaLabel": "Poner mensaje en cola",
  "promptQueue.title": "Cola de prompts ({count})",
  "promptQueue.delivery.queue": "En cola",
  "promptQueue.delivery.steer": "Intervención en curso",
  "promptQueue.attachments.one": "{count} archivo adjunto",
  "promptQueue.attachments.other": "{count} archivos adjuntos",
  ...
  "promptQueue.error.message": "No se pudo actualizar la cola de prompts",
