export const sessionMessages = {
  ...
  "sessionList.actions.pin.ariaLabel": "Fijar sesión",
  "sessionList.actions.pin.title": "Fijar sesión",
  "sessionList.actions.unpin.ariaLabel": "Desfijar sesión",
  "sessionList.actions.unpin.title": "Desfijar sesión",
  ...
  "sessionList.delete.confirmPinnedMessage": "\"{label}\" está marcada como importante. ¿Eliminar esta sesión fijada de todos modos?",
  ...
  "sessionList.bulkDelete.confirmPinnedMessage": "Tu selección contiene {pinnedCount} sesión(es) fijada(s). ¿Eliminar {count} sesiones de todos modos?",
  "sessionList.pin.badgeTooltip": "Sesión fijada",
  "sessionList.filter.pinned": "Fijadas",
