export const toolCallMessages = {
  ...
  "permissionApproval.kind.form": "Formulario",
  "formRequest.selectPlaceholder": "Selecciona una opción",
  "formRequest.openExternal": "Abrir formulario externo",
  "formRequest.cancel": "Cancelar",
  "formRequest.submit": "Enviar",
  "formRequest.submitting": "Enviando...",
  "formRequest.errors.reply": "No se pudo enviar el formulario",
  "formRequest.errors.cancel": "No se pudo cancelar el formulario",
  "formRequest.errors.validation": "Completa todos los campos obligatorios.",
  "formRequest.customValuesPlaceholder": "Otros valores, separados por comas",
