export const commandMessages = {
  ...
  "commands.removeSessionTechnicalParts.label": "Eliminar herramientas y razonamientos de la sesión",
  "commands.removeSessionTechnicalParts.description": "Conservar las respuestas finales y eliminar herramientas y razonamientos completados",
  "commands.removeSessionTechnicalParts.keywords": "limpiar, herramientas, razonamiento, eliminar, sesión",
  "commands.removeSessionTechnicalParts.empty.title": "Nada que eliminar",
  "commands.removeSessionTechnicalParts.empty.message": "Esta sesión no contiene herramientas ni razonamientos completados.",
  "commands.removeSessionTechnicalParts.confirm.title": "¿Eliminar herramientas y razonamientos?",
  "commands.removeSessionTechnicalParts.confirm.message": "Salidas de herramientas: {toolCount}; razonamientos: {reasoningCount}. El texto final se conservará.",
  "commands.removeSessionTechnicalParts.confirm.label": "Eliminar",
  "commands.removeSessionTechnicalParts.failed.title": "Error al eliminar",
  "commands.removeSessionTechnicalParts.failed.message": "No se pudieron limpiar {count} respuestas.",
