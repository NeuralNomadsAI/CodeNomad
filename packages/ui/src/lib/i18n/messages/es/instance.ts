export const instanceMessages = {
  ...
  "instanceShell.rightPanel.tabs.workflows": "Flujos de trabajo",
  "instanceShell.rightPanel.tabs.ariaLabel": "Pestañas del panel derecho",
  "instanceShell.workflows.builder.title": "Nuevo flujo",
  "instanceShell.workflows.builder.description": "Ejecuta una secuencia de etapas con agentes.",
  "instanceShell.workflows.objective.label": "Objetivo",
  "instanceShell.workflows.objective.placeholder": "Describe el resultado que debe conseguir el flujo",
  "instanceShell.workflows.stages.title": "Etapas",
  "instanceShell.workflows.stages.count": "{count} de {max}",
  "instanceShell.workflows.stages.number": "Etapa {number}",
  "instanceShell.workflows.fields.title": "Título",
  "instanceShell.workflows.fields.instructions": "Instrucciones",
  "instanceShell.workflows.fields.agent": "Agente",
  "instanceShell.workflows.fields.model": "Modelo",
  "instanceShell.workflows.fields.requiresApproval": "Solicitar aprobación después de esta etapa",
  "instanceShell.workflows.defaults.planner.title": "Planificador",
  "instanceShell.workflows.defaults.planner.instructions": "Crea un plan de implementación claro para el objetivo.",
  "instanceShell.workflows.defaults.implementer.title": "Implementador",
  "instanceShell.workflows.defaults.implementer.instructions": "Implementa el plan y valida el resultado.",
  "instanceShell.workflows.defaults.newStage.title": "Etapa {number}",
  "instanceShell.workflows.actions.moveUp": "Subir etapa",
  "instanceShell.workflows.actions.moveDown": "Bajar etapa",
  "instanceShell.workflows.actions.removeStage": "Eliminar etapa",
  "instanceShell.workflows.actions.addStage": "Añadir etapa",
  "instanceShell.workflows.actions.start": "Iniciar flujo",
  "instanceShell.workflows.actions.starting": "Iniciando...",
  "instanceShell.workflows.actions.refresh": "Actualizar flujos",
  "instanceShell.workflows.actions.approve": "Aprobar",
  "instanceShell.workflows.actions.keepWaiting": "Seguir esperando",
  "instanceShell.workflows.actions.cancel": "Cancelar flujo",
  "instanceShell.workflows.actions.keepRunning": "Dejar en ejecución",
  "instanceShell.workflows.actions.openSession": "Abrir sesión generada",
  "instanceShell.workflows.history.title": "Historial de ejecuciones",
  "instanceShell.workflows.history.description": "Flujos actuales y anteriores de este espacio de trabajo.",
  "instanceShell.workflows.history.loading": "Cargando flujos...",
  "instanceShell.workflows.history.empty": "Todavía no hay ejecuciones.",
  "instanceShell.workflows.confirm.approve.message": "¿Aprobar la etapa terminada y continuar este flujo?",
  "instanceShell.workflows.confirm.cancel.message": "¿Cancelar este flujo? Se detendrá el trabajo en curso.",
  "instanceShell.workflows.errors.action": "La acción del flujo ha fallado.",
  "instanceShell.workflows.errors.openSession": "No se pudo abrir la sesión generada.",
  "instanceShell.workflows.output": "Salida",
  "instanceShell.workflows.outputTruncated": "La salida se ha recortado. Abre la sesión generada para ver la salida completa.",
  "instanceShell.workflows.live.statusChanged": "El estado del flujo cambió a {status}.",
  "instanceShell.workflows.status.pending": "Pendiente",
  "instanceShell.workflows.status.running": "En ejecución",
  "instanceShell.workflows.status.waiting_for_review": "Esperando revisión",
  "instanceShell.workflows.status.completed": "Completado",
  "instanceShell.workflows.status.failed": "Fallido",
  "instanceShell.workflows.status.cancelled": "Cancelado",
  "instanceShell.workflows.status.interrupted": "Interrumpido",
  "instanceShell.rightPanel.modules.core": "Núcleo de CodeNomad",
  ...
  "instanceShell.rightPanel.customize.description": "Muestra u oculta módulos del panel derecho.",
  ...
  "instanceShell.rightPanel.customize.unavailableModules": "Módulos no disponibles",
