export const instanceMessages = {
  ...
  "instanceInfo.server.title": "Proceso de OpenCode",
  ...
  "gitPanel.history": "Historial",
  "filesPanel.workspace": "Espacio de trabajo",
  ...
  "gitPanel.detached": "HEAD separado",
  "gitPanel.filter": "Filtrar commits cargados…",
  "gitPanel.emptyHistory": "No hay commits para mostrar",
  "gitPanel.more": "Cargar commits anteriores",
  "gitPanel.files": "{count} archivos modificados",
  "gitPanel.actions": "Acciones Git",
  "gitPanel.diff": "Diferencias Git",
  "gitPanel.parentDiff": "Comparado con el primer padre",
  "gitPanel.backChat": "Volver a la conversación",
  ...
  "instanceShell.backgroundProcesses.error": "No se pudieron cargar los shells en segundo plano.",
  "instanceShell.backgroundProcesses.empty": "No hay shells en segundo plano.",
  "instanceShell.backgroundProcesses.status.running": "En ejecución",
  "instanceShell.backgroundProcesses.status.exited": "Finalizado",
  "instanceShell.backgroundProcesses.status.timeout": "Tiempo agotado",
  "instanceShell.backgroundProcesses.status.killed": "Detenido",
  "instanceShell.backgroundProcesses.pid": "PID {pid}",
  "instanceShell.backgroundProcesses.exitCode": "Salida {code}",
  "instanceShell.backgroundProcesses.actions.stopRemove": "Detener y eliminar",
  "instanceShell.backgroundProcesses.actions.remove": "Eliminar",
  "instanceShell.backgroundProcesses.actions.output": "Ver salida",
  "instanceShell.backgroundProcesses.remove.title": "Eliminar shell en segundo plano",
  "instanceShell.backgroundProcesses.remove.message": "¿Eliminar \"{title}\"? Si está en ejecución, se detendrá.",
  ...
  "instanceShell.gitChanges.actions.stageSelected": "Preparar {count} archivos seleccionados",
  "instanceShell.gitChanges.actions.unstageSelected": "Quitar de preparación {count} archivos seleccionados",
  ...
  "instanceShell.worktree.unavailable": "No disponible",
  "instanceShell.worktree.create.fromCurrentBranch": "Nuevo desde la rama actual",
  "instanceShell.worktree.create.action": "Crear y usar worktree",
  "instanceShell.worktree.create.description": "Crea una rama Git con nombre desde el checkout de esta sesión y mueve su familia al nuevo worktree. Los cambios sin commit permanecen en el checkout original.",
  "instanceShell.worktree.create.name": "Nombre",
  "instanceShell.worktree.create.placeholder": "nombre-worktree",
  "instanceShell.worktree.create.success": "Worktree {slug} creado",
  "instanceShell.worktree.create.error": "No se pudo crear el worktree",
  ...
  "instanceShell.worktree.delete.action": "Eliminar worktree",
  "instanceShell.worktree.delete.description": "Elimina este worktree de rama y su carpeta local.",
  ...
  "opencodeBinarySelector.customPath.placeholder": "Introduce la ruta al binario de {name}…",
  ...
  "opencodeBinarySelector.validation.v2Required": "CodeNomad requiere OpenCode V2. Instala y selecciona el binario opencode2.",
  "opencodeBinarySelector.validation.alreadyValidating": "Ya se está validando",
  "opencodeBinarySelector.display.systemPath": "{name} (automático)",
