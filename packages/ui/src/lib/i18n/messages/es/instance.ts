export const instanceMessages = {
  ...
  "instanceShell.rightPanel.errors.gitStatusFailed": "Error al cargar el estado de git",
  "instanceShell.rightPanel.errors.diffNotAvailable": "El diff del archivo eliminado no está disponible aún",
  "instanceShell.rightPanel.errors.binaryFile": "No se puede mostrar el archivo binario",
  "instanceShell.rightPanel.errors.unsupportedType": "Tipo de archivo no soportado",
  "instanceShell.rightPanel.errors.fileChangesFailed": "Error al cargar los cambios del archivo",
  "instanceShell.rightPanel.errors.filesLoadFailed": "Error al cargar la lista de archivos",
  "instanceShell.rightPanel.errors.fileReadFailed": "Error al leer el archivo",
  "instanceShell.rightPanel.errors.fileSaveFailed": "Error al guardar el archivo",
