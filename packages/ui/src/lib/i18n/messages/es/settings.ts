export const settingsMessages = {
  ...
  "instanceServiceStatus.plugins.errors.save": "No se pudo guardar la regla de activación del plugin. [{scope} {name}]",
  "instanceServiceStatus.plugins.errors.forbidden": "Este espacio de trabajo no puede cambiar esa ubicación de plugin. [{scope} {name}]",
  "instanceServiceStatus.plugins.errors.conflict": "El proyecto o la configuración cambió al mismo tiempo. Actualiza e inténtalo de nuevo. [{scope} {name}]",
  "instanceServiceStatus.plugins.errors.invalidConfig": "La configuración de OpenCode seleccionada está mal formada. No se modificó. [{scope} {name}]",
