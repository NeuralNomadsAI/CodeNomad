export const settingsMessages = {
  ...
  "settings.section.remote.title": "Control remoto",
  "settings.section.remote.subtitle": "Continúa de forma segura las sesiones de este dispositivo desde otro mediante el relé saliente.",
