export const settingsMessages = {
  ...
  "settings.usage.scope": "Estadísticas nativas de este proyecto Git y sus worktrees, incluidas subsesiones. Períodos móviles; actividad en la zona horaria indicada.",
  "settings.usage.noProject": "Abra un proyecto Git para ver el uso.",
  "settings.usage.period": "Período",
  "settings.usage.days": "Últimos {count} días",
  "settings.usage.loading": "Cargando uso…",
  "settings.usage.error": "No se pudo actualizar. Se requieren un proyecto Git verificado y conexión OpenCode. Los datos mostrados son de la última actualización correcta.",
