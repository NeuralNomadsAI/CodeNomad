export const settingsMessages = {
  ...
  "settings.speech.error.urlChangeKeyRequired.title": "Endpoint cambiado",
  "settings.speech.error.urlChangeKeyRequired.stt": "Has cambiado la URL de entrada pero no has introducido una nueva clave API. Introduce una nueva clave o borra la clave guardada primero.",
  "settings.speech.error.urlChangeKeyRequired.tts": "Has cambiado la URL de salida pero no has introducido una nueva clave API. Introduce una nueva clave o borra la clave guardada primero.",
  "settings.speech.error.urlChangeKeyRequired.both": "Has cambiado ambas URLs pero no has introducido nuevas claves API. Introduce nuevas claves o borra las guardadas primero.",
