export const settingsMessages = {
  ...
  "settings.appearance.gitDiff.gutterMode.title": "Modo del gutter del diff de Git",
  "settings.appearance.gitDiff.gutterMode.subtitle": "Elige la presentacion del gutter de Monaco usada en los diffs de Cambios de Git.",
  "settings.appearance.gitDiff.gutterMode.option.compact": "Compacto",
