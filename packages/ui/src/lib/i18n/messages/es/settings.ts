export const settingsMessages = {
  ...
  "instanceServiceStatus.plugins.empty": "No hay plugins activos.",
  ...
  "instanceServiceStatus.plugins.scope.required": "Elige Global o Proyecto antes de cambiar un plugin.",
  ...
  "instanceServiceStatus.plugins.inactive.heading": "Configurados pero inactivos",
  "instanceServiceStatus.plugins.configured.heading": "Entradas configuradas",
  "instanceServiceStatus.plugins.configured.empty": "No hay fuentes ni reglas de activación de plugins configuradas.",
  "instanceServiceStatus.plugins.configured.source": "Fuente",
  "instanceServiceStatus.plugins.configured.rule": "Regla",
  "instanceServiceStatus.plugins.configured.options": "Opciones",
  "instanceServiceStatus.plugins.configScope.global": "Global",
  "instanceServiceStatus.plugins.configScope.project": "Proyecto",
  "instanceServiceStatus.plugins.configScope.other": "Otra fuente",
  "instanceServiceStatus.plugins.configScope.virtual": "Fuente virtual",
  ...
  "instanceServiceStatus.plugins.errors.save": "No se pudo guardar la regla de activación del plugin.",
  "instanceServiceStatus.plugins.errors.forbidden": "Este espacio de trabajo no puede cambiar esa ubicación de plugin.",
  "instanceServiceStatus.plugins.errors.conflict": "El proyecto o la configuración cambió al mismo tiempo. Actualiza e inténtalo de nuevo.",
  "instanceServiceStatus.plugins.errors.invalidConfig": "La configuración de OpenCode seleccionada está mal formada. No se modificó.",
