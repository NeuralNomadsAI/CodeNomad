export const settingsMessages = {
  ...
  "settings.opencode.setup.source.legacy": "Instalación privada antigua de CodeNomad. No se encontró una instalación compartida.",
  "settings.opencode.setup.sharedInstall": "Instalar para el usuario y configurar PATH",
  "settings.opencode.setup.sharedInstallDescription": "Usa una instalación npm estándar compartida con otros clientes. Abre un terminal nuevo después de instalar. Se conservan las copias privadas antiguas.",
