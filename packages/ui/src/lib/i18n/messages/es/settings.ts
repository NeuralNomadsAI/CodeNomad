export const settingsMessages = {
  ...
  "settings.usage.noProject": "Abra un proyecto para conectar su servicio OpenCode y ver el uso global del servicio.",
  "settings.usage.period": "Período",
  "settings.usage.days": "Últimos {count} días",
  "settings.usage.loading": "Cargando uso…",
  "settings.usage.error": "No se pudo actualizar el uso del servicio. Se requiere conexión OpenCode. Los datos mostrados son de la última actualización correcta.",
