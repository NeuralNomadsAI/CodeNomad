export const settingsMessages = {
  ...
  "modelSelector.error.noVisibleModels": "Selecciona al menos un modelo visible antes de enviar un mensaje.",
  ...
  "settings.providers.modelVisibility.mode.label": "Modo de visibilidad de modelos",
  "settings.providers.modelVisibility.mode.all": "Todos los modelos",
  "settings.providers.modelVisibility.mode.all.description": "Mostrar modelos actuales y nuevos.",
  "settings.providers.modelVisibility.mode.custom": "Personalizado",
  "settings.providers.modelVisibility.mode.custom.description": "Mostrar solo los ID de modelo seleccionados.",
  ...
  "settings.providers.modelVisibility.count": "{selected} de {total} seleccionados",
  "settings.providers.modelVisibility.selectAll": "Seleccionar todos",
  "settings.providers.modelVisibility.selectNone": "No seleccionar ninguno",
  "settings.providers.modelVisibility.unavailable.one": "{count} modelo seleccionado no está disponible actualmente.",
  "settings.providers.modelVisibility.unavailable.other": "{count} modelos seleccionados no están disponibles actualmente.",
  "settings.providers.modelVisibility.empty": "Ningún modelo coincide con esta búsqueda.",
  "settings.providers.modelVisibility.listAriaLabel": "Modelos de {provider}",
  "settings.providers.modelVisibility.saveFailed": "No se pudo guardar la visibilidad de los modelos.",
