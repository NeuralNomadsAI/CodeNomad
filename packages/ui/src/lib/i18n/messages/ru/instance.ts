export const instanceMessages = {
  ...
  "gitPanel.history": "История",
  "filesPanel.workspace": "Рабочая область",
  "filesPanel.commits": "Коммиты",
  ...
  "gitPanel.detached": "Отсоединённый HEAD",
  "gitPanel.filter": "Фильтр загруженных коммитов…",
  "gitPanel.emptyHistory": "Нет коммитов для отображения",
  "gitPanel.more": "Загрузить предыдущие коммиты",
  "gitPanel.files": "Изменённых файлов: {count}",
  "gitPanel.actions": "Действия Git",
  "gitPanel.diff": "Различия Git",
  "gitPanel.parentDiff": "Сравнение с первым родителем",
  "gitPanel.backChat": "Вернуться к разговору",
  ...
  "instanceShell.backgroundProcesses.error": "Не удалось загрузить фоновые оболочки.",
  "instanceShell.backgroundProcesses.empty": "Нет фоновых оболочек.",
  "instanceShell.backgroundProcesses.status.running": "Выполняется",
  "instanceShell.backgroundProcesses.status.exited": "Завершено",
  "instanceShell.backgroundProcesses.status.timeout": "Время истекло",
  "instanceShell.backgroundProcesses.status.killed": "Остановлено",
  "instanceShell.backgroundProcesses.pid": "PID {pid}",
  "instanceShell.backgroundProcesses.exitCode": "Код {code}",
  "instanceShell.backgroundProcesses.actions.stopRemove": "Остановить и удалить",
  "instanceShell.backgroundProcesses.actions.remove": "Удалить",
  "instanceShell.backgroundProcesses.actions.output": "Показать вывод",
  "instanceShell.backgroundProcesses.remove.title": "Удалить фоновую оболочку",
  "instanceShell.backgroundProcesses.remove.message": "Удалить \"{title}\"? Выполняющийся процесс будет остановлен.",
  ...
  "instanceShell.filesShell.resizeFiles": "Изменить размер списка файлов",
  ...
  "instanceShell.worktree.unavailable": "Недоступно",
  "instanceShell.worktree.create.fromCurrentBranch": "Новый из текущей ветки",
  "instanceShell.worktree.create.action": "Создать и использовать worktree",
  "instanceShell.worktree.create.description": "Создаёт именованную ветку Git из рабочей копии этой сессии и переносит семейство сессий в новый worktree. Незакоммиченные изменения остаются в исходной рабочей копии.",
  "instanceShell.worktree.create.name": "Имя",
  "instanceShell.worktree.create.placeholder": "имя-worktree",
  "instanceShell.worktree.create.success": "Worktree {slug} создан",
  "instanceShell.worktree.create.error": "Не удалось создать worktree",
  ...
  "instanceShell.worktree.delete.action": "Удалить worktree",
  "instanceShell.worktree.delete.description": "Удаляет этот worktree ветки и его локальную папку.",
  ...
  "opencodeBinarySelector.customPath.placeholder": "Введите путь к бинарнику {name}…",
