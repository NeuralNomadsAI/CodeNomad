export const instanceMessages = {
  ...
  "instanceShell.rightPanel.tabs.workflows": "Процессы",
  "instanceShell.rightPanel.tabs.ariaLabel": "Вкладки правой панели",
  "instanceShell.workflows.builder.title": "Новый процесс",
  "instanceShell.workflows.builder.description": "Запустите последовательность этапов с агентами.",
  "instanceShell.workflows.objective.label": "Цель",
  "instanceShell.workflows.objective.placeholder": "Опишите результат, которого должен достичь процесс",
  "instanceShell.workflows.stages.title": "Этапы",
  "instanceShell.workflows.stages.count": "{count} из {max}",
  "instanceShell.workflows.stages.number": "Этап {number}",
  "instanceShell.workflows.fields.title": "Название",
  "instanceShell.workflows.fields.instructions": "Инструкции",
  "instanceShell.workflows.fields.agent": "Агент",
  "instanceShell.workflows.fields.model": "Модель",
  "instanceShell.workflows.fields.requiresApproval": "Требовать подтверждение после этого этапа",
  "instanceShell.workflows.defaults.planner.title": "Планировщик",
  "instanceShell.workflows.defaults.planner.instructions": "Составьте понятный план реализации цели.",
  "instanceShell.workflows.defaults.implementer.title": "Исполнитель",
  "instanceShell.workflows.defaults.implementer.instructions": "Реализуйте план и проверьте результат.",
  "instanceShell.workflows.defaults.newStage.title": "Этап {number}",
  "instanceShell.workflows.actions.moveUp": "Переместить этап вверх",
  "instanceShell.workflows.actions.moveDown": "Переместить этап вниз",
  "instanceShell.workflows.actions.removeStage": "Удалить этап",
  "instanceShell.workflows.actions.addStage": "Добавить этап",
  "instanceShell.workflows.actions.start": "Запустить процесс",
  "instanceShell.workflows.actions.starting": "Запуск...",
  "instanceShell.workflows.actions.refresh": "Обновить процессы",
  "instanceShell.workflows.actions.approve": "Подтвердить",
  "instanceShell.workflows.actions.keepWaiting": "Продолжить ожидание",
  "instanceShell.workflows.actions.cancel": "Отменить процесс",
  "instanceShell.workflows.actions.keepRunning": "Продолжить выполнение",
  "instanceShell.workflows.actions.openSession": "Открыть созданный сеанс",
  "instanceShell.workflows.history.title": "История запусков",
  "instanceShell.workflows.history.description": "Текущие и прошлые процессы этой рабочей области.",
  "instanceShell.workflows.history.loading": "Загрузка процессов...",
  "instanceShell.workflows.history.empty": "Запусков процессов пока нет.",
  "instanceShell.workflows.confirm.approve.message": "Подтвердить завершённый этап и продолжить процесс?",
  "instanceShell.workflows.confirm.cancel.message": "Отменить этот процесс? Текущая работа будет остановлена.",
  "instanceShell.workflows.errors.action": "Не удалось выполнить действие с процессом.",
  "instanceShell.workflows.errors.openSession": "Не удалось открыть созданный сеанс.",
  "instanceShell.workflows.output": "Результат",
  "instanceShell.workflows.outputTruncated": "Вывод сокращён. Откройте созданный сеанс, чтобы увидеть его полностью.",
  "instanceShell.workflows.live.statusChanged": "Статус процесса изменён на «{status}».",
  "instanceShell.workflows.status.pending": "Ожидает",
  "instanceShell.workflows.status.running": "Выполняется",
  "instanceShell.workflows.status.waiting_for_review": "Ожидает проверки",
  "instanceShell.workflows.status.completed": "Завершён",
  "instanceShell.workflows.status.failed": "Ошибка",
  "instanceShell.workflows.status.cancelled": "Отменён",
  "instanceShell.workflows.status.interrupted": "Прерван",
  "instanceShell.rightPanel.modules.core": "Ядро CodeNomad",
  "instanceShell.rightPanel.modules.core.description": "Встроенные панели Git, Файлы и Статус.",
  ...
  "instanceShell.rightPanel.customize.description": "Показывайте или скрывайте модули правой панели.",
  "instanceShell.rightPanel.customize.reset": "Сбросить",
  "instanceShell.rightPanel.customize.tabs": "Вкладки",
  "instanceShell.rightPanel.customize.sections": "Настроить секции",
  ...
  "instanceShell.rightPanel.customize.alwaysVisible": "Всегда видно",
  "instanceShell.rightPanel.customize.unavailableModules": "Недоступные модули",
  "instanceShell.rightPanel.customize.moduleUnavailable": "{module} недоступен",
  ...
  "instanceShell.gitChanges.noSessionSelected": "Выберите сессию, чтобы увидеть изменения Git.",
  ...
  "instanceShell.diff.hideUnchanged": "Скрыть неизменённые участки",
  "instanceShell.diff.showFull": "Показать файл полностью",
