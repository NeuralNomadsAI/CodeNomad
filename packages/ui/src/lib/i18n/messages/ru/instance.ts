export const instanceMessages = {
  ...
  "instanceShell.rightPanel.errors.gitStatusFailed": "Не удалось загрузить статус git",
  "instanceShell.rightPanel.errors.diffNotAvailable": "Diff удалённого файла пока недоступен",
  "instanceShell.rightPanel.errors.binaryFile": "Невозможно отобразить бинарный файл",
  "instanceShell.rightPanel.errors.unsupportedType": "Неподдерживаемый тип файла",
  "instanceShell.rightPanel.errors.fileChangesFailed": "Не удалось загрузить изменения файла",
  "instanceShell.rightPanel.errors.filesLoadFailed": "Не удалось загрузить список файлов",
  "instanceShell.rightPanel.errors.fileReadFailed": "Не удалось прочитать файл",
  "instanceShell.rightPanel.errors.fileSaveFailed": "Не удалось сохранить файл",
