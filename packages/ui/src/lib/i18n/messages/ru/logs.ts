export const logMessages = {
  ...
  "logsView.actions.clear": "Очистить логи",
  "logsView.actions.back": "Вернуться к разговору",
  ...
  "logsView.scrollToTop": "Прокрутить вверх",
  ...
  "infoView.logs.actions.back": "Вернуться к разговору",
