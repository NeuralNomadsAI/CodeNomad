export const commandMessages = {
  ...
  "commands.removeSessionTechnicalParts.label": "Удалить инструменты и рассуждения сессии",
  "commands.removeSessionTechnicalParts.description": "Сохранить итоговые ответы и удалить завершённые инструменты и рассуждения",
  "commands.removeSessionTechnicalParts.keywords": "очистка, инструменты, рассуждения, удалить, сессия",
  "commands.removeSessionTechnicalParts.empty.title": "Нечего удалять",
  "commands.removeSessionTechnicalParts.empty.message": "В этой сессии нет завершённых инструментов или блоков рассуждений.",
  "commands.removeSessionTechnicalParts.confirm.title": "Удалить инструменты и рассуждения?",
  "commands.removeSessionTechnicalParts.confirm.message": "Выводы инструментов: {toolCount}; блоки рассуждений: {reasoningCount}. Итоговый текст будет сохранён.",
  "commands.removeSessionTechnicalParts.confirm.label": "Удалить",
  "commands.removeSessionTechnicalParts.failed.title": "Ошибка удаления",
  "commands.removeSessionTechnicalParts.failed.message": "Не удалось очистить ответов: {count}.",
