export const toolCallMessages = {
  ...
  "permissionApproval.kind.form": "Форма",
  "formRequest.selectPlaceholder": "Выберите вариант",
  "formRequest.openExternal": "Открыть внешнюю форму",
  "formRequest.cancel": "Отмена",
  "formRequest.submit": "Отправить",
  "formRequest.submitting": "Отправка...",
  "formRequest.errors.reply": "Не удалось отправить форму",
  "formRequest.errors.cancel": "Не удалось отменить форму",
  "formRequest.errors.validation": "Заполните все обязательные поля.",
  "formRequest.customValuesPlaceholder": "Другие значения через запятую",
