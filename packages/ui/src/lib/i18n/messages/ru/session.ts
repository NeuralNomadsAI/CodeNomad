export const sessionMessages = {
  ...
  "sessionList.options.ariaLabel": "Сортировка и фильтр сессий",
  "sessionList.options.sort.label": "Сортировка",
  "sessionList.options.sort.activity": "Последняя активность",
  "sessionList.options.sort.name": "Название",
  "sessionList.options.sort.worktree": "Worktree",
  "sessionList.options.filter.label": "Фильтр по worktree",
  "sessionList.options.filter.all": "Все worktree",
  "sessionList.options.filter.workspace": "Рабочая область",
