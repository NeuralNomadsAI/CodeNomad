export const settingsMessages = {
  ...
  "settings.info.updates.check": "Check for updates",
  "settings.info.updates.upToDate": "You are running the latest version.",
  "settings.info.updates.available": "Version {version} is available.",
  ...
  "settings.info.diagnostics.warning": "Warning: Log entries will be included in this report. Common secret patterns (API keys, tokens) are automatically redacted, but review the output before sharing to ensure no sensitive data remains.",
  ...
  "settings.info.diagnostics.scope.label": "Log scope",
  "settings.info.diagnostics.scope.summary": "Summary only",
  "settings.info.diagnostics.scope.withLogs": "Summary + workspace logs",
