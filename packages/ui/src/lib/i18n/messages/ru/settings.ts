export const settingsMessages = {
  ...
  "settings.appearance.startup.restore.subtitle": "Повторно открывать вкладки рабочих пространств и sidecar, активные сессии, черновики, позиции прокрутки и расположение панелей.",
