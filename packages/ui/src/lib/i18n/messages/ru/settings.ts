export const settingsMessages = {
  ...
  "settings.appearance.gitDiff.gutterMode.title": "Режим gutter для Git diff",
  "settings.appearance.gitDiff.gutterMode.subtitle": "Выберите оформление gutter Monaco для диффов на вкладке Git Changes.",
  "settings.appearance.gitDiff.gutterMode.option.compact": "Компактный",
  "settings.appearance.gitDiff.gutterMode.option.normal": "Обычный",
