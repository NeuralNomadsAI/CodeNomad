export const messagingMessages = {
  ...
  "promptInput.voiceInput.liveMode": "Открыть режим живого голоса",
  "voice.hud.title": "Режим живого голоса",
  "voice.hud.connecting": "Подключение...",
  "voice.hud.listening": "Слушает...",
  "voice.hud.speaking": "Говорит...",
  "voice.hud.idle": "Готов",
  "voice.hud.error": "Ошибка голосового подключения",
  "voice.hud.muted": "Звук отключен",
  "voice.hud.mute": "Отключить микрофон",
  "voice.hud.unmute": "Включить микрофон",
  "voice.hud.interrupt": "Прервать ответ",
  "voice.hud.close": "Закрыть голосовой режим",
  "voice.hud.deadman_timeout": "Голосовой режим закрыт из-за неактивности",
  "voice.hud.empty_transcript": "Начните говорить, чтобы начать разговор...",
  "voice.hud.switch_provider": "Переключить голосового провайдера",
} as const
