export const messagingMessages = {
  ...
  "promptInput.btw.question": "Ваш вопрос",
  "promptInput.btw.answer": "Ответ",
  "promptInput.btw.ask": "Спросить",
  "promptInput.btw.loading": "Думает…",
  "promptInput.btw.cancel": "Отменить вопрос",
  "promptInput.btw.close": "Закрыть отдельный вопрос",
  "promptInput.btw.empty": "Модель не вернула текст. Попробуйте переформулировать вопрос.",
  "promptInput.btw.failed": "Не удалось ответить на отдельный вопрос.",
  "promptInput.btw.copy": "Копировать ответ",
  "promptInput.btw.copied": "Скопировано",
  "promptInput.btw.copyFailed": "Не удалось скопировать ответ.",
  ...
  "history.technical": "Включать инструменты и рассуждения",
  "history.counts": "Сообщения: {messages} · инструменты: {tools} · рассуждения: {reasoning}",
  "history.scanning": "Подсчёт…",
  "history.snapshot": "Снимок истории",
  "history.skipped": "Не удалось полностью обработать сообщений: {count}.",
  "history.more": "Следующие результаты",
  "history.text": "Текст",
  "history.tool": "Инструмент",
  "history.reasoning": "Рассуждение",
  ...
  "transcriptFilters.systemMessages": "Система",
  ...
  "promptInput.attachFiles.title": "Прикрепить файл…",
  "promptInput.attachFiles.help": "Выбрать файлы с этого устройства",
  "promptInput.attachFiles.reading": "Чтение файлов…",
  "promptInput.hints.projectFiles": "Ссылка на файлы проекта",
  "promptInput.attachFiles.deviceDetail": "Устройство: {name} · {bytes} байт",
  "promptInput.attachFiles.projectDetail": "Проект: {path}",
  "promptInput.attachFiles.rejected.tooLarge": "{name}: превышает 5 МиБ на файл.",
  "promptInput.attachFiles.rejected.limit": "{name}: превышен лимит 10 файлов или 20 МиБ суммарно.",
  "promptInput.attachFiles.rejected.unreadable": "{name}: не удалось прочитать.",
  ...
  "promptInput.attachFiles.tooLarge.other": "Не удалось прикрепить {count} выбранных файлов, потому что они превышают ограничение вложения в 5 МБ.",
  "promptInput.attachFiles.limit.one": "1 выбранный файл не прикреплён: разрешено не более {maxFiles} файлов общим размером {maxMegabytes} МБ.",
  "promptInput.attachFiles.limit.other": "{count} выбранных файлов не прикреплены: разрешено не более {maxFiles} файлов общим размером {maxMegabytes} МБ.",
  "promptInput.attachFiles.deviceRejected.one": "1 выбранный файл не прикреплён. Файлы должны читаться, быть не больше {maxFileMegabytes} МБ каждый и укладываться в предел {maxFiles} файлов и {maxTotalMegabytes} МБ суммарно.",
  "promptInput.attachFiles.deviceRejected.other": "{count} выбранных файлов не прикреплены. Файлы должны читаться, быть не больше {maxFileMegabytes} МБ каждый и укладываться в предел {maxFiles} файлов и {maxTotalMegabytes} МБ суммарно.",
