export const instanceMessages = {
  ...
  "instanceShell.rightPanel.sections.backgroundProcesses.tooltip": "当前工作区或 worktree 的 OpenCode PTY。",
  ...
  "instanceShell.backgroundProcesses.actions.rename": "重命名",
  "instanceShell.backgroundProcesses.actions.stopRemove": "停止并移除",
  "instanceShell.backgroundProcesses.actions.remove": "移除",
  "instanceShell.backgroundProcesses.rename.title": "重命名后台 Shell",
  "instanceShell.backgroundProcesses.rename.message": "请输入此后台 Shell 的新标题。",
  "instanceShell.backgroundProcesses.rename.inputLabel": "标题",
