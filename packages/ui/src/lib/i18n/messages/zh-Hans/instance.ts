export const instanceMessages = {
  ...
  "instanceShell.rightPanel.tabs.workflows": "工作流",
  "instanceShell.rightPanel.tabs.ariaLabel": "右侧面板标签页",
  "instanceShell.workflows.builder.title": "新建工作流",
  "instanceShell.workflows.builder.description": "按顺序运行多个代理阶段。",
  "instanceShell.workflows.objective.label": "目标",
  "instanceShell.workflows.objective.placeholder": "描述此工作流应实现的结果",
  "instanceShell.workflows.stages.title": "阶段",
  "instanceShell.workflows.stages.count": "{count} / {max}",
  "instanceShell.workflows.stages.number": "阶段 {number}",
  "instanceShell.workflows.fields.title": "标题",
  "instanceShell.workflows.fields.instructions": "说明",
  "instanceShell.workflows.fields.agent": "代理",
  "instanceShell.workflows.fields.model": "模型",
  "instanceShell.workflows.fields.requiresApproval": "此阶段后需要批准",
  "instanceShell.workflows.defaults.planner.title": "规划者",
  "instanceShell.workflows.defaults.planner.instructions": "为目标制定清晰的实施计划。",
  "instanceShell.workflows.defaults.implementer.title": "实施者",
  "instanceShell.workflows.defaults.implementer.instructions": "实施计划并验证结果。",
  "instanceShell.workflows.defaults.newStage.title": "阶段 {number}",
  "instanceShell.workflows.actions.moveUp": "上移阶段",
  "instanceShell.workflows.actions.moveDown": "下移阶段",
  "instanceShell.workflows.actions.removeStage": "删除阶段",
  "instanceShell.workflows.actions.addStage": "添加阶段",
  "instanceShell.workflows.actions.start": "启动工作流",
  "instanceShell.workflows.actions.starting": "正在启动...",
  "instanceShell.workflows.actions.refresh": "刷新工作流",
  "instanceShell.workflows.actions.approve": "批准",
  "instanceShell.workflows.actions.keepWaiting": "继续等待",
  "instanceShell.workflows.actions.cancel": "取消工作流",
  "instanceShell.workflows.actions.keepRunning": "继续运行",
  "instanceShell.workflows.actions.openSession": "打开生成的会话",
  "instanceShell.workflows.history.title": "运行历史",
  "instanceShell.workflows.history.description": "此工作区当前和之前的运行记录。",
  "instanceShell.workflows.history.loading": "正在加载工作流...",
  "instanceShell.workflows.history.empty": "尚无工作流运行记录。",
  "instanceShell.workflows.confirm.approve.message": "批准已完成的阶段并继续此工作流？",
  "instanceShell.workflows.confirm.cancel.message": "取消此工作流？正在运行的工作将停止。",
  "instanceShell.workflows.errors.action": "工作流操作失败。",
  "instanceShell.workflows.errors.openSession": "无法打开生成的会话。",
  "instanceShell.workflows.output": "输出",
  "instanceShell.workflows.outputTruncated": "输出已截短。请打开生成的会话以查看完整输出。",
  "instanceShell.workflows.live.statusChanged": "工作流状态已变为{status}。",
  "instanceShell.workflows.status.pending": "待处理",
  "instanceShell.workflows.status.running": "运行中",
  "instanceShell.workflows.status.waiting_for_review": "等待审核",
  "instanceShell.workflows.status.completed": "已完成",
  "instanceShell.workflows.status.failed": "失败",
  "instanceShell.workflows.status.cancelled": "已取消",
  "instanceShell.workflows.status.interrupted": "已中断",
  "instanceShell.rightPanel.modules.core": "CodeNomad 核心",
  "instanceShell.rightPanel.modules.core.description": "内置 Git、文件和状态面板。",
  "instanceShell.rightPanel.customize.toggle": "自定义右侧面板",
  "instanceShell.rightPanel.customize.title": "自定义右侧面板",
  "instanceShell.rightPanel.customize.description": "显示或隐藏右侧面板模块。",
  "instanceShell.rightPanel.customize.reset": "重置",
  "instanceShell.rightPanel.customize.tabs": "标签页",
  "instanceShell.rightPanel.customize.sections": "自定义分区",
  "instanceShell.rightPanel.customize.statusSections": "状态分区",
  "instanceShell.rightPanel.customize.dragToReorder": "拖动以重新排序。",
  "instanceShell.rightPanel.customize.alwaysVisible": "始终可见",
  "instanceShell.rightPanel.customize.unavailableModules": "不可用模块",
  "instanceShell.rightPanel.customize.moduleUnavailable": "{module} 不可用",
  ...
  "instanceShell.rightPanel.actions.conflict.message": "文件已被智能体修改。是否覆盖智能体的更改？",
  ...
  "instanceShell.rightPanel.sections.backgroundProcesses.tooltip": "智能体启动的长时间运行进程。你可以监控其输出、停止或终止它们。",
  ...
  "instanceShell.gitChanges.noSessionSelected": "选择会话以查看 Git 更改。",
