export const instanceMessages = {
  ...
  "instanceShell.worktree.actionTarget": "工作树操作目标",
  "instanceShell.worktree.create.fromCurrentBranch": "从当前分支新建",
  "instanceShell.worktree.create.action": "创建 worktree",
  "instanceShell.worktree.create.description": "创建一个 Git worktree",
