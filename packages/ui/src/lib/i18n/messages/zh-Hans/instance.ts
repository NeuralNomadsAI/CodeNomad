export const instanceMessages = {
  ...
  "gitPanel.history": "历史",
  "filesPanel.workspace": "工作区",
  "filesPanel.commits": "提交",
  ...
  "gitPanel.detached": "分离的 HEAD",
  "gitPanel.filter": "筛选已加载的提交…",
  "gitPanel.emptyHistory": "没有可显示的提交",
  "gitPanel.more": "加载更早的提交",
  "gitPanel.files": "{count} 个已更改文件",
  "gitPanel.actions": "Git 操作",
  "gitPanel.diff": "Git 差异",
  "gitPanel.parentDiff": "与第一个父提交比较",
  "gitPanel.backChat": "返回对话",
  ...
  "instanceShell.backgroundProcesses.error": "无法加载后台 Shell。",
  "instanceShell.backgroundProcesses.empty": "没有后台 Shell。",
  "instanceShell.backgroundProcesses.status.running": "运行中",
  "instanceShell.backgroundProcesses.status.exited": "已退出",
  "instanceShell.backgroundProcesses.status.timeout": "已超时",
  "instanceShell.backgroundProcesses.status.killed": "已终止",
  "instanceShell.backgroundProcesses.pid": "PID {pid}",
  "instanceShell.backgroundProcesses.exitCode": "退出码 {code}",
  "instanceShell.backgroundProcesses.actions.stopRemove": "停止并移除",
  "instanceShell.backgroundProcesses.actions.remove": "移除",
  "instanceShell.backgroundProcesses.actions.output": "查看输出",
  "instanceShell.backgroundProcesses.remove.title": "移除后台 Shell",
  "instanceShell.backgroundProcesses.remove.message": "移除“{title}”？正在运行的进程将被停止。",
  ...
  "instanceShell.worktree.unavailable": "不可用",
  "instanceShell.worktree.create.fromCurrentBranch": "从当前分支新建",
  "instanceShell.worktree.create.action": "创建并使用 worktree",
  "instanceShell.worktree.create.description": "从此会话的检出创建命名 Git 分支，并将会话族移至新 worktree。未提交的更改保留在原检出中。",
  "instanceShell.worktree.create.name": "名称",
  "instanceShell.worktree.create.placeholder": "worktree-name",
  "instanceShell.worktree.create.success": "已创建 worktree {slug}",
  "instanceShell.worktree.create.error": "无法创建 worktree",
  ...
  "instanceShell.worktree.delete.action": "删除 worktree",
  "instanceShell.worktree.delete.description": "删除此分支 worktree 及其本地文件夹。",
  ...
  "opencodeBinarySelector.customPath.placeholder": "输入 {name} 可执行文件路径…",
