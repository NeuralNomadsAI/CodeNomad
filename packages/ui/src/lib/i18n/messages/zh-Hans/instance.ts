export const instanceMessages = {
  ...
  "instanceShell.rightPanel.errors.gitStatusFailed": "加载 git status 失败",
  "instanceShell.rightPanel.errors.diffNotAvailable": "已删除文件的 diff 暂不可用",
  "instanceShell.rightPanel.errors.binaryFile": "无法显示二进制文件",
  "instanceShell.rightPanel.errors.unsupportedType": "不支持的文件类型",
  "instanceShell.rightPanel.errors.fileChangesFailed": "加载文件变更失败",
  "instanceShell.rightPanel.errors.filesLoadFailed": "加载文件列表失败",
  "instanceShell.rightPanel.errors.fileReadFailed": "读取文件失败",
  "instanceShell.rightPanel.errors.fileSaveFailed": "保存文件失败",
