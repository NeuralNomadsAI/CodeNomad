export const sessionMessages = {
  ...
  "sessionList.options.ariaLabel": "排序和筛选会话",
  "sessionList.options.sort.label": "排序",
  "sessionList.options.sort.activity": "最近活动",
  "sessionList.options.sort.name": "名称",
  "sessionList.options.sort.worktree": "Worktree",
  "sessionList.options.filter.label": "按 worktree 筛选",
  "sessionList.options.filter.all": "所有 worktree",
  "sessionList.options.filter.workspace": "工作区",
