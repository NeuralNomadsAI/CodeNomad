export const folderSelectionMessages = {
  ...
  "folderSelection.servers.dialog.savedServer": "已保存的服务器",
  "folderSelection.servers.dialog.newServer": "新服务器",
  "folderSelection.servers.dialog.newServerDescription": "输入其他服务器地址",
