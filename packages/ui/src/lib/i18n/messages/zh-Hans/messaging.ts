export const messagingMessages = {
  ...
  "promptInput.voiceInput.liveMode": "开启实时语音模式",
  "promptInput.resizeHandle.title": "拖动以调整输入框高度",
  "voice.hud.title": "实时语音模式",
  "voice.hud.connecting": "正在连接...",
  "voice.hud.listening": "正在倾听...",
  "voice.hud.speaking": "正在讲话...",
  "voice.hud.idle": "就绪",
  "voice.hud.error": "语音连接错误",
  "voice.hud.muted": "已静音",
  "voice.hud.mute": "静音麦克风",
  "voice.hud.unmute": "取消静音麦克风",
  "voice.hud.interrupt": "打断回复",
  "voice.hud.close": "关闭语音模式",
  "voice.hud.deadman_timeout": "由于长时间未活动，语音模式已关闭",
  "voice.hud.empty_transcript": "开始说话以发起对话...",
  "voice.hud.switch_provider": "切换语音提供商",
} as const
