export const messagingMessages = {
  ...
  "promptInput.btw.question": "你的问题",
  "promptInput.btw.answer": "回答",
  "promptInput.btw.ask": "提问",
  "promptInput.btw.loading": "思考中…",
  "promptInput.btw.cancel": "取消提问",
  "promptInput.btw.close": "关闭旁支问题",
  "promptInput.btw.empty": "模型未返回文本。请尝试换一种方式提问。",
  "promptInput.btw.failed": "无法回答旁支问题。",
  "promptInput.btw.copy": "复制回答",
  "promptInput.btw.copied": "已复制",
  "promptInput.btw.copyFailed": "无法复制回答。",
  ...
  "history.technical": "包含工具和思考",
  "history.counts": "{messages} 条消息 · {tools} 个工具 · {reasoning} 个思考块",
  "history.scanning": "正在统计…",
  "history.snapshot": "历史快照",
  "history.skipped": "无法完整处理 {count} 条消息。",
  "history.more": "下一页结果",
  "history.text": "文本",
  "history.tool": "工具",
  "history.reasoning": "思考",
  ...
  "promptInput.attachFiles.help": "从此设备选择文件",
  "promptInput.attachFiles.reading": "正在读取文件…",
  "promptInput.hints.projectFiles": "引用项目文件",
  "promptInput.attachFiles.deviceDetail": "设备：{name} · {bytes} 字节",
  "promptInput.attachFiles.projectDetail": "项目：{path}",
  "promptInput.attachFiles.rejected.tooLarge": "{name}：超过每个文件 5 MiB 的限制。",
  "promptInput.attachFiles.rejected.limit": "{name}：超过 10 个文件或总计 20 MiB 的限制。",
  "promptInput.attachFiles.rejected.unreadable": "{name}：无法读取。",
  ...
  "promptInput.attachFiles.tooLarge.other": "由于超过 5 MB 附件大小限制，{count} 个选中的文件无法附加。",
  "promptInput.attachFiles.limit.one": "附件最多为 {maxFiles} 个且总计 {maxMegabytes} MB，因此未附加 1 个选中的文件。",
  "promptInput.attachFiles.limit.other": "附件最多为 {maxFiles} 个且总计 {maxMegabytes} MB，因此未附加 {count} 个选中的文件。",
  "promptInput.attachFiles.deviceRejected.one": "未附加 1 个选中的文件。文件必须可读取、每个不超过 {maxFileMegabytes} MB，并且不超过 {maxFiles} 个和总计 {maxTotalMegabytes} MB。",
  "promptInput.attachFiles.deviceRejected.other": "未附加 {count} 个选中的文件。文件必须可读取、每个不超过 {maxFileMegabytes} MB，并且不超过 {maxFiles} 个和总计 {maxTotalMegabytes} MB。",
