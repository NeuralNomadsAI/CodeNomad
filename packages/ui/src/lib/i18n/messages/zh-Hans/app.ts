export const appMessages = {
  ...
  "window.menu.ariaLabel": "应用程序菜单",
  "window.menu.file": "文件",
  "window.menu.edit": "编辑",
  "window.menu.view": "视图",
  "window.menu.leftPanel": "左侧面板",
  "window.menu.rightPanel": "右侧面板",
  "window.menu.timeline": "时间线",
  "window.menu.timelineTools": "时间线中的工具",
  "window.menu.window": "窗口",
  "window.menu.help": "帮助",
