export const settingsMessages = {
  ...
  "agentSelector.add.title": "添加项目智能体",
  "agentSelector.add.name.placeholder": "agent-name",
  "agentSelector.add.name.ariaLabel": "智能体名称",
  "agentSelector.add.description.placeholder": "简短描述",
  "agentSelector.add.description.ariaLabel": "智能体描述",
  "agentSelector.add.prompt.placeholder": "系统提示词（可选）",
  "agentSelector.add.prompt.ariaLabel": "智能体提示词",
  "agentSelector.add.action": "添加智能体",
  "agentSelector.add.creating": "正在添加...",
  "agentSelector.add.name.help": "使用字母、数字、连字符或下划线。",
  "agentSelector.add.invalidName": "智能体名称请使用字母、数字、连字符或下划线。",
