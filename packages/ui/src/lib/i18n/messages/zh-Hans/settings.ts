export const settingsMessages = {
  ...
  "settings.appearance.gitDiff.gutterMode.title": "Git diff 边栏模式",
  "settings.appearance.gitDiff.gutterMode.subtitle": "选择 Git Changes 差异中使用的 Monaco 边栏展示方式。",
  "settings.appearance.gitDiff.gutterMode.option.compact": "紧凑",
  "settings.appearance.gitDiff.gutterMode.option.normal": "标准",
