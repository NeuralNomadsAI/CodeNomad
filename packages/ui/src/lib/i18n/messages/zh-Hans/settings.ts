export const settingsMessages = {
  ...
  "modelSelector.error.noVisibleModels": "发送消息前，请至少选择一个可见模型。",
  ...
  "settings.providers.modelVisibility.mode.label": "模型可见性模式",
  "settings.providers.modelVisibility.mode.all": "所有模型",
  "settings.providers.modelVisibility.mode.all.description": "显示当前和新报告的模型。",
  "settings.providers.modelVisibility.mode.custom": "自定义",
  "settings.providers.modelVisibility.mode.custom.description": "仅显示已选择的模型 ID。",
  ...
  "settings.providers.modelVisibility.count": "已选择 {selected}/{total}",
  "settings.providers.modelVisibility.selectAll": "全选",
  "settings.providers.modelVisibility.selectNone": "全部取消",
  "settings.providers.modelVisibility.unavailable.one": "当前有 {count} 个已选模型不可用。",
  "settings.providers.modelVisibility.unavailable.other": "当前有 {count} 个已选模型不可用。",
  "settings.providers.modelVisibility.empty": "没有与搜索匹配的模型。",
  "settings.providers.modelVisibility.listAriaLabel": "{provider} 的模型",
  "settings.providers.modelVisibility.saveFailed": "无法保存模型可见性设置。",
