export const settingsMessages = {
  ...
  "settings.speech.error.urlChangeKeyRequired.title": "端點已變更",
  "settings.speech.error.urlChangeKeyRequired.stt": "您變更了輸入 Base URL 但未輸入新的 API 密鑰。請輸入新密鑰或先清除已儲存的密鑰。",
  "settings.speech.error.urlChangeKeyRequired.tts": "您變更了輸出 Base URL 但未輸入新的 API 密鑰。請輸入新密鑰或先清除已儲存的密鑰。",
  "settings.speech.error.urlChangeKeyRequired.both": "您變更了兩個 Base URL 但未輸入新的 API 密鑰。請輸入新密鑰或先清除已儲存的密鑰。",
