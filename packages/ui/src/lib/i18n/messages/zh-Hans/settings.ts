export const settingsMessages = {
  ...
  "settings.appearance.startup.restore.subtitle": "重新打开标签页、活动会话和未发送的消息，恢复布局，并在此设备上缓存最近的会话消息以便更快重新打开。",
  ...
  "settings.behavior.toolInputsVisibility.title": "工具输入",
  "settings.behavior.toolInputsVisibility.subtitle": "设置工具调用输入参数的默认可见性。",
  "settings.behavior.usageMetrics.title": "令牌用量",
