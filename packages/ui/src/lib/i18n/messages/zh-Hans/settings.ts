export const settingsMessages = {
  ...
  "settings.speech.error.urlChangeKeyRequired.title": "端点已变更",
  "settings.speech.error.urlChangeKeyRequired.stt": "您变更了输入 Base URL 但未输入新的 API 密钥。请输入新密钥或先清除已保存的密钥。",
  "settings.speech.error.urlChangeKeyRequired.tts": "您变更了输出 Base URL 但未输入新的 API 密钥。请输入新密钥或先清除已保存的密钥。",
  "settings.speech.error.urlChangeKeyRequired.both": "您变更了两个 Base URL 但未输入新的 API 密钥。请输入新密钥或先清除已保存的密钥。",
