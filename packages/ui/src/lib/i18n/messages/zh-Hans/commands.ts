export const commandMessages = {
  ...
  "commands.removeSessionTechnicalParts.label": "删除会话工具和推理",
  "commands.removeSessionTechnicalParts.description": "保留最终回复并删除已完成的工具输出和推理",
  "commands.removeSessionTechnicalParts.keywords": "清理, 工具, 推理, 删除, 会话",
  "commands.removeSessionTechnicalParts.empty.title": "没有可删除的内容",
  "commands.removeSessionTechnicalParts.empty.message": "此会话没有已完成的工具输出或推理块。",
  "commands.removeSessionTechnicalParts.confirm.title": "删除工具和推理？",
  "commands.removeSessionTechnicalParts.confirm.message": "工具输出：{toolCount}；推理块：{reasoningCount}。最终回复文本将保留。",
  "commands.removeSessionTechnicalParts.confirm.label": "删除",
  "commands.removeSessionTechnicalParts.failed.title": "删除失败",
  "commands.removeSessionTechnicalParts.failed.message": "无法清理 {count} 个回复。",
  ...
  "commands.toolOutputsDefault.description": "设置工具输出的默认可见性",
  "commands.toolOutputsDefault.keywords": "tool, output, hide, expand, collapse, 工具, 输出, 隐藏, 展开, 折叠",

  "commands.diagnosticsDefault.label": "诊断默认 · {state}",
  "commands.diagnosticsDefault.description": "设置诊断输出的默认可见性",
  "commands.diagnosticsDefault.keywords": "diagnostics, hide, expand, collapse, 诊断, 隐藏, 展开, 折叠",
