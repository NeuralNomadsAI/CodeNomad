export const toolCallMessages = {
  ...
  "toolCall.renderer.toolName.shell": "终端",
  "toolCall.renderer.toolName.fetch": "获取",
  ...
  "permissionApproval.kind.form": "表单",
  "formRequest.selectPlaceholder": "选择一个选项",
  "formRequest.openExternal": "打开外部表单",
  "formRequest.cancel": "取消",
  "formRequest.submit": "提交",
  "formRequest.submitting": "正在提交...",
  "formRequest.errors.reply": "无法提交表单",
  "formRequest.errors.cancel": "无法取消表单",
  "formRequest.errors.validation": "请填写所有必填字段。",
  "formRequest.customValuesPlaceholder": "其他值，用逗号分隔",
  ...
  "toolCall.task.sections.prompt": "提示词",
