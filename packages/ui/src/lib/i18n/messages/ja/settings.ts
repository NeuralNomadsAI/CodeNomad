export const settingsMessages = {
  ...
  "settings.speech.error.urlChangeKeyRequired.title": "エンドポイントが変更されました",
  "settings.speech.error.urlChangeKeyRequired.stt": "入力ベース URL を変更しましたが、新しい API キーを入力していません。新しいキーを入力するか、保存済みのキーを削除してください。",
  "settings.speech.error.urlChangeKeyRequired.tts": "出力ベース URL を変更しましたが、新しい API キーを入力していません。新しいキーを入力するか、保存済みのキーを削除してください。",
  "settings.speech.error.urlChangeKeyRequired.both": "両方のベース URL を変更しましたが、新しい API キーを入力していません。新しいキーを入力するか、保存済みのキーを削除してください。",
