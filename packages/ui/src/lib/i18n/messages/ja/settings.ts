export const settingsMessages = {
  ...
  "settings.appearance.colorScheme.custom.field.surfaceBase": "コンテンツ背景",
  "settings.appearance.colorScheme.custom.field.surfaceSecondary": "パネル背景",
  "settings.appearance.colorScheme.custom.field.surfaceMuted": "控えめな背景",
  "settings.appearance.colorScheme.custom.field.borderBase": "境界線と区切り",
