export const settingsMessages = {
  "settings.usage.title": "統計",
  "settings.usage.scope": "接続中のOpenCodeサービス全体：全プロジェクト、独立したクローン、サブセッションを含みます。開いているフォルダーには限定されません。期間は直近の日数、活動は表示されたタイムゾーンに基づきます。",
  "settings.usage.noProject": "プロジェクトを開いてOpenCodeサービスに接続し、サービス全体の統計を表示してください。",
  "settings.usage.period": "期間",
  "settings.usage.days": "直近{count}日間",
  "settings.usage.loading": "統計を読み込み中…",
  "settings.usage.error": "サービスの統計を更新できませんでした。OpenCode接続が必要です。表示データは前回成功した更新のものです。",
