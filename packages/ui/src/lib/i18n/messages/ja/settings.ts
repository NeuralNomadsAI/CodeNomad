export const settingsMessages = {
  ...
  "modelSelector.error.noVisibleModels": "メッセージを送信する前に、表示するモデルを1つ以上選択してください。",
  ...
  "settings.providers.modelVisibility.mode.label": "モデル表示モード",
  "settings.providers.modelVisibility.mode.all": "すべてのモデル",
  "settings.providers.modelVisibility.mode.all.description": "現在および新しく報告されたモデルを表示します。",
  "settings.providers.modelVisibility.mode.custom": "カスタム",
  "settings.providers.modelVisibility.mode.custom.description": "選択したモデル ID のみ表示します。",
  ...
  "settings.providers.modelVisibility.count": "{total} 件中 {selected} 件を選択",
  "settings.providers.modelVisibility.selectAll": "すべて選択",
  "settings.providers.modelVisibility.selectNone": "すべて解除",
  "settings.providers.modelVisibility.unavailable.one": "選択したモデル {count} 件は現在利用できません。",
  "settings.providers.modelVisibility.unavailable.other": "選択したモデル {count} 件は現在利用できません。",
  "settings.providers.modelVisibility.empty": "検索に一致するモデルはありません。",
  "settings.providers.modelVisibility.listAriaLabel": "{provider} のモデル",
  "settings.providers.modelVisibility.saveFailed": "モデルの表示設定を保存できませんでした。",
