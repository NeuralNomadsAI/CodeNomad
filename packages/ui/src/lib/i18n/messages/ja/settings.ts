export const settingsMessages = {
  ...
  "settings.opencode.setup.source.legacy": "CodeNomad の旧プライベートインストールです。共有インストールは見つかりませんでした。",
  "settings.opencode.setup.sharedInstall": "ユーザー用にインストールして PATH を設定",
  "settings.opencode.setup.sharedInstallDescription": "他のクライアントと共有する標準の npm インストールを使用します。インストール後に新しいターミナルを開いてください。旧プライベートコピーは保持されます。",
