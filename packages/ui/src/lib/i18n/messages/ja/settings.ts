export const settingsMessages = {
  "settings.usage.title": "使用状況",
  "settings.usage.scope": "接続中のOpenCodeサービス全体：全プロジェクト、独立したクローン、サブセッションを含みます。開いているフォルダーには限定されません。期間は直近の日数、活動は表示されたタイムゾーンに基づきます。",
  "settings.usage.noProject": "プロジェクトを開いてOpenCodeサービスに接続し、サービス全体の使用状況を表示してください。",
  "settings.usage.period": "期間",
  "settings.usage.days": "直近{count}日間",
  "settings.usage.loading": "使用状況を読み込み中…",
  "settings.usage.error": "サービスの使用状況を更新できませんでした。OpenCode接続が必要です。表示データは前回成功した更新のものです。",
  "settings.usage.sessions": "セッション",
  "settings.usage.subagents": "サブセッション",
  "settings.usage.prompts": "プロンプト",
  "settings.usage.steps": "ステップ",
  "settings.usage.input": "入力トークン",
  "settings.usage.output": "出力トークン",
  "settings.usage.reasoning": "推論トークン",
  "settings.usage.cacheRead": "キャッシュ読取トークン",
  "settings.usage.cacheWrite": "キャッシュ書込トークン",
  "settings.usage.activeDays": "活動日数",
  "settings.usage.streak": "連続日数",
  "settings.usage.cost": "記録された費用（USD）",
  "settings.usage.costHint": "OpenCodeが記録した費用とトークンです。サブスクリプションの枠やプロバイダーの請求は計測しません。",
  "settings.usage.models": "モデル別",
  "settings.usage.model": "モデル",
  "settings.usage.activity": "日別の活動",
  ...
  "settings.accounts.label": "アカウント名",
  ...
  "settings.websearch.effective": "このプロジェクトの検索：{provider}",
  ...
  "settings.opencode.setup.source.user": "現在の PATH 外にユーザーの npm インストールが見つかりました。",
  "settings.opencode.setup.sharedInstall": "ユーザー用にインストールして PATH を設定",
  "settings.opencode.setup.sharedInstallDescription": "他のクライアントと共有する標準の npm インストールを使用します。インストール後に新しいターミナルを開いてください。",
  "settings.opencode.update.available": "OpenCode {version} が利用可能です。",
  "settings.opencode.setup.manage": "OpenCode を管理…",
  "settings.opencode.setup.connected": "OpenCode に接続しています。",
  "settings.opencode.setup.disconnected": "OpenCode に接続していません。",
  ...
  "settings.opencode.setup.progress.start": "OpenCode に接続中…",
  "settings.opencode.setup.progress.restart": "共有サービスを再起動中…",
  "settings.opencode.setup.progress.reload": "OpenCode の設定を再読み込み中…",
  ...
  "settings.opencode.setup.ready": "OpenCode の実行ファイルが利用可能です。",
  "settings.opencode.setup.recommended": "推奨最小バージョン",
  "settings.opencode.setup.untested": "OpenCode {version} は、この CodeNomad リリースで完全には検証されていません。これだけを理由に接続が拒否されることはありません。",
  "settings.opencode.setup.error": "選択した実行ファイルを確認できませんでした。",
  "settings.opencode.setup.minimum": "最小バージョン",
  "settings.opencode.setup.minimumReason": "OpenCode {version} で、会話表示に必要なネイティブのステップ開始時刻が導入されました。それ以前のバージョンには、削除済みのイベント変換が必要です。",
  "settings.opencode.setup.canonical_api": "実行中のサービスは、この CodeNomad リリースに必要なセッション、権限、フォーム、受信キューの API を提供していません。",
  "settings.opencode.setup.session_environment": "実行中のサービスは、プロンプトやコマンドの送信前に必要なセッション環境の置き換えに対応していません。",
  "settings.opencode.setup.daemon": "実行中のサービス",
  "settings.opencode.setup.install": "OpenCode をインストールして起動",
  "settings.opencode.setup.connect": "接続して続行",
  "settings.opencode.setup.restart": "共有サービスを再起動",
  "settings.opencode.setup.restartRequired": "実行中のサービスの更新が必要です。再起動すると、接続中のすべての OpenCode クライアントで作業が中断されます。",
  ...
  "settings.opencode.setup.serviceError": "共有サービスを確認できません。接続と認証を確認して再試行してください。",
  "settings.opencode.setup.manual": "対応する実行ファイルを選ぶか、実行ホストに @opencode/cli をインストールして再試行してください。",
  "settings.opencode.setup.wsl": "この実行ファイルは WSL 内で動作します。選択したディストリビューション内で OpenCode をインストールまたは更新してください。",
  "settings.opencode.setup.chooseBinary": "実行ファイルを選択",
  "settings.opencode.setup.required": "OpenCode の設定が必要です",
  ...
  "settings.appearance.palette.mist.description": "冷たい色味を帯びた柔らかなニュートラルグレー。",
  "settings.appearance.palette.slate": "粘板岩",
  "settings.appearance.palette.slate.description": "青みがかったグレーの背景と控えめな鉱物色のアクセント。",
  "settings.appearance.palette.clay": "粘土",
  "settings.appearance.palette.clay.description": "暖かな土色のグレーと落ち着いた黄土色。",
  "settings.appearance.palette.linen": "リネン",
  "settings.appearance.palette.linen.description": "柔らかな象牙色の紙と灰緑色の文字。",
  "settings.appearance.palette.iris": "アイリス",
  "settings.appearance.palette.iris.description": "まぶしい白を使わない、涼しげなラベンダーグレーの背景。",
  "settings.appearance.palette.sage": "セージ",
  "settings.appearance.palette.sage.description": "オリーブ色を帯びた穏やかな灰緑色の背景。",
  "settings.appearance.palette.saved": "保存済みのカスタマイズ",
  ...
  "instanceServiceStatus.plugins.scope.legend": "次のルールの書き込み先",
  "instanceServiceStatus.plugins.scope.global": "グローバル",
  ...
  "instanceServiceStatus.plugins.runtime.active": "有効",
  "instanceServiceStatus.plugins.runtime.failed": "失敗",
  "instanceServiceStatus.plugins.runtime.inactive": "未実行",
  "instanceServiceStatus.plugins.runtime.empty": "ランタイムからプラグインが報告されていません。",
  "instanceServiceStatus.plugins.refresh": "プラグインコントロールを更新",
  "instanceServiceStatus.plugins.toggleAriaLabel": "{name} の有効化ルールを変更",
  "instanceServiceStatus.plugins.globalOverridden": "ここではプロジェクトルールがグローバル状態を上書きしています。",
  "instanceServiceStatus.plugins.source.package": "パッケージ: {source}",
  "instanceServiceStatus.plugins.source.local": "ローカルソース: {source}",
  "instanceServiceStatus.plugins.source.builtin": "OpenCode 組み込み",
  "instanceServiceStatus.plugins.source.sdk": "SDK ホストから提供",
  "instanceServiceStatus.plugins.ruleState.default": "継承",
  "instanceServiceStatus.plugins.ruleState.enabled": "ルールで有効",
  "instanceServiceStatus.plugins.ruleState.disabled": "ルールで無効",
  "instanceServiceStatus.plugins.toast.ruleSaved": "{name} の {scope} 有効化ルールを保存しました。",
  "instanceServiceStatus.plugins.toast.ruleUnchanged": "{name} の {scope} 有効化ルールはすでに最新です。",
  "instanceServiceStatus.plugins.toast.reloadNote": "デーモンが設定を再読み込みすると、このルールが適用されます。",
  "instanceServiceStatus.plugins.errors.load": "プラグイン有効化コントロールを読み込めませんでした。",
  "instanceServiceStatus.plugins.errors.refresh": "更新に失敗しました。最後に確認できた状態を表示しています。",
  "instanceServiceStatus.plugins.errors.save": "{name} の有効化ルール（スコープ: {scope}）を保存できませんでした。",
  "instanceServiceStatus.plugins.errors.forbidden": "このワークスペースには、{name} の設定場所（スコープ: {scope}）を変更する権限がありません。",
  "instanceServiceStatus.plugins.errors.conflict": "{name} のルール（スコープ: {scope}）を保存中に、プロジェクトまたは設定が変更されました。更新して再試行してください。",
  "instanceServiceStatus.plugins.errors.invalidConfig": "{name} の OpenCode 設定（スコープ: {scope}）の形式が正しくありません。設定は変更されませんでした。",
  ...
  "permissionBanner.detail.form.one": "{count} 件のフォーム",
  "permissionBanner.detail.form.other": "{count} 件のフォーム",
  ...
  "settings.appearance.colorScheme.title": "カラースキーム",
  "settings.appearance.colorScheme.subtitle": "この CodeNomad サーバーに接続するクライアントの配色を選択します。",
  "settings.appearance.colorScheme.option.system": "システム",
  "settings.appearance.colorScheme.option.light": "ライト",
  "settings.appearance.colorScheme.option.porcelain": "ポーセリン",
  "settings.appearance.colorScheme.option.dawn": "夜明け",
  "settings.appearance.colorScheme.option.parchment": "パーチメント",
  "settings.appearance.colorScheme.option.codeNomadClassic": "クラシック",
  "settings.appearance.colorScheme.option.basalt": "バサルト",
  "settings.appearance.colorScheme.option.fjord": "フィヨルド",
  "settings.appearance.colorScheme.option.lichen": "ライケン",
  "settings.appearance.colorScheme.option.velvet": "ベルベット",
  "settings.appearance.colorScheme.option.ember": "エンバー",
  "settings.appearance.colorScheme.option.custom": "カスタム",
  "settings.appearance.colorScheme.description.system": "OS の表示設定に合わせます。",
  "settings.appearance.colorScheme.description.light": "明るくニュートラルな配色です。",
  "settings.appearance.colorScheme.description.porcelain": "柔らかなニュートラルカラーの枠と、くっきりした白い作業領域。",
  "settings.appearance.colorScheme.description.dawn": "涼やかな昼光色の面に、明快な青のアクセント。",
  "settings.appearance.colorScheme.description.parchment": "温かな紙色の面に、控えめな青緑のアクセント。",
  "settings.appearance.colorScheme.description.codeNomadClassic": "CodeNomad オリジナルのダーク配色です。",
  "settings.appearance.colorScheme.description.basalt": "チャコールに寒色の青を合わせた配色です。",
  "settings.appearance.colorScheme.description.fjord": "深いブルーグレーに青緑を合わせた配色です。",
  "settings.appearance.colorScheme.description.lichen": "土色のグリーングレーに苔色を合わせた配色です。",
  "settings.appearance.colorScheme.description.velvet": "深いプラム色に暖かなピーチ色を合わせた配色です。",
  "settings.appearance.colorScheme.description.ember": "暖かな黒褐色に銅色を合わせた配色です。",
  "settings.appearance.colorScheme.description.custom": "独自の配色を作成して保存します。",
  "settings.appearance.colorScheme.custom.appearance": "カスタム表示",
  "settings.appearance.colorScheme.custom.appearance.light": "ライト",
  "settings.appearance.colorScheme.custom.appearance.dark": "ダーク",
  "settings.appearance.colorScheme.custom.colors": "色",
  "settings.appearance.colorScheme.custom.field.surfaceBase": "ベース",
  "settings.appearance.colorScheme.custom.field.surfaceSecondary": "セカンダリ",
  "settings.appearance.colorScheme.custom.field.surfaceMuted": "控えめ",
  "settings.appearance.colorScheme.custom.field.borderBase": "境界線",
  "settings.appearance.colorScheme.custom.field.textPrimary": "メインテキスト",
  "settings.appearance.colorScheme.custom.field.textMuted": "控えめなテキスト",
  "settings.appearance.colorScheme.custom.field.accentPrimary": "アクセント",
  "settings.appearance.colorScheme.custom.field.statusSuccess": "成功",
  "settings.appearance.colorScheme.custom.field.statusWarning": "警告",
  "settings.appearance.colorScheme.custom.field.statusError": "エラー",
  "settings.appearance.colorScheme.custom.field.userAccent": "ユーザー",
  "settings.appearance.colorScheme.custom.field.agentAccent": "エージェント",
  "settings.appearance.colorScheme.custom.field.compactionAccent": "コンパクション",
  "settings.appearance.colorScheme.custom.field.yoloAccent": "YOLOモード",
  "settings.appearance.colorScheme.custom.pickerAriaLabel": "{name}を選択",
  "settings.appearance.colorScheme.custom.valueAriaLabel": "{name}の16進値",
  "settings.appearance.colorScheme.custom.warning.format": "大文字の #RRGGBB 形式で入力してください。",
  "settings.appearance.colorScheme.custom.reset": "リセット",
  "settings.appearance.colorScheme.custom.new": "新規",
  "settings.appearance.colorScheme.custom.name": "名前",
  "settings.appearance.colorScheme.custom.delete": "削除",
  "settings.appearance.colorScheme.custom.deleteConfirm": "「{name}」を削除しますか？",
  ...
  "settings.opencode.update.title": "OpenCode バージョン",
  "settings.opencode.update.subtitle": "設定された OpenCode バイナリのインストール済みバージョンです。",
  "settings.opencode.update.checking": "インストール済みバージョンを読み込んでいます...",
  "settings.opencode.update.checkFailed": "インストール済みの OpenCode バージョンを読み込めませんでした。",
  ...
  "settings.opencode.update.availableUnsupported": "OpenCode {version} を利用できます。OpenCode V2 は自動インストールに対応していません。",
  ...
  "settings.providers.method.command": "コマンド",
  "settings.providers.method.mixed": "API キー、OAuth、またはコマンド",
  ...
  "settings.providers.prompt.customValuesPlaceholder": "追加の値（カンマ区切り）",
  "settings.providers.command.description": "OpenCode がこのプロバイダーのネイティブ認証コマンドを実行します。",
  "settings.providers.command.waitingTitle": "コマンド認証を待機中",
  "settings.providers.command.waitingMessage": "認証コマンドに表示される手順を完了してください。",
  ...
  "settings.behavior.expansionDefaults.otherTools": "その他",
  ...
  "settings.behavior.focusExistingWindowOnSecondLaunch.title": "2 回目の起動で既存ウィンドウをフォーカス",
  "settings.behavior.focusExistingWindowOnSecondLaunch.subtitle": "新しいウィンドウを開かず、最後に使用した CodeNomad ウィンドウを前面に表示します。",
  ...
  "settings.info.diagnostics.reportTitle": "CodeNomad 診断レポート",
  "settings.info.diagnostics.generated": "生成日時",
  "settings.info.connectivity.title": "CodeNomad サーバー接続",
  ...
  "settings.info.connectivity.disclaimer": "これらのアドレスはネットワークインターフェースから算出されます。ファイアウォール、ルーター、証明書の設定によって接続できない場合があります。",
  "settings.info.connectivity.loadFailed": "CodeNomad サーバーの接続情報を読み込めませんでした。",
  "settings.info.diagnostics.privacy": "共有する前にこのレポートを確認してください。ローカルパスとネットワークアドレスは含まれますが、パスワードや認証シークレットは含まれません。",
