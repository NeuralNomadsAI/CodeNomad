export const settingsMessages = {
  ...
  "settings.appearance.startup.restore.subtitle": "タブ、アクティブなセッション、未送信メッセージを再度開き、配置を復元し、最近のセッションメッセージをこのデバイスにキャッシュして再表示を高速化します。",
  "settings.appearance.startup.clear.title": "保存された起動状態",
  "settings.appearance.startup.clear.subtitle": "保存されたタブ、下書き、配置、キャッシュ済みセッションメッセージをこのデバイスから削除します。OpenCode の会話は削除されません。",
  ...
  "settings.behavior.toolInputsVisibility.title": "ツール入力",
  "settings.behavior.toolInputsVisibility.subtitle": "ツール呼び出しの入力引数の既定の表示状態を設定します。",
  "settings.behavior.usageMetrics.title": "トークン使用量",
