export const settingsMessages = {
  ...
  "settings.usage.scope": "このGitプロジェクトとworktreeのネイティブ統計（サブセッションを含む）。期間は直近の日数、活動は表示されたタイムゾーンに基づきます。",
  "settings.usage.noProject": "Gitプロジェクトを開くと使用状況を表示できます。",
  "settings.usage.period": "期間",
  "settings.usage.days": "直近{count}日間",
  "settings.usage.loading": "使用状況を読み込み中…",
  "settings.usage.error": "更新できませんでした。検証済みGitプロジェクトとOpenCode接続が必要です。表示データは前回成功した更新のものです。",
