export const settingsMessages = {
  ...
  "settings.appearance.gitDiff.gutterMode.title": "Git diff ガターモード",
  "settings.appearance.gitDiff.gutterMode.subtitle": "Git Changes の差分で使う Monaco ガター表示を選びます。",
  "settings.appearance.gitDiff.gutterMode.option.compact": "コンパクト",
  "settings.appearance.gitDiff.gutterMode.option.normal": "標準",
