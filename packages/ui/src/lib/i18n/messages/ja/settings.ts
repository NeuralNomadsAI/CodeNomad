export const settingsMessages = {
  ...
  "settings.opencode.executionProfiles.preview.advancedTitle": "Advanced launcher preview",
  "settings.opencode.executionProfiles.preview.advancedSubtitle": "Inspect the generated launcher/command resolved from this preset without changing the preset itself.",
  "settings.opencode.executionProfiles.preview.advancedBadge": "Secondary",
  "settings.opencode.executionProfiles.preview.hint": "The preset form above remains the source of truth. Use this section to inspect and copy the generated launcher details only.",
  "settings.opencode.executionProfiles.preview.empty": "Generate a preview to inspect the launcher derived from the current preset.",
  "settings.opencode.executionProfiles.preview.transport": "Transport",
  "settings.opencode.executionProfiles.preview.launcher": "Launcher",
  "settings.opencode.executionProfiles.preview.args": "Arguments",
  "settings.opencode.executionProfiles.preview.commandLine": "Command line",
  "settings.opencode.executionProfiles.preview.copyCommandLine": "Copy command line",
  "settings.opencode.executionProfiles.preview.copyEnvironment": "Copy environment",
  "settings.opencode.executionProfiles.preview.copyAll": "Copy full preview",
  "settings.opencode.executionProfiles.preview.copySuccess": "Launcher preview copied to clipboard.",
  "settings.opencode.executionProfiles.preview.copyFailed": "Clipboard access denied. Copy the preview manually instead.",
  "settings.opencode.executionProfiles.preview.none": "(none)",
