export const settingsMessages = {
  ...
  "instanceServiceStatus.plugins.errors.save": "プラグイン有効化ルールを保存できませんでした。 [{scope} {name}]",
  "instanceServiceStatus.plugins.errors.forbidden": "このワークスペースにはそのプラグイン場所を変更する権限がありません。 [{scope} {name}]",
  "instanceServiceStatus.plugins.errors.conflict": "プロジェクトまたは設定が同時に変更されました。更新して再試行してください。 [{scope} {name}]",
  "instanceServiceStatus.plugins.errors.invalidConfig": "選択した OpenCode 設定が不正です。変更されませんでした。 [{scope} {name}]",
