export const settingsMessages = {
  ...
  "instanceServiceStatus.plugins.scope.required": "プラグインを変更する前にグローバルまたはプロジェクトを選択してください。",
  ...
  "instanceServiceStatus.plugins.inactive.heading": "設定済み・未実行",
  "instanceServiceStatus.plugins.configured.heading": "設定済みエントリ",
  "instanceServiceStatus.plugins.configured.empty": "プラグインソースまたは有効化ルールは設定されていません。",
  "instanceServiceStatus.plugins.configured.source": "ソース",
  "instanceServiceStatus.plugins.configured.rule": "ルール",
  "instanceServiceStatus.plugins.configured.options": "オプション",
  "instanceServiceStatus.plugins.configScope.global": "グローバル",
  "instanceServiceStatus.plugins.configScope.project": "プロジェクト",
  "instanceServiceStatus.plugins.configScope.other": "その他のソース",
  "instanceServiceStatus.plugins.configScope.virtual": "仮想ソース",
  ...
  "instanceServiceStatus.plugins.errors.save": "プラグイン有効化ルールを保存できませんでした。",
  "instanceServiceStatus.plugins.errors.forbidden": "このワークスペースにはそのプラグイン場所を変更する権限がありません。",
  "instanceServiceStatus.plugins.errors.conflict": "プロジェクトまたは設定が同時に変更されました。更新して再試行してください。",
  "instanceServiceStatus.plugins.errors.invalidConfig": "選択した OpenCode 設定が不正です。変更されませんでした。",
