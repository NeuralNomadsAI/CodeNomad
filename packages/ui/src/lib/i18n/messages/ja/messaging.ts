export const messagingMessages = {
  ...
  "promptInput.voiceInput.liveMode": "ライブ音声モードを開く",
  "voice.hud.title": "ライブ音声モード",
  "voice.hud.connecting": "接続中...",
  "voice.hud.listening": "聞き取り中...",
  "voice.hud.speaking": "応答中...",
  "voice.hud.idle": "待機中",
  "voice.hud.error": "音声接続エラー",
  "voice.hud.muted": "ミュート中",
  "voice.hud.mute": "マイクをミュート",
  "voice.hud.unmute": "マイクのミュートを解除",
  "voice.hud.interrupt": "応答を中断",
  "voice.hud.close": "音声モードを閉じる",
  "voice.hud.deadman_timeout": "無操作のため音声モードを終了しました",
  "voice.hud.empty_transcript": "話しかけて会話を開始してください...",
  "voice.hud.switch_provider": "音声プロバイダーを切り替え",
} as const
