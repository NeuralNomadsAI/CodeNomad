export const messagingMessages = {
  ...
  "promptInput.btw.question": "質問",
  "promptInput.btw.answer": "回答",
  "promptInput.btw.ask": "質問する",
  "promptInput.btw.loading": "考え中…",
  "promptInput.btw.cancel": "質問をキャンセル",
  "promptInput.btw.close": "補足の質問を閉じる",
  "promptInput.btw.empty": "モデルからテキストが返されませんでした。質問を言い換えてみてください。",
  "promptInput.btw.failed": "補足の質問に回答できませんでした。",
  "promptInput.btw.copy": "回答をコピー",
  "promptInput.btw.copied": "コピーしました",
  "promptInput.btw.copyFailed": "回答をコピーできませんでした。",
  ...
  "history.scope": "検索範囲",
  "history.session": "セッション全体",
  "history.workspace": "ワークスペース全体",
  "history.technical": "ツールと思考を含める",
  "history.counts": "メッセージ {messages} 件 · ツール {tools} 件 · 思考 {reasoning} 件",
  "history.scanning": "集計中…",
  "history.snapshot": "履歴のスナップショット",
  "history.skipped": "{count} 件のメッセージを完全に処理できませんでした。",
  "history.more": "次の結果",
  "history.text": "テキスト",
  "history.tool": "ツール",
  ...
  "messageBlock.reasoning.steps.one": "{count} ステップ",
  "messageBlock.reasoning.steps.other": "{count} ステップ",
  "messageBlock.exploration.completed": "探索完了: {tools}",
  "messageBlock.exploration.active": "探索中: {tools}",
  "messageBlock.exploration.read.one": "読み取り {count} 件",
  ...
  "messageItem.actions.deleteTechnicalParts": "この回答からツールと推論を削除",
  "messageItem.actions.deleteTechnicalParts.confirmTitle": "ツールと推論を削除しますか？",
  "messageItem.actions.deleteTechnicalParts.confirmMessage": "ツール出力: {toolCount}、推論ブロック: {reasoningCount}。最終テキストは保持されます。",
  "messageItem.actions.deleteTechnicalParts.confirmLabel": "削除",
  "messageItem.actions.deleteTechnicalParts.failedTitle": "削除に失敗しました",
  "messageItem.actions.deleteTechnicalParts.failedMessage": "この回答からツールと推論を削除できませんでした",
  ...
  "promptInput.attachFiles.help": "このデバイスからファイルを選択",
  "promptInput.attachFiles.reading": "ファイルを読み込み中…",
  "promptInput.hints.projectFiles": "プロジェクトのファイルを参照",
  "promptInput.attachFiles.deviceDetail": "デバイス: {name} · {bytes} バイト",
  "promptInput.attachFiles.projectDetail": "プロジェクト: {path}",
  "promptInput.attachFiles.rejected.tooLarge": "{name}: ファイルあたり5 MiBを超えています。",
  "promptInput.attachFiles.rejected.limit": "{name}: 10ファイルまたは合計20 MiBを超えています。",
  "promptInput.attachFiles.rejected.unreadable": "{name}: 読み込めませんでした。",
  ...
  "promptInput.attachFiles.tooLarge.other": "選択した{count}件のファイルは5 MBの添付サイズ上限を超えているため添付できませんでした。",
  "promptInput.attachFiles.limit.one": "添付は{maxFiles}件、合計{maxMegabytes} MBまでのため、選択した1件のファイルは添付されませんでした。",
  "promptInput.attachFiles.limit.other": "添付は{maxFiles}件、合計{maxMegabytes} MBまでのため、選択した{count}件のファイルは添付されませんでした。",
  "promptInput.attachFiles.deviceRejected.one": "選択した1件のファイルは添付されませんでした。ファイルは読み取り可能で、1件あたり{maxFileMegabytes} MB以下、最大{maxFiles}件かつ合計{maxTotalMegabytes} MB以内である必要があります。",
  "promptInput.attachFiles.deviceRejected.other": "選択した{count}件のファイルは添付されませんでした。ファイルは読み取り可能で、1件あたり{maxFileMegabytes} MB以下、最大{maxFiles}件かつ合計{maxTotalMegabytes} MB以内である必要があります。",
  "promptInput.clear.ariaLabel": "プロンプトのテキストをクリア",
  "promptInput.clear.title": "プロンプトのテキストをクリア",
  "promptInput.send.ariaLabel": "メッセージを送信",
  "promptInput.send.queueAriaLabel": "メッセージをキューに追加",
  "promptQueue.title": "プロンプトキュー（{count}）",
  "promptQueue.delivery.queue": "待機中",
  "promptQueue.delivery.steer": "割り込み中",
  "promptQueue.attachments.one": "添付ファイル {count} 件",
  "promptQueue.attachments.other": "添付ファイル {count} 件",
  ...
  "promptQueue.error.message": "プロンプトキューを更新できませんでした",
