export const commandMessages = {
  ...
  "commands.removeSessionTechnicalParts.label": "セッションのツールと推論を削除",
  "commands.removeSessionTechnicalParts.description": "最終回答を保持し、完了したツール出力と推論を削除します",
  "commands.removeSessionTechnicalParts.keywords": "クリーンアップ, ツール, 推論, 削除, セッション",
  "commands.removeSessionTechnicalParts.empty.title": "削除するものがありません",
  "commands.removeSessionTechnicalParts.empty.message": "このセッションには完了したツール出力や推論ブロックがありません。",
  "commands.removeSessionTechnicalParts.confirm.title": "ツールと推論を削除しますか？",
  "commands.removeSessionTechnicalParts.confirm.message": "ツール出力: {toolCount}、推論ブロック: {reasoningCount}。最終回答は保持されます。",
  "commands.removeSessionTechnicalParts.confirm.label": "削除",
  "commands.removeSessionTechnicalParts.failed.title": "削除に失敗しました",
  "commands.removeSessionTechnicalParts.failed.message": "{count} 件の回答をクリーンアップできませんでした。",
