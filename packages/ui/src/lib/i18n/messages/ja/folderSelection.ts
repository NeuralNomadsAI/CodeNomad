export const folderSelectionMessages = {
  ...
  "folderSelection.servers.dialog.savedServer": "保存済みサーバー",
  "folderSelection.servers.dialog.newServer": "新しいサーバー",
  "folderSelection.servers.dialog.newServerDescription": "別のサーバーアドレスを入力",
