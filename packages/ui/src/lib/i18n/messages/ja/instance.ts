export const instanceMessages = {
  ...
  "instanceShell.worktree.actionTarget": "ワークツリー操作の対象",
  "instanceShell.worktree.create.fromCurrentBranch": "現在のブランチから新規作成",
  "instanceShell.worktree.create.action": "worktree を作成",
  "instanceShell.worktree.create.description": "Git worktree を作成します",
