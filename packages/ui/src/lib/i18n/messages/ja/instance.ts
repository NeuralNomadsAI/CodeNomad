export const instanceMessages = {
  ...
  "instanceShell.rightPanel.errors.gitStatusFailed": "gitステータスの読み込みに失敗しました",
  "instanceShell.rightPanel.errors.diffNotAvailable": "削除されたファイルのdiffはまだ利用できません",
  "instanceShell.rightPanel.errors.binaryFile": "バイナリファイルは表示できません",
  "instanceShell.rightPanel.errors.unsupportedType": "サポートされていないファイル形式です",
  "instanceShell.rightPanel.errors.fileChangesFailed": "ファイル変更の読み込みに失敗しました",
  "instanceShell.rightPanel.errors.filesLoadFailed": "ファイル一覧の読み込みに失敗しました",
  "instanceShell.rightPanel.errors.fileReadFailed": "ファイルの読み込みに失敗しました",
  "instanceShell.rightPanel.errors.fileSaveFailed": "ファイルの保存に失敗しました",
