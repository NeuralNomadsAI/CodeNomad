export const instanceMessages = {
  ...
  "gitPanel.history": "履歴",
  "filesPanel.workspace": "ワークスペース",
  "filesPanel.commits": "コミット",
  ...
  "gitPanel.detached": "切り離された HEAD",
  "gitPanel.filter": "読み込んだコミットを絞り込む…",
  "gitPanel.emptyHistory": "表示するコミットはありません",
  "gitPanel.more": "以前のコミットを読み込む",
  "gitPanel.files": "変更されたファイル: {count}",
  "gitPanel.actions": "Git 操作",
  "gitPanel.diff": "Git 差分",
  "gitPanel.parentDiff": "最初の親コミットと比較",
  "gitPanel.backChat": "会話に戻る",
  ...
  "instanceShell.backgroundProcesses.error": "バックグラウンドシェルを読み込めませんでした。",
  "instanceShell.backgroundProcesses.empty": "バックグラウンドシェルはありません。",
  "instanceShell.backgroundProcesses.status.running": "実行中",
  "instanceShell.backgroundProcesses.status.exited": "終了",
  "instanceShell.backgroundProcesses.status.timeout": "タイムアウト",
  "instanceShell.backgroundProcesses.status.killed": "強制終了",
  "instanceShell.backgroundProcesses.pid": "PID {pid}",
  "instanceShell.backgroundProcesses.exitCode": "終了 {code}",
  "instanceShell.backgroundProcesses.actions.stopRemove": "停止して削除",
  "instanceShell.backgroundProcesses.actions.remove": "削除",
  "instanceShell.backgroundProcesses.actions.output": "出力を表示",
  "instanceShell.backgroundProcesses.remove.title": "バックグラウンドシェルを削除",
  "instanceShell.backgroundProcesses.remove.message": "「{title}」を削除しますか？実行中のプロセスは停止します。",
  ...
  "instanceShell.filesShell.resizeFiles": "ファイル一覧のサイズを変更",
  ...
  "instanceShell.worktree.unavailable": "利用不可",
  "instanceShell.worktree.create.fromCurrentBranch": "現在のブランチから新規作成",
  "instanceShell.worktree.create.action": "worktree を作成して使用",
  "instanceShell.worktree.create.description": "このセッションのチェックアウトから名前付き Git ブランチを作成し、セッションファミリーを新しい worktree に移動します。未コミットの変更は元のチェックアウトに残ります。",
  "instanceShell.worktree.create.name": "名前",
  "instanceShell.worktree.create.placeholder": "worktree-name",
  "instanceShell.worktree.create.success": "worktree {slug} を作成しました",
  "instanceShell.worktree.create.error": "worktree を作成できませんでした",
  ...
  "instanceShell.worktree.delete.action": "worktree を削除",
  "instanceShell.worktree.delete.description": "このブランチの worktree とローカルフォルダーを削除します。",
  ...
  "opencodeBinarySelector.customPath.placeholder": "{name} バイナリのパスを入力…",
