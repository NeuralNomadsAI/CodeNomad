export const instanceMessages = {
  ...
  "instanceShell.rightPanel.sections.backgroundProcesses.tooltip": "アクティブなワークスペースまたはワークツリーの OpenCode PTY。",
  ...
  "instanceShell.backgroundProcesses.actions.rename": "名前を変更",
  "instanceShell.backgroundProcesses.actions.stopRemove": "停止して削除",
  "instanceShell.backgroundProcesses.actions.remove": "削除",
  "instanceShell.backgroundProcesses.rename.title": "バックグラウンドシェルの名前を変更",
  "instanceShell.backgroundProcesses.rename.message": "このバックグラウンドシェルの新しいタイトルを入力してください。",
  "instanceShell.backgroundProcesses.rename.inputLabel": "タイトル",
