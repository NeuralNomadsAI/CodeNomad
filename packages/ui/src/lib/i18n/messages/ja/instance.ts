export const instanceMessages = {
  ...
  "instanceShell.rightPanel.tabs.workflows": "ワークフロー",
  "instanceShell.rightPanel.tabs.ariaLabel": "右パネルのタブ",
  "instanceShell.workflows.builder.title": "新しいワークフロー",
  "instanceShell.workflows.builder.description": "エージェントのステージを順番に実行します。",
  "instanceShell.workflows.objective.label": "目的",
  "instanceShell.workflows.objective.placeholder": "達成したい結果を入力してください",
  "instanceShell.workflows.stages.title": "ステージ",
  "instanceShell.workflows.stages.count": "{max} 件中 {count} 件",
  "instanceShell.workflows.stages.number": "ステージ {number}",
  "instanceShell.workflows.fields.title": "タイトル",
  "instanceShell.workflows.fields.instructions": "指示",
  "instanceShell.workflows.fields.agent": "エージェント",
  "instanceShell.workflows.fields.model": "モデル",
  "instanceShell.workflows.fields.requiresApproval": "このステージの後に承認を求める",
  "instanceShell.workflows.defaults.planner.title": "プランナー",
  "instanceShell.workflows.defaults.planner.instructions": "目的を達成するための明確な実装計画を作成してください。",
  "instanceShell.workflows.defaults.implementer.title": "実装担当",
  "instanceShell.workflows.defaults.implementer.instructions": "計画を実装し、結果を検証してください。",
  "instanceShell.workflows.defaults.newStage.title": "ステージ {number}",
  "instanceShell.workflows.actions.moveUp": "ステージを上へ移動",
  "instanceShell.workflows.actions.moveDown": "ステージを下へ移動",
  "instanceShell.workflows.actions.removeStage": "ステージを削除",
  "instanceShell.workflows.actions.addStage": "ステージを追加",
  "instanceShell.workflows.actions.start": "ワークフローを開始",
  "instanceShell.workflows.actions.starting": "開始しています...",
  "instanceShell.workflows.actions.refresh": "ワークフローを更新",
  "instanceShell.workflows.actions.approve": "承認",
  "instanceShell.workflows.actions.keepWaiting": "待機を続ける",
  "instanceShell.workflows.actions.cancel": "ワークフローをキャンセル",
  "instanceShell.workflows.actions.keepRunning": "実行を続ける",
  "instanceShell.workflows.actions.openSession": "生成されたセッションを開く",
  "instanceShell.workflows.history.title": "実行履歴",
  "instanceShell.workflows.history.description": "このワークスペースの現在および過去の実行です。",
  "instanceShell.workflows.history.loading": "ワークフローを読み込み中...",
  "instanceShell.workflows.history.empty": "ワークフローの実行はまだありません。",
  "instanceShell.workflows.confirm.approve.message": "完了したステージを承認して続行しますか？",
  "instanceShell.workflows.confirm.cancel.message": "このワークフローをキャンセルしますか？実行中の作業は停止します。",
  "instanceShell.workflows.errors.action": "ワークフロー操作に失敗しました。",
  "instanceShell.workflows.errors.openSession": "生成されたセッションを開けませんでした。",
  "instanceShell.workflows.output": "出力",
  "instanceShell.workflows.outputTruncated": "出力は短縮されています。完全な出力を確認するには、生成されたセッションを開いてください。",
  "instanceShell.workflows.live.statusChanged": "ワークフローの状態が「{status}」に変わりました。",
  "instanceShell.workflows.status.pending": "保留中",
  "instanceShell.workflows.status.running": "実行中",
  "instanceShell.workflows.status.waiting_for_review": "レビュー待ち",
  "instanceShell.workflows.status.completed": "完了",
  "instanceShell.workflows.status.failed": "失敗",
  "instanceShell.workflows.status.cancelled": "キャンセル済み",
  "instanceShell.workflows.status.interrupted": "中断",
  "instanceShell.rightPanel.modules.core": "CodeNomad コア",
