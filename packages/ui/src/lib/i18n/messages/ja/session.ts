export const sessionMessages = {
  ...
  "sessionList.options.ariaLabel": "セッションの並べ替えと絞り込み",
  "sessionList.options.sort.label": "並べ替え",
  "sessionList.options.sort.activity": "最近のアクティビティ",
  "sessionList.options.sort.name": "名前",
  "sessionList.options.sort.worktree": "Worktree",
  "sessionList.options.filter.label": "Worktree で絞り込む",
  "sessionList.options.filter.all": "すべての worktree",
  "sessionList.options.filter.workspace": "ワークスペース",
