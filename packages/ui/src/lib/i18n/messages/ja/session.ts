export const sessionMessages = {
  ...
  "sessionList.actions.pin.ariaLabel": "セッションを固定",
  "sessionList.actions.pin.title": "セッションを固定",
  "sessionList.actions.unpin.ariaLabel": "セッションの固定を解除",
  "sessionList.actions.unpin.title": "セッションの固定を解除",
  ...
  "sessionList.delete.confirmPinnedMessage": "\"{label}\" は重要としてマークされています。固定されたこのセッションを削除しますか？",
  ...
  "sessionList.bulkDelete.confirmPinnedMessage": "選択項目に {pinnedCount} 件の固定セッションが含まれています。{count} 件のセッションを削除しますか？",
  "sessionList.pin.badgeTooltip": "固定されたセッション",
  "sessionList.filter.pinned": "固定済み",
