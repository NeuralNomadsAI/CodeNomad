export const toolCallMessages = {
  ...
  "permissionApproval.kind.form": "フォーム",
  "formRequest.selectPlaceholder": "オプションを選択",
  "formRequest.openExternal": "外部フォームを開く",
  "formRequest.cancel": "キャンセル",
  "formRequest.submit": "送信",
  "formRequest.submitting": "送信中...",
  "formRequest.errors.reply": "フォームを送信できません",
  "formRequest.errors.cancel": "フォームをキャンセルできません",
  "formRequest.errors.validation": "必須項目をすべて入力してください。",
  "formRequest.customValuesPlaceholder": "その他の値（カンマ区切り）",
