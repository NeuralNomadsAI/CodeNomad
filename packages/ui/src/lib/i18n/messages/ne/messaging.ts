export const messagingMessages = {
  ...
  "promptInput.btw.question": "तपाईंको प्रश्न",
  "promptInput.btw.answer": "उत्तर",
  "promptInput.btw.ask": "सोध्नुहोस्",
  "promptInput.btw.loading": "सोच्दै…",
  "promptInput.btw.cancel": "प्रश्न रद्द गर्नुहोस्",
  "promptInput.btw.close": "छुट्टै प्रश्न बन्द गर्नुहोस्",
  "promptInput.btw.empty": "मोडेलले कुनै पाठ फर्काएन। प्रश्नलाई अर्को तरिकाले सोध्नुहोस्।",
  "promptInput.btw.failed": "छुट्टै प्रश्नको उत्तर दिन सकिएन।",
  "promptInput.btw.copy": "उत्तर प्रतिलिपि गर्नुहोस्",
  "promptInput.btw.copied": "प्रतिलिपि गरियो",
  "promptInput.btw.copyFailed": "उत्तर प्रतिलिपि गर्न सकिएन।",
  ...
  "history.session": "पूरै सत्र",
  "history.workspace": "पूरै कार्यस्थान",
  "history.technical": "उपकरण र सोच समावेश गर्नुहोस्",
  "history.counts": "{messages} सन्देश · {tools} उपकरण · {reasoning} सोच खण्ड",
  "history.scanning": "गणना हुँदैछ…",
  "history.snapshot": "इतिहासको स्न्यापसट",
  "history.skipped": "{count} सन्देश पूर्ण रूपमा प्रशोधन गर्न सकिएन।",
  "history.more": "अर्को नतिजा",
  "history.text": "पाठ",
  "history.tool": "उपकरण",
  "history.reasoning": "सोच",
  "history.planning": "इतिहास जाँच्दै: {count} सन्देश",
  "history.pruning": "सफा गर्दै: {count} / {total} सन्देश",
  "transcriptFilters.title": "सन्देशको सामग्री",
  "transcriptFilters.systemMessages": "प्रणाली",
  ...
  "messageBlock.reasoning.thoughtLabel": "विचार",
  "messageBlock.reasoning.steps.one": "{count} चरण",
  "messageBlock.reasoning.steps.other": "{count} चरणहरू",
  "messageBlock.exploration.completed": "अन्वेषण पूरा: {tools}",
  "messageBlock.exploration.active": "अन्वेषण गर्दै: {tools}",
  "messageBlock.exploration.read.one": "{count} पढाइ",
  ...
  "messageItem.actions.deleteTechnicalParts": "यस जवाफबाट उपकरण र तर्क हटाउनुहोस्",
  "messageItem.actions.deleteTechnicalParts.confirmTitle": "उपकरण र तर्क हटाउने?",
  "messageItem.actions.deleteTechnicalParts.confirmMessage": "उपकरण आउटपुट: {toolCount}; तर्क ब्लक: {reasoningCount}। अन्तिम पाठ सुरक्षित रहनेछ।",
  "messageItem.actions.deleteTechnicalParts.confirmLabel": "हटाउनुहोस्",
  "messageItem.actions.deleteTechnicalParts.failedTitle": "हटाउन असफल",
  "messageItem.actions.deleteTechnicalParts.failedMessage": "यस जवाफबाट उपकरण र तर्क हटाउन सकिएन",
  ...
  "messagePart.actions.delete": "मेटाउनुहोस्",
  ...
  "promptInput.attachFiles.title": "फाइल संलग्न गर्नुहोस्…",
  "promptInput.attachFiles.help": "यस उपकरणबाट फाइलहरू छान्नुहोस्",
  "promptInput.attachFiles.reading": "फाइलहरू पढ्दै…",
  "promptInput.hints.projectFiles": "परियोजनाका फाइलहरू सन्दर्भ गर्नुहोस्",
  "promptInput.attachFiles.deviceDetail": "उपकरण: {name} · {bytes} बाइट",
  "promptInput.attachFiles.projectDetail": "परियोजना: {path}",
  "promptInput.attachFiles.rejected.tooLarge": "{name}: प्रति फाइल 5 MiB भन्दा बढी छ।",
  "promptInput.attachFiles.rejected.limit": "{name}: 10 फाइल वा कुल 20 MiB भन्दा बढी छ।",
  "promptInput.attachFiles.rejected.unreadable": "{name}: पढ्न सकिएन।",
  ...
  "promptInput.attachFiles.tooLarge.other": "{count} फाइलहरू ५ एमबी भन्दा ठूला भएकाले संलग्न गर्न सकिएन।",
  "promptInput.attachFiles.limit.one": "संलग्नकहरू {maxFiles} फाइल र जम्मा {maxMegabytes} एमबीमा सीमित भएकाले १ फाइल संलग्न गरिएन।",
  "promptInput.attachFiles.limit.other": "संलग्नकहरू {maxFiles} फाइल र जम्मा {maxMegabytes} एमबीमा सीमित भएकाले {count} फाइलहरू संलग्न गरिएनन्।",
  "promptInput.attachFiles.deviceRejected.one": "१ चयन गरिएको फाइल संलग्न गरिएन। फाइल पढ्न मिल्ने, प्रत्येक {maxFileMegabytes} एमबीभन्दा ठूलो नहुने र {maxFiles} फाइल तथा जम्मा {maxTotalMegabytes} एमबीको सीमाभित्र हुनुपर्छ।",
  "promptInput.attachFiles.deviceRejected.other": "{count} चयन गरिएका फाइलहरू संलग्न गरिएनन्। फाइलहरू पढ्न मिल्ने, प्रत्येक {maxFileMegabytes} एमबीभन्दा ठूलो नहुने र {maxFiles} फाइल तथा जम्मा {maxTotalMegabytes} एमबीको सीमाभित्र हुनुपर्छ।",
  ...
  "promptInput.send.queueAriaLabel": "सन्देश लाममा राख्नुहोस्",
  "promptQueue.title": "प्रम्प्ट लाम ({count})",
  "promptQueue.delivery.queue": "लाममा",
  "promptQueue.delivery.steer": "अहिले पठाइँदै",
  "promptQueue.attachments.one": "{count} संलग्नक",
  "promptQueue.attachments.other": "{count} संलग्नकहरू",
  ...
  "promptQueue.error.message": "प्रम्प्ट लाम अद्यावधिक गर्न सकिएन",
