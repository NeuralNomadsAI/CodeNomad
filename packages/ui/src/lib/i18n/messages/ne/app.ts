export const appMessages = {
  ...
  "emptyState.examples": "उदाहरणहरू: {example}",
  ...
  "theme.mode.light": "उज्यालो (Light)",
  "theme.mode.dark": "अँध्यारो (Dark)",
  "theme.toggle.title": "थिम: {mode}",
  "theme.toggle.ariaLabel": "थिम: {mode}",
} as const
