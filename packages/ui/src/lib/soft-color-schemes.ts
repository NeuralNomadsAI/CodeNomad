...
function palette(
  ...
  return {
    ...
    colors: { ...colors, ...(appearance === "dark" ? DARK_IDENTITY_COLORS : LIGHT_IDENTITY_COLORS) },
  }
}
...
export const SOFT_COLOR_SCHEMES: readonly ColorSchemeDefinition[] = [
  ...
  palette("porcelain", "mist", "light", {
    ...
    statusError: "#AC4547", yoloAccent: "#665BA3",
  }),
  palette("mist", "mist", "dark", {
    ...
    accentPrimary: "#B8BEAC", statusSuccess: "#A1C181", statusWarning: "#DEC184",
  ...
  palette("dawn", "slate", "light", {
    ...
    accentPrimary: "#6B609A", statusSuccess: "#4B733C", statusWarning: "#805C20",
  ...
  palette("slate", "slate", "dark", {
    ...
    borderBase: "#53647C", textPrimary: "#C9D1DF", textMuted: "#B4C1D1",
  ...
  palette("parchment", "clay", "light", {
    ...
    accentPrimary: "#5F682F", statusSuccess: "#496C42", statusWarning: "#7B551B",
    statusError: "#A33D36", yoloAccent: "#5F682F",
  }),
  palette("clay", "clay", "dark", {
    surfaceBase: "#32302F", surfaceSecondary: "#403C38", surfaceMuted: "#504A43",
    borderBase: "#645C50", textPrimary: "#D8CBB3", textMuted: "#C6B9A5",
    accentPrimary: "#B8BA86", statusSuccess: "#A9BA80", statusWarning: "#D8B574",
    statusError: "#E39380", yoloAccent: "#B8BA86",
  }),
  ...
  palette("linen", "linen", "light", {
    ...
    accentPrimary: "#776524", statusSuccess: "#55733A", statusWarning: "#835B1E",
  ...
  palette("iris", "iris", "light", {
    ...
    accentPrimary: "#776026", statusSuccess: "#477343", statusWarning: "#825B20",
  ...
  palette("sage-light", "sage", "light", {
    ...
    accentPrimary: "#756126", statusSuccess: "#496E3C", statusWarning: "#80591D",
  ...
  palette("sage", "sage", "dark", {
    ...
    accentPrimary: "#CCC092", statusSuccess: "#A7C080", statusWarning: "#DBBC7F",
