...
import { Folder, Clock, Trash2, FolderPlus, Settings, ChevronRight, MonitorUp, Star, Languages, ChevronDown, X, Globe, Loader2, Terminal, GitBranch } from "lucide-solid"
                                    ...
                                    <div class="flex items-center justify-between gap-3 w-full">
                                      <div class="flex-1 min-w-0 text-left">
                                        <div class="flex items-center gap-2 mb-1">
                                          <Show when={server.kind === "remote-server"} fallback={<MonitorUp class="w-4 h-4 flex-shrink-0 icon-muted" />}>
