...
export const ChatSettingsSection: Component = () => {
  ...
  const behaviorSettings = createMemo<BehaviorSetting[]>(() => [
    ...getBehaviorSettings(config).filter(
      (setting) =>
        ...
        setting.id !== "behavior.promptVoiceInput" &&
        setting.id !== "behavior.promptSubmitOnEnter" &&
        setting.id !== "behavior.thinkingBlocksDefault" &&
        setting.id !== "behavior.toolOutputsDefault",
    ),
    {
      kind: "toggle",
    ...
    <div class="settings-section-stack">
      <div class="settings-card">
        ...
        <div class="settings-stack">
          <BehaviorSettingRows settings={behaviorSettings} preferences={preferences} />
        </div>
      </div>
    </div>
  )
