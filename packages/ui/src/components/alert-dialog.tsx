        ...
        return (
          ...
          >
            <Dialog.Portal>
              ...
              <Dialog.Content class="modal-surface fixed left-1/2 top-1/2 z-[70] w-full max-w-sm -translate-x-1/2 -translate-y-1/2 p-6 border border-base shadow-2xl" tabIndex={-1}>
