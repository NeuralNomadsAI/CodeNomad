...
render(() => <ConfigProvider><I18nProvider><ThemeProvider><main style={{ width: "340px" }}><McpCodeModeControls instanceId="mcp" directory={directory()} /></main></ThemeProvider></I18nProvider></ConfigProvider>, document.getElementById("root")!)
;(window as any).fixture = { writes, reads: () => reads, setDirectory, fail: () => { fail = true }, defer: () => { defer = true }, release: () => release?.(),
