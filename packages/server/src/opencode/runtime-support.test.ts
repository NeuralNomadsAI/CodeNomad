...
test("native timestamp minimum is distinct from recommendation and unfamiliar version labels", () => {
  ...
  assert.equal(RECOMMENDED_OPENCODE_VERSION, "2.0.14")
  for (const version of ["2.0.7", "2.0.8", "2.0.9", "2.0.10", "2.0.11", "2.0.12", "2.0.13", "2.0.14", "2.1.0", "2.0.14-dev.1", "3.0.0", "custom-build"]) {
