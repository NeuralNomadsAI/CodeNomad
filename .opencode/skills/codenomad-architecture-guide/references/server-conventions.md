...
- Never spawn or stop OpenCode per workspace or add general plugin installation/packaging. The reviewed exceptions are Developer Mode's project-local adapter and the bundled session-pruning RPC under `src/opencode/session-pruning/`.
